...
./exportitem resdb_deploy 192.168.0.77 mmog mmog > imp_item.txt
...
Generate_Sql()
{
	cd ~/myworld/tools/
	./create_dbtab_sql.sh
	mysqldump --add-drop-database --add-drop-table --default-character-set=latin1 -userver -ptulin#1234 -h192.168.0.77 resdb_deploy > resdb_data.sql
...
cp -f /data/shared/test/script/* $bin_dir/bin_deploy/zone/script/
