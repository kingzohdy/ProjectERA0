	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		<tr>
			...
			<td><select name="admintype">
            		<option value="3" > 高级游戏管理员</option>
                    <option value="4">游戏管理员</option>
            	</select>
        ...
        <tr>
			...
			<td><input type="text" name="adm" id="title" class="class_input" />
				<span class="maroon">*</span>
			</td>
		</tr>
		<tr>
			<td height="35" align="right">密码：</td>
			<td><input type="text" name="pw" id="author" class="class_input" /><span class="maroon">*</span></td>
		</tr>
	</table>
