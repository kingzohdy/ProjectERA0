...
function sear()
{
	...
	$.ajax({
		...
		url: 'select_log.php',
		dataType: 'json',
		data: {"stallBuy":"","xzdb": f,"time":tb, "time1":tb1, "us":jsm,"fag":fag},
		success: function(msg){
			if( null ==msg || ""== msg)
			{
				$("#tabr").empty();
			...
			else
			{
				...
				$.each(msg, function (index, value) {
					...
					var s = '<tr class=mgr_tr align=center ><td height=32 width="10%" >'+value['UinA']+'</td><td width="10%" >'+value['LoginNameA']+'</td><td width="10%" >'+value['RoleNameA']+'</td><td width="10%" >'+value['UinB']+'</td><td width="10%">'+value['LoginNameB']+'</td><td width="10%" >'+value['RoleNameB']+'</td><td width="25%">'+value['buys']+'</td><td width="5%">'+value['Price']+'</td><td width="10%" >'+value['LogTime']+'</td></tr>';
					$("#tabr").append(s);
				});
			}
		}
...
<body>
<div class="mgr_header"> <span class="title">购买摆摊物品</span>
	...
	<tr>
        ...
        <?php } ?> 
    		...
    		&nbsp;&nbsp;&nbsp;服务器：<select name="fw" id="fw" >
             ...
             <select id="jz">
            	<option value="1" selected="selected">购买人角色</option>
                <option value="2" >购买人帐号</option>
                <option value="3" >摊主角色</option>
                <option value="4" >摊主帐号</option>
            </select>
            <input type="text" id="us" name="us"  onblur="jc()" />(输入摊主或购买人的账号或角色)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table" id="bd">
		<tr class="thead2" align="center">
        		<td width="10%">摊主Uin</td>
				<td width="10%">摊主账号</td>
				<td width="10%">摊主角色名</td>
				<td width="10%">购买玩家Uin</td>
                <td width="10%">购买玩家账号</td>
                <td width="10%">购买玩家角色名</td>
                <td width="25%">购买类型：名字：唯一ID：数量：有效时间</td>
                <td width="5%">总价</td>
                <td width="10%">时间</td>
		</tr>
</table>
