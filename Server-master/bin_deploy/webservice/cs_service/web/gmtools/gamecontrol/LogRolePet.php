...
function sear()
{
	...
	$.ajax({
		...
		url: 'select_log.php',
		dataType: 'json',
		data: {"LogRolePet":"","xzdb": f,"time":tb, "time1":tb1, "us":jsm,"fag":fag},
		success: function(msg){
			if( null ==msg || ""== msg)
			{
				$("#tabr").empty();
			...
			else
			{
				$("#ttt").hide();
				$("#tabr").empty();
				//处理检索到的数据......StrengthenLevel
				$.each(msg, function (index, value) {
					//alert(value.RoleName);
					var s = '<tr class=mgr_tr align=center ><td height=32 width="5%" style="border-right:1px solid #666" >'+value['Uin']+'</td><td width="5%" style="border-right:1px solid #666" >'+value['LoginName']+'</td><td width="5%" style="border-right:1px solid #666" >'+value['RoleName']+'</td><td width="5%" style="border-right:1px solid #666" >'+value['PetName']+'</td><td width="4%" style="border-right:1px solid #666" >'+value['Level']+'</td><td width="4%" style="border-right:1px solid #666" >'+value['Genius']+'</td><td width="8%" style="border-right:1px solid #666" >'+value['PetInfo_WID']+'</td><td width="12%" style="border-right:1px solid #666" >'+value['StrengthenLevel']+'</td><td width="9%" style="border-right:1px solid #666" >'+value['NativeSkill']+'</td><td width="9%" style="border-right:1px solid #666" >'+value['PetSkills']+'</td><td width="5%" style="border-right:1px solid #666" >'+value['OpType']+'</td><td width="5%" style="border-right:1px solid #666" >'+value['Money']+'</td><td width="5%" style="border-right:1px solid #666" >'+value['GetItem']+'</td><td width="4%" style="border-right:1px solid #666" >'+value['ItemDec_Num']+'</td><td width="4%" style="border-right:1px solid #666" >'+value['StarPet']+'</td><td width="4%" style="border-right:1px solid #666" >'+value['LastValPet']+'</td><td width="7%" style="border-right:1px solid #666" >'+value['LogTime']+'</td></tr>';
					$("#tabr").append(s);
				});
			}
		}
...
<body>
<div class="mgr_header"> <span class="title">宠物操作日志</span>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table" id="bd">
		<tr class="thead2" align="center">
            ...
            <td width="4%">等级</td>
            <td width="4%">品质</td>
            <td width="8%">宠物唯一ID</td>
            <td width="12%">强化等级(星级)</td>
            <td width="9%">天赋技能,等级</td>
            <td width="9%">(技能,等级)</td>
            <td width="5%">操作类型</td>
            <td width="5%">消耗银币</td>
            <td width="5%">消耗物品</td>
            <td width="4%">消耗数量(绑定,不绑)</td>
            <td width="4%">初始星级</td>
            <td width="4%">最终星级</td>
            <td width="7%">时间</td>
		</tr>
