...
foreach ($columns as $fieldname) {
    echo '            <option value="' . latin_htmlspecialchars($fieldname) . '">'
        . latin_htmlspecialchars($fieldname) . '</option>' . "\n";
}
unset($columns);
?>
...
?>
    <input type="text" maxlength="100" size="30" name="target_db" value="<?php echo latin_htmlspecialchars($GLOBALS['db']); ?>"/>
<?php
    } else {
?>
...
value="<?php echo latin_htmlspecialchars($GLOBALS['table']); ?>" /><br />
    <?php
...
<fieldset>
    ...
    <tr><td><?php echo $strRenameTable; ?></td>
        <td><input type="text" size="20" name="new_name" onfocus="this.select()"
                value="<?php echo latin_htmlspecialchars($GLOBALS['table']); ?>" />
        </td>
    </tr>
    ...
    <tr><td><?php echo $strTableComments; ?></td>
        <td><input type="text" name="comment" maxlength="60" size="30"
                value="<?php echo latin_htmlspecialchars($comment); ?>" onfocus="this.select()" />
            <input type="hidden" name="prev_comment" value="<?php echo latin_htmlspecialchars($comment); ?>" />
        </td>
    </tr>
...
$this_url_params = array_merge($url_params,
    array(
        ...
        'zero_rows' => sprintf($strTableHasBeenFlushed,
            latin_htmlspecialchars($GLOBALS['table'])),
        'reload'    => 1,
        ));
?>
    <li><a href="sql.php<?php echo PMA_generate_common_url($this_url_params); ?>">
...
<?php
        ...
        foreach($partition_names as $one_partition) {
            $one_partition = latin_htmlspecialchars($one_partition);
