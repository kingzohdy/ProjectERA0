...
function PMA_langList()
{
    ...
    return array(
        ...
        'zh-gbk'    => array('zh|chinese simplified', 'chinese_simplified-gbk', 'zh', '¼òÌåÖÐÎÄgbk'),
    );
}
...
if ($GLOBALS['lang_failed_cfg']) {
    trigger_error(
        sprintf($GLOBALS['strLanguageUnknown'],
            latin_htmlspecialchars($GLOBALS['lang_failed_cfg'])),
        E_USER_ERROR);
}
if ($GLOBALS['lang_failed_cookie']) {
    trigger_error(
        sprintf($GLOBALS['strLanguageUnknown'],
            latin_htmlspecialchars($GLOBALS['lang_failed_cookie'])),
        E_USER_ERROR);
}
if ($GLOBALS['lang_failed_request']) {
    trigger_error(
        sprintf($GLOBALS['strLanguageUnknown'],
            latin_htmlspecialchars($GLOBALS['lang_failed_request'])),
        E_USER_ERROR);
}
