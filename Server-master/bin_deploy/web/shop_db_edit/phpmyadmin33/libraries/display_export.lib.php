...
<fieldset>
    ...
    <label for="checkbox_dump_onserver">
        <?php echo sprintf($strSaveOnServer, latin_htmlspecialchars(PMA_userDir($cfg['SaveDir']))); ?>
    </label>,<br />
