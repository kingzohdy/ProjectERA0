...
function PMA_auth()
{
	...
	unset($soap_serverlist);

//	PMA_setCookie($soap_serverlistKey,$soap_serverlist);
...
<?php if ($GLOBALS['cfg']['AllowArbitraryServer']) { ?>
        <div class="item">
            ...
            <input type="text" name="pma_servername" id="input_servername" value="<?php echo latin_htmlspecialchars($default_server); ?>" size="24" class="textfield" title="<?php echo $GLOBALS['strLogServerHelp']; ?>" />
        </div>
<?php } ?>
        <div class="item">
            <label for="input_username"><?php echo $GLOBALS['strLogUsername']; ?></label>
            <input type="text" name="pma_username" id="input_username" value="<?php echo latin_htmlspecialchars($default_user); ?>" size="24" class="textfield"/>
        </div>
        <div class="item">
...
function PMA_auth_set_user()
{
	...
	if (isset($soap_serverlist) and isset($soap_serverlistKey))
	{
		$_SESSION[$soap_serverlistKey] = $soap_serverlist;
	}
