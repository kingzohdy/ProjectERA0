...
PROC 1
	...
	CIRCLE_NEW_MON 200028 40 18800 7600 2000 1 40 0 0 0 0 1 2
		...
		if @41 >= 20 and @41 < 30
		CALL_MON_TEAM_ALL 293121 100 600 18819 7577
		endif
		if @41 >= 30 and @41 < 40
		CALL_MON_TEAM_ALL 293122 100 600 18819 7577
		endif
		if @41 >= 40 and @41 < 50
		CALL_MON_TEAM_ALL 293131 100 600 18819 7577
		endif
		if @41 >= 50 and @41 < 60
		CALL_MON_TEAM_ALL 293132 100 600 18819 7577
		endif
		if @41 >= 60 and @41 < 70
		CALL_MON_TEAM_ALL 293133 100 600 18819 7577
		endif
		if @41 >= 70 and @41 < 80
		CALL_MON_TEAM_ALL 293134 100 600 18819 7577
		endif
		if @41 >= 80 and @41 < 90
		CALL_MON_TEAM_ALL 293135 100 600 18819 7577
		endif
		if @41 >= 90 and @41 < 100
		CALL_MON_TEAM_ALL 293136 100 600 18819 7577
		endif
		if @41 >= 100 and @41 < 110
		CALL_MON_TEAM_ALL 293137 100 600 18819 7577
		endif
		if @41 >= 110 and @41 <= 120
		CALL_MON_TEAM_ALL 293138 100 600 18819 7577
		endif
