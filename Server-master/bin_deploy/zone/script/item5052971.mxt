...
proc 1
	...
	get_role_var 67 8 0 zhi
	
	if zhi < 1
		GET_PACK_SPACE 0 ret
		if ret >= 8
			DEC_ITEM_NUM_INPAK 5052971 1 10
			if 10 = 0
				...
				; ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 3653006 1 1 0
		...
		add_sys_msg_start
		add_sys_msg 你已开启过叶子猪公测特权金卡，无法再开启
