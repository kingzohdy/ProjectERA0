...
proc 1
	strvar d v 
	use_cangbaotu_pic 5062000 1000  d v
	switch d
	case 0
		ITEM_ADD_ONEDAY 5062000 1
		;使用次数+1
		dec_item_num_inpak 5062000 1 0
		...
		; if @41 < 30
			; if @50 < 50
				; add_sys_msg_start
				; add_sys_msg  运气不好，这个藏宝点被一个职业挖宝的强盗捷足先登了
				; set_sys_msg_mode 4 0 0
				; msg_info
				; new_life_dyn_mon 1 200024 1 @43 @44 300 0 0 0 0 @41 0 60
			; else
				; add_sys_msg_start
				; add_sys_msg  干得好！成功挖出了一个宝藏箱
				; set_sys_msg_mode 4 0 0
				; msg_info
				; new_life_mon 293121 1 @43 @44 0 0 0 1 60 1 2
			; endif
		; endif
		...
		; if @41 >= 30 and @41 < 40
			...
			; else
				...
				; set_sys_msg_mode 4 0 0
				; msg_info
				; new_life_mon 293122 1 @43 @44 0 0 0 1 60 1 2
			; endif
		; endif
		...
		switch 10
			case 0
				NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao2.mac
			endcase
			case 1
				NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao3.mac
			endcase
			case 2
				NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao4.mac
			endcase
			case 3
				NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao1.mac
			endcase
			case 4
				NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao5.mac
			endcase
			case 5
				call 100
			endcase
	...
	case 1
		add_sys_msg_start
		add_sys_msg 你确定没有看错？藏宝图描绘的地点似乎在冰岛地图
		set_sys_msg_mode 4 0 0
		msg_info
	endcase
	case 2
...
proc 100
	...
	if 41 < 50
		NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao1_boss.mac
	endif
	if 41 >= 50 and 41 < 60
		NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao2_boss.mac
	endif
	if 41 >= 60 and 41 < 70
		NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao3_boss.mac
	endif
	if 41 >= 70 and 41 < 80
		NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao4_boss.mac
	endif
	if 41 >= 80
		NEW_NPC_PRIVATE 2 0 333033 60 0 0 0 DJcangbao5_boss.mac
	endif
endproc
