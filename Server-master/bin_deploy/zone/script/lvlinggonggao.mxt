proc 1
	...
	task_add_option 3140 1 801
	task_stat 3140 1 10
	if 10 = 2
		option 501 #我已浏览完条约内容，可以开始作答了
	endif
...
proc 501
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b和平模式中是否能对攻击你的玩家进行反击？——【战斗模式】
	option 701 #是
	option 601 #否
	talk
endproc
...
proc 502
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b公会宣战模式是否能攻击己方公会的闪名、红名和黑名玩家？——【战斗模式】
	option 702 #是
	option 602 #否
	talk
endproc
...
proc 503
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b在其它公会的公会城市击杀玩家，是否会获得杀气值？——【地图规则】
	option 603 #是
	option 703 #否
	talk
endproc
...
proc 504
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b在中立区域的地图击杀白名玩家，是否会获得杀气值？——【地图规则】
	option 604 #是
	option 704 #否
	talk
endproc
...
proc 505
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b当杀气值≥30时，是否会被记名为红名玩家？——【杀气值】
	option 605 #是
	option 705 #否
	talk
endproc
...
proc 506
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b杀气值越高，是否每分钟减少的杀气值越少？——【杀气值】
	option 606 #是
	option 706 #否
	talk
endproc
...
proc 507
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b若黑名玩家死亡，是否会损失人物的经验值？——【红黑名】
	option 607 #是
	option 707 #否
	talk
endproc
...
proc 508
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b击杀闪名、红名、黑名玩家，是否会获得杀气值？——【红黑名】
	option 708 #是
	option 608 #否
	talk
endproc
...
proc 509
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b野外的巡逻卫兵是否会攻击遇到的红黑名玩家？——【红黑名】
	option 609 #是
	option 709 #否
	talk
endproc
...
proc 510
	DIALOG 1
	add_talk $_npc$:
	add_talk #b#b黑名玩家使用传送道具或死亡选择回复活点复活，是否会被送到监狱？——【红黑名】
	option 610 #是
	option 710 #否
	talk
endproc
...
proc 701
	...
	add_talk #b#b#c186506很抱歉你的回答错误，可重新作答这道题目。#n
	option 701 #是
	option 601 #否
	talk
endproc
