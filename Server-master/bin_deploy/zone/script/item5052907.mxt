...
proc 1
	...
	get_role_var 10 8 0 zhi
	
	if zhi < 1
		GET_PACK_SPACE 0 ret
		if ret >= 8
			DEC_ITEM_NUM_INPAK 5052907 1 10
			if 10 = 0
				...
				; ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 3653001 1 1 0
				...
				ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5600222 1 1 0

				var zhi 1
				set_role_var 10 8 @zhi 1
			endif
		else
			add_sys_msg_start
		...
		add_sys_msg_start
		add_sys_msg 你已开启过17173公测特权金卡，无法再开启
