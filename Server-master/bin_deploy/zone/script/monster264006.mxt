...
;怪物巡逻结束事件
	...
	if Mon_Ret = 0
		...
		if PatrolID = 15 
			...
			switch NumRand_3
				case 100
					MON_CHG_MAP 2300 16190 3886 20 20 1
				endcase 
				case 101
					MON_CHG_MAP 2300 16190 3886 33 20 1
				endcase
				case 102
					MON_CHG_MAP 2300 16190 3886 34 20 1
				endcase
...
;	endif
	...
	if 32 != 1000
		...
		if 13 = 20 
			...
			MON_CALL_ENEMY_MON 200024 2 90 1 @MonX @MonY 1000 0 0 0 30 1 0
			MON_CALL_ENEMY_MON 200025 2 90 1 @MonX @MonY 1000 0 0 0 30 1 0
			var 13 0
			SET_MON_VAR 1 8 @13 1		
		endif
	endif
