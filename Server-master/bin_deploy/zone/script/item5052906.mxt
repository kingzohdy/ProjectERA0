...
proc 1
	get_role_var 9 8 0 20
	
	if 20 = 1
		strvar ret
		GET_PACK_SPACE 0 ret
		if ret > 0
			DEC_ITEM_NUM_INPAK 5052906 1 10
			if 10 = 0
	...
	if 20 = 0
		...
		if ret >= 9
			DEC_ITEM_NUM_INPAK 5052906 1 10
			if 10 = 0
				ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 3653003 1 1 0
				...
				ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5004130 3 1 0
				ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5005126 1 1 0
				ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5054006 1 1 0
				ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5052930 1 1 0
				var 20 1
				set_role_var 9 8 @20 1
			endif
		else
			add_sys_msg_start
