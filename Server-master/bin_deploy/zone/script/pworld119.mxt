...
proc 1 
	...
	;阻挡1
	NEW_MON_BY_DIR 201273 1 16900 29200 0 0 0 30 1 menmid1 
	var 10 @menmid1
	set_pworld_var 0 32 @10 1
	
	;阻挡2
	NEW_MON_BY_DIR 201273 1 14200 22300 0 0 0 45 1 menmid2
	var 11 @menmid2
	set_pworld_var 4 32 @11 1
	
	
	;阻挡3
	NEW_MON_BY_DIR 201273 1 27600 21100 0 0 0 90 1 menmid3 
	var 12 @menmid3
	...
	;2号进入战斗后刷 阻挡
;	NEW_MON_BY_DIR 201273 1 8900 26000 0 0 0 45 1 menmid4
;	var 13 @menmid4
;	set_pworld_var 16 32 @13 1
	;3号进入战斗后刷 阻挡
;	NEW_MON_BY_DIR 201273 1 23800 24800 0 0 0 45 1 menmid4
;	var 13 @menmid4
;	set_pworld_var 20 32 @13 1
	...
	;第二结界烈焰结界BOSS德鲁伊;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	NEW_MON_BY_DIR 201258 1 11400 24000 0 0 0 30 1 momid	
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
	
	;第三结界牧树结界;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	NEW_MON_BY_DIR 201267 1 26200 23100 0 0 0 30 1 momid
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
	SET_MON_GROUP 1 @momid 304
	NEW_MON_BY_DIR 201268 1 26100 23600 0 0 0 30 1 momid
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
	SET_MON_GROUP 1 @momid 304
	LINK_MON 1 304
	...
	;第四古武结界;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	NEW_MON_BY_DIR 201269 1 26600 8300 0 0 0 30 1 momid
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 

	;第五结界牢笼;;;;;;;;;;;;;;;;;;;;;;;;;专家副本才有++++++++++++++++++++++++++++++++++++++++++++
	NEW_MON_BY_DIR 201272 1 17000 14000 0 0 0 30 1 momid
;	NEW_LIFE_MON 201272 1 17000 14000 0 0 0 0 1200 0 momid
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
	;npc罩子
	NEW_NPC 1 301007 17000 14000 0 60zhuanjiazhao.mac
	GET_MAP_NPC_ID 301007 npcmid 1
	var 51 @npcmid
	set_pworld_var 28 32 @51 1
	
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;	声明变量
	var 50 0
	set_pworld_var 24 32 @50 1
;	队员进入副本后发送中央倒计时，存储当前时间的变量 -专家
	var 20 0
	set_pworld_var 32 32 @20 1
...
;	两只牧树人都死
	...
	call 790
	NEW_MON_BY_DIR 201292 1 15400 28100 0 519 0 30 1 Ret1 
	NEW_MON_BY_DIR 201292 1 9500 30200 0 520 0 30 1 Ret1 
	NEW_MON_BY_DIR 201292 1 19000 21000 0 521 0 30 1 Ret1 
	NEW_MON_BY_DIR 201292 1 24500 24700 0 522 0 30 1 Ret1 
	NEW_MON_BY_DIR 201292 1 28200 17800 0 523 0 30 1 Ret1 
	NEW_MON_BY_DIR 201292 1 25100 12800 0 524 0 30 1 Ret1 
...
;	call 98
	call 99
	;;;;;;;;;;;;;;;;;刷单独小怪
	NEW_MON_BY_DIR 201293 1 9500 29400 0 0 0 120 1 Ret1 	
;	NEW_MON_BY_DIR 201293 1 9500 30600 0 0 0 120 1 Ret1 	
	NEW_MON_BY_DIR 201298 1 22500 24300 0 0 0 30 1 Ret1 	
	NEW_MON_BY_DIR 201298 1 22600 24900 0 0 0 30 1 Ret1 	
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;6.26号修改
	...
	rand 33 2
	if 33 = 0
		NEW_NPC 1 304012 16200 31500 135 senlin_liulanghan.mac
	endif
	if 33 = 1
		NEW_NPC 1 304012 19300 26100 90 senlin_liulanghan.mac
	endif

	;变量-如果为1  第一波只出BOSS，不刷小怪，在流浪汉处设置
	var 50 0
...
;;;;;;;;;;;;;;;;;;;;专家副本用;;;;;;;+++++++++++++++++++++++++++++++++++++++++
	...
	if 47 = 1	
		;获取副本当前tick里面从1970年到现在的时间
		GET_TIME_SEC 30
		;获取一下从1970到开始计时时的时间长度（NPC对话时记录的）
		get_pworld_var 16 32 1 time	
		sub 30 @time
		
		;获取一下倒计时总时间10
		get_pworld_var 24 32 1 10
		if 30 >= @10
			
			;当前的时间等于倒计时时，删除老大 xxxxxxx
			DESTROY_MON_BY_DEFID 1 201272
			del_npc 301007 1
			COUNT_DOWN 11 0 0 拯救蓝鹰队员倒计时：
			
			add_sys_msg_start
			add_sys_msg 无情的时间夺去了蓝鹰队员的生命，英雄们不要放弃，去打败古武族首领，为他们报仇！
...
;			MON_SPEECH @14 1 2 1 嘟嘟鸟来了。。。。。。。。。。。。。。。。
			...
			;第一波刷嘟嘟鸟，随机一种
			if aa = 0
				NEW_MON_BY_DIR 201276 1 18500 30200 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79
				
				NEW_MON_BY_DIR 201276 1 18400 29700 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79 
			
				
				NEW_MON_BY_DIR 201276 1 18600 29200 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79 
				
				
				NEW_MON_BY_DIR 201276 1 19200 29000 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79 
				
				
			endif
			if aa = 1
				NEW_MON_BY_DIR 201276 1 18400 30000 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79  
				
				NEW_MON_BY_DIR 201276 1 18400 29400 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79 
				
				NEW_MON_BY_DIR 201276 1 18800 29000 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79 
				
				NEW_MON_BY_DIR 201276 1 19500 29100 0 0 0 120 1 50
				;;SET_MON_GROUP 1 @50 79 
	...
	if roc = 2
		...
		GET_MON_NUM_BY_DEFID 201285 num
		if num = 0
			get_pworld_var 104 8 1 44
			if 44 = 0
			...
			if 44 = 3
				...
				DEL_NPC 201102 1
				NEW_MON_BY_DIR 201250 1 19200 29800 0 0 0 30 1 momid
				TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
				var roc 0
				set_pworld_var 101 8 @roc 1
			endif
	...
	if roc >= 50
		...
		if roc = 50
		;驯鹿
			GET_MON_NUM_BY_DEFID 201276 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 51
		;蝎子
			GET_MON_NUM_BY_DEFID 201281 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 52
		;野猪
			GET_MON_NUM_BY_DEFID 201280 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 53
		;豹子
			GET_MON_NUM_BY_DEFID 201279 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 54
		;老虎
			GET_MON_NUM_BY_DEFID 201278 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 55
		;剑齿虎
			GET_MON_NUM_BY_DEFID 201277 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 56
		;蝙蝠
			GET_MON_NUM_BY_DEFID 201282 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 57
		;蜘蛛
			GET_MON_NUM_BY_DEFID 201283 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 58
		;狼
			GET_MON_NUM_BY_DEFID 201284 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
				...
				if 44 = 2
					...
					mon_speech @mid 0 2 1 没有得到帮助，流浪汉失望的离开了
					del_npc 304012 1
				endif
			endif
		endif
...
;;;;;;;;;;;;;;;;;;;;;;;1111111专家11111111111111111111111111111111111111111111111111111111111
;箭头指向4号BOSS
	;26900 15300
	;箭头位置 26000 15300
	strvar px py m
	...
	if 42 = 0
		get_pworld_var 105 8 1 45
		if 45 = 0
			effect 0 0 playEffct(26000,15300,35,"effect\\entity\\9570_16.ent")
		endif
		add 45 1
		set_pworld_var 105 8 @45 1
		if 45 = 2
	...
	if 42 = 1
		...
		set_pworld_var 105 8 @45 1
		if 45 = 1
			COUNT_DOWN 11 0 0 毁灭倒计时：
			get_pworld_var 28 32 1 51 
			MON_SPEECH @51 1 2 1 感谢英雄们，我终于获救了，我先行离开了，古武族首领就交给你们了
		endif
		if 45 = 3
			del_npc 301007 1
			
			NEW_MON_BY_DIR 307021 1 17000 14000 0 0 0 0 1 momid
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201289 1 13900 27800 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201293 1 13500 30500 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201294 1 13500 30500 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201293 1 11500 29600 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201294 1 11500 29600 100 0 0 30 1 Ret1 
;	if 1 = 0
;		;;SET_MON_GROUP 1 @Ret1 99
;	endif
;	NEW_MON_BY_DIR 201294 1 11500 29600 100 0 0 30 1 Ret1 
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201289 1 10400 30500 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201293 1 8200 25600 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;proc 168
	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201294 1 8200 25600 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;proc 184
;	strvar Ret1
;		NEW_MON_BY_DIR 201298 1 24200 22800 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 185
;	strvar Ret1
;		NEW_MON_BY_DIR 201299 1 24200 22800 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 186
;	strvar Ret1
;		NEW_MON_BY_DIR 201300 1 24200 22800 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 190
;	strvar Ret1
;		NEW_MON_BY_DIR 201301 1 25600 21600 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 191
;	strvar Ret1
;		NEW_MON_BY_DIR 201302 1 25600 21600 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 192
;	strvar Ret1
;		NEW_MON_BY_DIR 201303 1 25600 21600 100 0 0 30 1 Ret1 
;		if 1 = 0
...
proc 790
	NEW_MON_BY_DIR 201289 1 13400 22700 0 511 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 300
	NEW_MON_BY_DIR 201289 1 13800 22700 0 512 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 300
	;;LINK_MON 1 300
	
	NEW_MON_BY_DIR 201286 1 12800 25600 0 513 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 301
	NEW_MON_BY_DIR 201286 1 12800 26200 0 514 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 301
	;;LINK_MON 1 301
	
	NEW_MON_BY_DIR 201291 1 9900 25100 0 515 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 302
	NEW_MON_BY_DIR 201291 1 9400 25100 0 516 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 302
	;;LINK_MON 1 302
	
;	NEW_MON_BY_DIR 201287 1 8200 30500 0 517 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 303
	
;	NEW_MON_BY_DIR 201287 1 8700 30500 0 518 0 30 1 Ret1 
	;;SET_MON_GROUP 1 @Ret1 303
...
;驯鹿
	...
	if a = 0
		...
		;;SET_MON_GROUP 1 @50 83 
		NEW_MON_BY_DIR @mondef 1 19200 22900 0 0 0 121 1 50
		;;SET_MON_GROUP 1 @50 83
		rand b 4
		if b = 0
