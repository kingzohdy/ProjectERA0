...
;怪物巡逻结束事件
	...
	if Mon_Ret = 0
		if PatrolID = 20 or PatrolID = 33 or PatrolID = 34 or PatrolID = 22
		...
		if PatrolID = 15 
			...
			switch NumRand_1
				case 100
					MON_CHG_MAP 2300 16100 20800 20 20 1
				endcase
				case 101
					MON_CHG_MAP 2300 16100 20800 33 20 1
				endcase
				case 102
					MON_CHG_MAP 2300 16100 20800 34 20 1
				endcase
				case 103
					MON_CHG_MAP 2300 16190 20698 21 20 1
				endcase
			endswitch
		endif
		...
		if 32 != 1000
			...
			if 13 = 20 
				...
				if Rad = 0
					...
					MON_CALL_ENEMY_MON 200026 2 35 2 @OutMonX @OutMonY 500 0 0 0 60 1 0
					MON_CALL_ENEMY_MON 200027 2 35 2 @OutMonX @OutMonY 500 0 0 0 60 1 0
				endif
				var 13 0
				SET_MON_VAR 1 8 @13 1		
			endif
