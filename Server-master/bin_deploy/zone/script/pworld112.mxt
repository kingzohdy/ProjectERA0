...
PROC 1					;创建副本事件
	...
	set_pworld_var 104 32 @31 1
		...
		;NEW_MON 206335 1 11486 18553 0 39 0 1 2
		;NEW_MON 206333 4 11486 18553 10 39 0 1 2
		;NEW_MON 206335 1 13063 16552 0 40 0 1 2
		;NEW_MON 206333 4 13063 16552 10 40 0 1 2
		;NEW_MON 206335 1 15171 17907 0 41 0 1 2
		;NEW_MON 206333 4 15171 17907 10 41 0 1 2
		;NEW_MON 206335 1 14145 19407 0 42 0 1 2
		;NEW_MON 206333 4 14145 19407 10 42 0 1 2
		NEW_MON 206336 4 6990 15185 0 0 0 1 2
		NEW_MON 206336 4 5875 15781 0 0 0 1 2
		NEW_MON 206336 4 6760 17562 0 0 0 1 2
		NEW_MON 206336 4 8776 18074 0 0 0 1 2
		NEW_MON 206336 4 8642 15596 0 0 0 1 2
...
PROC 3
	...
	if 11 = 1 and 13 = 0
		...
		NEW_MON 206335 1 11486 18553 0 280 0 1 2
		NEW_MON 206333 1 11386 18553 0 282 0 1 2
		NEW_MON 206333 1 11586 18553 0 283 0 1 2
		NEW_MON 206333 1 11486 18653 0 281 0 1 2
		NEW_MON 206333 1 11486 18453 0 285 0 1 2
		var 13 1
		set_pworld_var 16 32 @13 1
	endif
	if 11 = 11 and 13 = 1
	...
	if 11 = 41 and 13 = 4
		...
		if 17 = 2
			...
			if 18 = 2
			DEL_NPC 306015 2
			NEW_MON_BY_DIR 206339 1 9153 16822 0 0 0 47 1 16	;新月狼王
			set_pworld_var 56 32 @16 1
		...
		get_pworld_var 16 32 1 13
		if 107 = 2
			get_mon_num_by_defid 206329 20
			get_mon_num_by_defid 206330 21
			add 106 1
			SET_PWORLD_VAR 40 32 @106 1
			GET_PWORLD_VAR 40 32 1 106
			;加速刷怪
			...
			set_sys_msg_mode 4 0 0
			map_msg_info
			NEW_MON 206329 3 19035 11475 200 284 0 1 22
			set_pworld_var 84 32 @22 1
			endif

			if 106 = 8
				NEW_MON 206329 5 19035 11475 200 284 0 1 2
			endif
			...
			if 106 = 18
				...
				set_sys_msg_mode 4 0 0
				map_msg_info
				NEW_MON 206329 2 17685 11799 400 286 0 1 2
				NEW_MON 206330 1 17685 11799 400 286 0 1 22
				set_pworld_var 84 32 @22 1
				endif
			endif
			
			if 106 = 21
				NEW_MON 206329 4 17685 11799 400 286 0 1 2
				NEW_MON 206330 1 17685 11799 400 286 0 1 2
			endif
			...
			if 106 = 31
				...
				set_sys_msg_mode 4 0 0
				map_msg_info
				NEW_MON 206329 5 21271 12389 400 287 0 1 2
				NEW_MON 206330 1 21271 12389 400 287 0 1 22
				set_pworld_var 84 32 @22 1
				endif
			endif
			...
			if 106 = 34
				NEW_MON 206329 5 21271 12389 400 287 0 1 2
				NEW_MON 206330 1 21271 12389 400 287 0 1 2
			endif
			...
			if 106 = 40
				...
				set_sys_msg_mode 4 0 0
				map_msg_info
				NEW_MON_BY_DIR 206337 1 19035 11475 0 0 0 95 1 16
				set_pworld_var 56 32 @16 1
				get_pworld_var 56 32 1 16
		...
		if 108 = 2
			NEW_MON 206334 5 18238 4177 600 0 0 1 2
			NEW_MON 206334 5 18394 3278 600 0 0 1 2
			NEW_MON 206334 5 20218 3227 600 0 0 1 2
			NEW_MON 206334 5 20235 4340 600 0 0 1 2
			var 108 3
			set_pworld_var 48 32 @108 1
		endif
	...
	if 10 = 2
		...
		GET_PWORLD_VAR 36 32 1 105
			...
			if 105 = 15
			del_npc 306018 105
			NEW_MON 206338 1 19248 3548 0 0 0 1 16
			set_pworld_var 56 32 @16 1
			get_pworld_var 56 32 1 16
			TARGET_ADD_STATUS 3 @16 1095 1 7200 2
			endif
...
PROC 4
	...
	If @14 = 206337
		...
		get_pworld_var 0 32 1 10
		if 10 < 1
		get_mon_info 1 206337 0 0 0 0 103 104
		add 103 100
		sub 104 200
		del_npc 306018 2
	...
	set_pworld_var 52 32 @15 1
		...
		get_pworld_var 0 32 1 10		
		if 10 < 1
		get_mon_info 1 206338 0 0 0 0 103 104
		add 103 100
		add 104 300
		del_npc 306018 2
