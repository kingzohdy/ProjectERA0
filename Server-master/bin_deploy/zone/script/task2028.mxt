...
proc 1
	...
	strvar Loc
	var Loc 0
	set_task_var 2028 1 8 @Loc 1
	;
	
	strvar Tim2
	var Tim2 0
	set_task_var 2028 2 8 @Tim2 1
	;计时器  10秒内没做表情任务失败
	strvar Loc2
	var Loc2 0
	set_task_var 2028 3 8 @Loc2 1
	...
	strvar Loc4
	var Loc4 0
	set_task_var 2028 5 8 @Loc4 1
	
	strvar LocNum
	var LocNum 0
	set_task_var 2028 6 8 @LocNum 1
	;等于6的时候完成任务
...
proc 6
	...
	GET_POINT_DIST 5500 7500 @px @py M
	...
	if M > 1000
		...
		add_sys_msg_start
		add_sys_msg 您距离阿斯旺太远，无法与他配合，请与阿斯旺对话，重新开始表演
	...
	set_task_var 2028 0 8 @Tim 1	
	if Tim = 1
		GET_MAP_NPC_ID 302087 50 0 
		mon_speech @50 0 0 1 伙计们，这是我们亲爱的#Name#，精心为大家演绎的节目——双簧，有请#Name#登场！	
...
;		add_sys_msg_start
;		add_sys_msg 准备R-a-d=$@Rad$   L-o-c=$@Loc$
;		set_sys_msg_mode 1 0 0
;		msg_info
		
	endif
	
;	get_task_var 2026 1 8 1 Loc
;	add_sys_msg_start
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;计数6次完成任务
	get_task_var 2028 6 8 1 LocNum
	if LocNum >= 6
		GET_MAP_NPC_ID 302087 50 0 
