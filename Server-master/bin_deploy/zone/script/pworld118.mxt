...
proc 1 
	...
	;阻挡大门
	NEW_MON_BY_DIR 201244 1 24800 32200 0 0 0 40 1 menmid4
	var 13 @menmid4
...
;	set_pworld_var 20 32 @13 1
	...
	;第二结界烈焰结界BOSS德鲁伊;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	NEW_MON_BY_DIR 201188 1 11400 24000 0 0 0 30 1 momid	
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
	
	;第三结界牧树结界;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	NEW_MON_BY_DIR 201197 1 26200 23100 0 0 0 30 1 momid
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
	SET_MON_GROUP 1 @momid 304
	NEW_MON_BY_DIR 201198 1 26100 23600 0 0 0 30 1 momid
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
	SET_MON_GROUP 1 @momid 304
	LINK_MON 1 304
	...
	;第四古武结界;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	NEW_MON_BY_DIR 201199 1 26600 8300 0 0 0 30 1 momid
	TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
...
;	两只牧树人都死
	...
	call 790
	NEW_MON_BY_DIR 201222 1 15400 28100 0 519 0 30 1 Ret1 
	NEW_MON_BY_DIR 201222 1 9500 30200 0 520 0 30 1 Ret1 
	NEW_MON_BY_DIR 201222 1 19000 21000 0 521 0 30 1 Ret1 
	NEW_MON_BY_DIR 201222 1 24500 24700 0 522 0 30 1 Ret1 
	NEW_MON_BY_DIR 201222 1 28200 17800 0 523 0 30 1 Ret1 
	NEW_MON_BY_DIR 201222 1 25100 12800 0 524 0 30 1 Ret1 
...
;	call 98
	call 99
	;;;;;;;;;;;;;;;;;刷单独小怪
	NEW_MON_BY_DIR 201223 1 9500 29400 0 0 0 120 1 Ret1 	
;	NEW_MON_BY_DIR 201223 1 9500 30600 0 0 0 120 1 Ret1 	
	NEW_MON_BY_DIR 201228 1 22500 24300 0 0 0 30 1 Ret1 	
	NEW_MON_BY_DIR 201228 1 22600 24900 0 0 0 30 1 Ret1 	
...
;			MON_SPEECH @14 1 2 1 嘟嘟鸟来了。。。。。。。。。。。。。。。。
			...
			rand aa 2
			if aa = 0
				NEW_MON_BY_DIR 201206 1 18500 30200 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79
				
				NEW_MON_BY_DIR 201206 1 18400 29700 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79 
			
				
				NEW_MON_BY_DIR 201206 1 18600 29200 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79 
				
				
				NEW_MON_BY_DIR 201206 1 19200 29000 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79 
				
				
			endif
			if aa = 1
				NEW_MON_BY_DIR 201206 1 18400 30000 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79  
				
				NEW_MON_BY_DIR 201206 1 18400 29400 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79 
				
				NEW_MON_BY_DIR 201206 1 18800 29000 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79 
				
				NEW_MON_BY_DIR 201206 1 19500 29100 0 0 0 120 1 50
				;SET_MON_GROUP 1 @50 79 
	...
	if roc = 2
		...
		GET_MON_NUM_BY_DEFID 201215 num
		if num = 0
			get_pworld_var 104 8 1 44
			if 44 = 0
			...
			if 44 = 3
				...
				DEL_NPC 201102 1
				NEW_MON_BY_DIR 201180 1 19200 29800 0 0 0 30 1 momid
				TARGET_ADD_STATUS 3 @momid 1095 1 25920000 0 
				var roc 3
				set_pworld_var 101 8 @roc 1
			endif
	...
	if roc >= 50
		...
		if roc = 50
		;驯鹿
			GET_MON_NUM_BY_DEFID 201206 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 51
		;蝎子
			GET_MON_NUM_BY_DEFID 201211 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 52
		;野猪
			GET_MON_NUM_BY_DEFID 201210 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 53
		;豹子
			GET_MON_NUM_BY_DEFID 201209 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 54
		;老虎
			GET_MON_NUM_BY_DEFID 201208 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 55
		;剑齿虎
			GET_MON_NUM_BY_DEFID 201207 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 56
		;蝙蝠
			GET_MON_NUM_BY_DEFID 201212 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 57
		;蜘蛛
			GET_MON_NUM_BY_DEFID 201213 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
		...
		if roc = 58
		;狼
			GET_MON_NUM_BY_DEFID 201214 num
			if num = 0
				get_pworld_var 104 8 1 44
				if 44 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201219 1 13900 27800 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201223 1 13500 30500 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201224 1 13500 30500 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201223 1 11500 29600 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201224 1 11500 29600 100 0 0 30 1 Ret1 
;	if 1 = 0
;		;SET_MON_GROUP 1 @Ret1 99
;	endif
;	NEW_MON_BY_DIR 201224 1 11500 29600 100 0 0 30 1 Ret1 
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201219 1 10400 30500 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201223 1 8200 25600 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;proc 168
	;11
;	strvar ad rad Ret1
;	NEW_MON_BY_DIR 201224 1 8200 25600 100 0 0 30 1 Ret1 
;	if 1 = 0
...
;proc 184
;	strvar Ret1
;		NEW_MON_BY_DIR 201228 1 24200 22800 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 185
;	strvar Ret1
;		NEW_MON_BY_DIR 201229 1 24200 22800 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 186
;	strvar Ret1
;		NEW_MON_BY_DIR 201230 1 24200 22800 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 190
;	strvar Ret1
;		NEW_MON_BY_DIR 201231 1 25600 21600 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 191
;	strvar Ret1
;		NEW_MON_BY_DIR 201232 1 25600 21600 100 0 0 30 1 Ret1 
;		if 1 = 0
...
;proc 192
;	strvar Ret1
;		NEW_MON_BY_DIR 201233 1 25600 21600 100 0 0 30 1 Ret1 
;		if 1 = 0
...
proc 790
	NEW_MON_BY_DIR 201219 1 13400 22700 0 511 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 300
	NEW_MON_BY_DIR 201219 1 13800 22700 0 512 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 300
	;;LINK_MON 1 300
	
	NEW_MON_BY_DIR 201216 1 12800 25600 0 513 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 301
	NEW_MON_BY_DIR 201216 1 12800 26200 0 514 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 301
	;;LINK_MON 1 301
	
	NEW_MON_BY_DIR 201221 1 9900 25100 0 515 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 302
	NEW_MON_BY_DIR 201221 1 9400 25100 0 516 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 302
	;;LINK_MON 1 302
	
;	NEW_MON_BY_DIR 201217 1 8200 30500 0 517 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 303
	
;	NEW_MON_BY_DIR 201217 1 8700 30500 0 518 0 30 1 Ret1 
	;SET_MON_GROUP 1 @Ret1 303
