...
PROC 1
	...
	;CALL_MON 1 293131 100 600 21995 22014 1
	
; -------------------------------------------------------
	;hnz挂起，调试火焰藏宝图宝箱偶尔开不出道具BUG
	; GET_PLAYER_BASE_ATT 0 40 41 42
	; if @41 >= 20 and @41 < 30
		; CALL_MON 1 293220 100 600 21995 22014 1
	; endif
	; if @41 >= 30 and @41 < 40
		; CALL_MON 1 293220 100 600 21995 22014 1
	; endif
...
; -------------------------------------------------------
	;hnz新增，调试火焰藏宝图宝箱偶尔开不出道具BUG
	GET_PLAYER_BASE_ATT 0 40 41 42
	if @41 >= 20 and @41 < 30
		CALL_MON 1 293121 100 600 21995 22014 1
	endif
	if @41 >= 30 and @41 < 40
		CALL_MON 1 293122 100 600 21995 22014 1
	endif
	if @41 >= 40 and @41 < 50
		CALL_MON 1 293131 100 600 21995 22014 1
	endif
	if @41 >= 50 and @41 < 60
		CALL_MON 1 293132 100 600 21995 22014 1
	endif
	if @41 >= 60 and @41 < 70
		CALL_MON 1 293133 100 600 21995 22014 1
	endif
	if @41 >= 70 and @41 < 80
		CALL_MON 1 293134 100 600 21995 22014 1
	endif
	if @41 >= 80 and @41 < 90
		CALL_MON 1 293135 100 600 21995 22014 1
	endif
	if @41 >= 90 and @41 < 100
		CALL_MON 1 293136 100 600 21995 22014 1
	endif
	if @41 >= 100 and @41 < 110
		CALL_MON 1 293137 100 600 21995 22014 1
	endif
	if @41 >= 110 and @41 <= 120
		CALL_MON 1 293138 100 600 21995 22014 1
	endif
; -------------------------------------------------------
...
; -------------------------------------------------------
		...
		;ADD_SYS_MSG 恭喜你，你通过了考验，现在去领取你的奖励吧
		SET_SYS_MSG_MODE 4 0 0
		MAP_MSG_INFO
...
proc 5
	...
	;ADD_SYS_MSG 每隔2秒火焰会移向相邻的方格，躲开火焰坚持1分钟即可通过考验
