...
proc 1
	strvar Odds1 Odds2 Odds3 Item1 Item2 Item3 Rand1
	var Item1 0
	var Item2 0
	var Item3 0
	;USE_TREASURE_PIC  #物品ID #有效范围 @返回值 @角度 @地图ID @X坐标 @Y坐标
	USE_TREASURE_PIC 5062008 1000 10 4 5 6 7
	...
	if 10 = 0
			...
			rand Rand1 2
					...
					if Odds1 >= 30 and Odds1 < 35
						var Item1 5221322
					endif
					if Odds1 >= 35 and Odds1 < 40
						var Item1 5221222
					endif
					if Odds1 >= 40 and Odds1 < 50
						var Item1 5221022
					endif
					if Odds1 >= 50 and Odds1 < 60
						var Item1 5222022
					endif							
					...
					if Odds1 >= 85 and Odds1 < 93
						var Item1 5050210
					endif
					if Odds1 >= 93 and Odds1 < 98
						var Item1 5050510
					endif
			...
			rand Odds2 98
					...
					if Odds2 >= 30 and Odds2 < 35
						var Item2 5221322
					endif
					if Odds2 >= 35 and Odds2 < 40
						var Item2 5221222
					endif
					if Odds2 >= 40 and Odds2 < 50
						var Item2 5221022
					endif
					if Odds2 >= 50 and Odds2 < 60
						var Item2 5222022
					endif							
					...
					if Odds2 >= 85 and Odds2 < 93
						var Item2 5050210
					endif
					if Odds2 >= 93 and Odds2 < 98
						var Item2 5050510
					endif
			...
			rand Odds3 98
					...
					if Odds3 >= 5 and Odds3 < 10
						var Item3 5222320
					endif
					if Odds3 >= 10 and Odds3 < 20
						var Item3 5222122
					endif
					if Odds3 >= 20 and Odds3 < 30
						var Item3 5221122
					endif
					if Odds3 >= 30 and Odds3 < 35
						var Item3 5221322
					endif
					if Odds3 >= 35 and Odds3 < 40
						var Item3 5221222
					endif
					if Odds3 >= 40 and Odds3 < 50
						var Item3 5221022
					endif
					if Odds3 >= 50 and Odds3 < 60
						var Item3 5222022
					endif							
					if Odds3 >= 60 and Odds3 < 65
						var Item3 5222420
					endif			
					if Odds3 >= 65 and Odds3 < 70
						var Item3 5223320
					endif
					if Odds3 >= 70 and Odds3 < 75
						var Item3 5229302
					endif
					if Odds3 >= 75 and Odds3 < 80
						var Item3 5229502
					endif
					if Odds3 >= 80 and Odds3 < 85
						var Item3 5209003
					endif
					if Odds3 >= 85 and Odds3 < 93
						var Item3 5050210
					endif
					if Odds3 >= 93 and Odds3 < 98
						var Item3 5050510
					endif
			endif
			ADD_ITEM_ON_MAP 8 1 @Item1 1 @Item2 1 @Item3 1
			
			If 8 = 0
				ITEM_ADD_ONEDAY 5062000 1
				;使用次数+1
				dec_item_num_inpak 5062008 1 0
