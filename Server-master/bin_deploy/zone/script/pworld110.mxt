...
PROC 1
	...
	NEW_MON 206400 1 12339 21357 0 292 0 1 2
	NEW_MON 206400 1 13071 21283 0 293 0 1 2
	NEW_MON 206400 1 20839 21424 0 294 0 1 2
	NEW_MON 206400 1 12154 18401 0 295 0 1 2

	new_mon 204019 1 23831 10835 0 0 0 1 2



	get_map_mon_id 206224 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	get_map_mon_id 206225 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	get_map_mon_id 206227 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	get_map_mon_id 206233 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	...
	;将两个BOSS设定到组22
	GET_MAP_MON_ID 206224 2 1
	SET_MON_GROUP 1 @2 22
	GET_MAP_MON_ID 206225 2 1
	SET_MON_GROUP 1 @2 22
...
PROC 3
	...
	if 21 = 2
		...
		if 26 = 2
			...
			map_msg_info
			del_npc 332001 1
			NEW_MON 206226 1 23256 8010 0 0 0 1 13
			set_pworld_var 28 32 @13 1
			get_pworld_var 28 32 1 13
			TARGET_ADD_STATUS 3 @13 1095 1 7200 2
		endif
