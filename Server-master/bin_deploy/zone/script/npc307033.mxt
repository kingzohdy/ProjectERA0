		...
		if @num < 6
			...
			if ret = 1
				if zhi2 < 30
					...
					if zhi < 950
						if zhi < 400
							ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5052184 1 1 0
						endif
						if zhi >= 400 and zhi < 945
							ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5052175 1 1 0
						endif
						if zhi >= 945 and zhi < 950
							ADD_ITEM_NUM_INPAK_NOLIMIT 5052194 1 1 0
							call 102
						endif
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小箱绑银、一些强化石、慧然果子和战备箱！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif
					if zhi >= 950
						ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5060004 1 1 0
							
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小箱绑银、一些强化石、慧然果子和一块合金！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif
				endif
				if zhi2 >= 30 and zhi2 < 38
					...
					if zhi < 950
						...
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小箱绑银、一些强化石、独悟果子和战备箱！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif
					if zhi >= 950
						...
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小箱绑银、一些强化石、独悟果子和一块合金！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif
				endif
		...
		if @num < 6
			...
			if ret = 1
				...
				if zhi < 950
					...
					ADD_SYS_MSG_START
					ADD_SYS_MSG 你从领主的遗产中找到了一小箱绑银、一些强化石和战备箱！
					SET_SYS_MSG_MODE 3 0 0
					MSG_INFO
				endif
				if zhi >= 950
					...
					ADD_SYS_MSG_START
					ADD_SYS_MSG 你从领主的遗产中找到了一小箱绑银、一些强化石和一块合金！
					SET_SYS_MSG_MODE 3 0 0
					MSG_INFO
				endif
...
proc 101
	...
	ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5052818 1 1 0
