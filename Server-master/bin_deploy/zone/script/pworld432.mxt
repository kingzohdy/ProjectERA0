...
proc 1
	...
	;各阵营枢纽守护者
	;NEW_DYN_MON 1 303073 1 8106 12167 0 0 0 2 1 0 0
	NEW_CAMP_NPC 1 303073 8106 12167 135 1 npc303073.mac
	;SET_CAMP_MON_MAP_SHOW #返回标志 #怪物MemID #阵营 #类型
;	if @1 > 0
;		SET_CAMP_MON_MAP_SHOW 2 @1 1 0
;	endif
	;NEW_DYN_MON 1 303074 1 15919 25655 0 0 0 2 2 0 0
	NEW_CAMP_NPC 1 303074 15919 25655 0 2 npc303074.mac
	;SET_CAMP_MON_MAP_SHOW #返回标志 #怪物MemID #阵营 #类型
;	if @1 > 0
;		SET_CAMP_MON_MAP_SHOW 2 @1 2 0
;	endif
	;NEW_DYN_MON 1 303075 1 24000 10950 0 0 0 2 3 0 0
	NEW_CAMP_NPC 1 303075 24000 10950 60 3 npc303075.mac
	;SET_CAMP_MON_MAP_SHOW #返回标志 #怪物MemID #阵营 #类型
;	if @1 > 0
...
;	endif
	...
	NEW_MON 261246 1 9285 12319 0 0 0 1 3 
	;SET_CAMP_MON_MAP_SHOW #返回标志 #怪物MemID #阵营 #类型
	...
	;NEW_MON #怪物id #怪物数量 #坐标x #坐标y #随机半径 #巡逻ID #是否可以重生 #返回标志 #第一只怪物的实例ID
	NEW_MON 261247 1 16041 23527 0 0 0 1 3 
	;SET_CAMP_MON_MAP_SHOW #返回标志 #怪物MemID #阵营 #类型
	;SET_MON_CAMP_IDX #返回值 #实例ID #阵营索引
	if 1 = 0
	...
	;NEW_MON #怪物id #怪物数量 #坐标x #坐标y #随机半径 #巡逻ID #是否可以重生 #返回标志 #第一只怪物的实例ID
	NEW_MON 261248 1 22734 12442 0 0 0 1 3 
	;SET_CAMP_MON_MAP_SHOW #返回标志 #怪物MemID #阵营 #类型
	;SET_MON_CAMP_IDX #返回值 #实例ID #阵营索引
	if 1 = 0
...
;	GET_MON_NUM_BY_DEFID 261246 3
;	if defid = 261246 or 3 < 1
;		add dienum 1
;		add diecamp 1
;	endif 
	if defid = 261246 
	...
	;枢纽怪 2
	;GET_MON_NUM_BY_DEFID #怪物的定义ID #返回标志
;	GET_MON_NUM_BY_DEFID 261247 3
;	if defid = 261247 or 3 < 1
;		add dienum 1
;		add diecamp 2
;	endif 
	if defid = 261247 
	...
	;枢纽怪 3
	;GET_MON_NUM_BY_DEFID #怪物的定义ID #返回标志
;	GET_MON_NUM_BY_DEFID 261248 3
;	if defid = 261248 or 3 < 1
;		add dienum 1
;		add diecamp 3
;	endif 
	if defid = 261248 
