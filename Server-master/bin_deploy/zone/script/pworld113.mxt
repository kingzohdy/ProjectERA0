...
PROC 1
	...
	NEW_MON 206401 1 12339 21357 0 296 0 1 2
	NEW_MON 206401 1 13071 21283 0 297 0 1 2
	NEW_MON 206401 1 20839 21424 0 298 0 1 2
	NEW_MON 206401 1 12154 18401 0 299 0 1 2

	new_mon 204019 1 23831 10835 0 0 0 1 2



	get_map_mon_id 206344 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	get_map_mon_id 206345 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	get_map_mon_id 206347 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	get_map_mon_id 206353 13 1
	set_pworld_var 28 32 @13 1
	get_pworld_var 28 32 1 13
	TARGET_ADD_STATUS 3 @13 1095 1 7200 2
	...
	;将两个BOSS设定到组22
	GET_MAP_MON_ID 206344 2 1
	SET_MON_GROUP 1 @2 22
	GET_MAP_MON_ID 206345 2 1
	SET_MON_GROUP 1 @2 22
...
PROC 3
	...
	if 21 = 2
		...
		if 26 = 2
			...
			map_msg_info
			del_npc 332001 1
			NEW_MON 206346 1 23256 8010 0 0 0 1 13
			set_pworld_var 28 32 @13 1
			get_pworld_var 28 32 1 13
			TARGET_ADD_STATUS 3 @13 1095 1 7200 2
		endif
