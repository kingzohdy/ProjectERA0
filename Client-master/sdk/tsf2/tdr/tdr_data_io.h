...
*	- TDR_IO_OLD_XML_VERSION	表示FO-DR定义输入/输出格式
*	- TDR_IO_NEW_XML_VERSION 表示TSF-G-DR定义的输入/输出格式
...
*
*@note 如果a_iCutOffVersion为0 ，则安装剪裁到最高版本
*@note 如果a_iIOVersion指定除TDR_IO_NEW_XML_VERSION，TDR_IO_OLD_XML_VERSION以外的值，则强制按照版本2进行处理
*
...
*@param[in] a_iCutOffVersion	要剪裁的版本号
*@param[in] a_iIOVersion XML格式输入/输出的版本,目前支持两个版本
*	- TDR_IO_OLD_XML_VERSION	表示旧的输入/输出格式
*	- TDR_IO_NEW_XML_VERSION 表示新的输入/输出格式
