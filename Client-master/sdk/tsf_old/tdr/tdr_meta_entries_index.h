...
{
	//char szName[TDR_NAME_LEN];	/**<成员的名称*/  //直接使用pstEntry中的名字
...
*/
TDR_API void *tdr_calc_entry_address(IN void *a_pMetaBase, IN LPTDRMETAENTRYNAMEINDEX a_pstNameIndex, IN LPTDRMETAENTRYOFFINDEX a_pstOffIndex, IN const char *a_pszName);
