...
*@param[in] a_pstMeta 需要定位的结构的元数据描述句柄
*@param[out] a_pszBuff 保存成员路径信息的缓冲区，其空间在函数外分配
*@param[in] a_iBuff 缓冲区的可用空间大小
...
*@pre \e a_iOff 必须大于等于0
*/
TDR_API int tdr_entry_off_to_path(IN LPTDRMETA a_pstMeta, OUT char *a_pszBuff, IN int a_iBuff,  IN int a_iOff);
...
/** @}*/ /* TDR_META_MANAGE TDR_数据成员(entry)管理*/
