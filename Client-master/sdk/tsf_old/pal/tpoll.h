...
**  $Id: tpoll.h,v 1.7 2007/12/28 03:59:02 steve Exp $
**  @author $Author: steve $
**  @date $Date: 2007/12/28 03:59:02 $
...
*********************************************************************/
	int tpoll_create (IN int a_iSize);
...
*********************************************************************/
	int tpoll_ctl(IN int a_iTpfd, IN int a_iOp, IN int a_iFd, IN TPOLL_EVENT* a_pstEvent);
...
*********************************************************************/
	int tpoll_wait(IN int a_iTpfd, OUT TPOLL_EVENT* a_pstEvents, IN int a_iMaxEvents, IN int a_iTimeout);
...
*	@retval 0 for success.
*********************************************************************/
	int tpoll_destroy(IN int a_iTpfd);
...
*********************************************************************/
	int tpoll_recv(IN int a_iTpfd, IN int a_iFd, IN TPOLL_EVENT* a_pstEvent, OUT char* a_pszBuff, IN int a_iBuff);
...
*********************************************************************/
	int tpoll_send(IN int a_iTpfd, IN int a_iFd, IN TPOLL_EVENT* a_pstEvent, IN char* a_pszBuff, IN int a_iBuff);
...
*********************************************************************/
	int tpoll_accept(IN int a_iTpfd, IN int a_iFd, IN TPOLL_EVENT* a_pstEvent, OUT struct sockaddr* a_pstAddr, INOUT int* a_piLen);
