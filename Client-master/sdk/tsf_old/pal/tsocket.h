...
**  $Id: tsocket.h,v 1.6 2007/10/31 10:49:54 steve Exp $
**  @author $Author: steve $
**  @date $Date: 2007/10/31 10:49:54 $
...
*********************************************************************/
int tsocket_open(IN int a_iAf, IN int a_iType, IN int a_iProto);
...
*********************************************************************/
int tsocket_open_unix(IN int a_iType);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_reuse_addr(IN int a_iSock, IN int a_iIsReuseAddr);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_set_nonblock(IN int a_iSock, IN int a_iIsNonblock);
...
*********************************************************************/
int tsocket_start_connect(IN int a_iSock, IN struct sockaddr* a_pstAddr, IN int a_iLen);
...
*********************************************************************/
int tsocket_check_connect(IN int a_iSock, IN int a_iTimeout);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_listen(IN int a_iSock, IN struct sockaddr* a_pstAddr, IN int a_iLen, IN int a_iBacklog);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_connect(IN int a_iSock, IN struct sockaddr* a_pstAddr, IN int a_iLen, IN int a_iTimeout);
...
*********************************************************************/
int tsocket_accept(IN int a_iSock, OUT struct sockaddr* a_pstAddr, INOUT int* a_piLen, IN int a_iTimeout);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_close(IN int a_iSock);
...
*********************************************************************/
int tsocket_send(IN int a_iSock, IN const char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*	@param[in,out] a_piLen the size of buffer as input, data size for return.
...
*********************************************************************/
int tsocket_recv(IN int a_iSock, OUT char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*	@retval >=0  the bytes sent.
*********************************************************************/
int tsocket_sendall(IN int a_iSock, IN const char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*	@retval >=0  the bytes received.
*********************************************************************/
int tsocket_recvall(IN int a_iSock, OUT char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_set_recvbuff(IN int a_iSock, IN int a_iSize);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_set_sendbuff(IN int a_iSock, IN int a_iSize);
...
*	@retval 0 for success.
*********************************************************************/
int tsocket_get_type(IN int a_iSock, OUT int* a_piType);
...
*	@param[in] a_iSock descriptor of the socket.
*	@param[in] a_piType the pointer to buffer for hold the information whether this socket ia an acceptable socket.
*	@return whether the operation is succeed.
*	@retval -1 for failure.
*	@retval 0 for success.
*********************************************************************/
int tsocket_get_acceptconn(IN int a_iSock, OUT int* a_piAcceptConn);
