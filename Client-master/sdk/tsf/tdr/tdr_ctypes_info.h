...
*  @{
*/
#define TDR_SIZEOF_BYTE		1	/**<char存储字节数 */
#define TDR_SIZEOF_SHORT	2	/**<short类型整数的存储字节数*/
#define TDR_SIZEOF_INT	4	/**<int类型整数的存储字节数*/
#define TDR_SIZEOF_LONGLONG	8	/**<longlong类型存储的字节数*/
/**   @}*/
