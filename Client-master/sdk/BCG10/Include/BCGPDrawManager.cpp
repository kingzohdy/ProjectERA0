...
#if (!defined _BCGPCALENDAR_STANDALONE) && !(defined _BCGPGRID_STANDALONE) && !(defined _BCGSUITE_)
...
void CBCGPDrawManager::DrawLine (int x1, int y1, int x2, int y2, COLORREF clrLine)
{
	if (clrLine == -1)
	{
		return;
...
void CBCGPDrawManager::DrawLineA (double x1, double y1, double x2, double y2, COLORREF clrLine)
{
	if (clrLine == -1)
	{
		return;
...
void CBCGPDrawManager::DrawEllipse (const CRect& rect, COLORREF clrFill, COLORREF clrLine)
{
