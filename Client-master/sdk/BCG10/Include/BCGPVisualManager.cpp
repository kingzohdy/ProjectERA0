...
void CBCGPVisualManager::DrawGanttHeaderText (const CBCGPGanttChart*, CDC& dc, const BCGP_GANTT_CHART_HEADER_CELL_INFO& cellInfo, const CString& sCellText, BOOL bHilite) const
{
	...
	dc.SetTextColor (bHilite ? globalData.clrHotText : globalData.clrBarText);
					...
					CDC* pDC, CBCGPRibbonCaptionButton* pButton)
{
	...
	CBCGPMenuImages::Draw (pDC, imageID, pButton->GetRect (),
		pButton->IsDisabled () ? 
		CBCGPMenuImages::ImageGray : CBCGPMenuImages::ImageBlack);
											 ...
											 CRect rect, CString str)
{
	...
	COLORREF clrTextOld = pDC->SetTextColor (
		pElement->IsDisabled () ? globalData.clrGrayedText : ::GetSysColor (COLOR_INFOTEXT));
...
void CBCGPWinXPThemeManager::CleanUpThemes ()
{
	...
	{
		(*m_pfCloseThemeData) (m_hThemeToolTip);
	}
	...
	if (m_hThemeNavigation != NULL)
	{
		(*m_pfCloseThemeData) (m_hThemeNavigation);
	}
}
//**********************************************************************************
