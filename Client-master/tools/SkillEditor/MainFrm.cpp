...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndFightWorkSpace.Create (_T("战斗模拟"), this, CRect (0, 0, 200, 200),
	...
	//m_wndFightWorkSpace.SetIcon (imagesWorkspace.ExtractIcon (0), FALSE);

	if (!m_wndCreatSkillWorkSpace.Create (_T("技能编辑"), this, CRect (0, 0, 200, 200),
	...
	//m_wndCreatSkillWorkSpace.SetIcon (imagesWorkspace.ExtractIcon (1), FALSE);
	...
	m_wndFightWorkSpace.EnableDocking(CBRS_ALIGN_ANY);
	m_wndCreatSkillWorkSpace.EnableDocking(CBRS_ALIGN_ANY);
	m_wndOutput.EnableDocking(CBRS_ALIGN_ANY);
	EnableDocking(CBRS_ALIGN_ANY);
	EnableAutoHideBars(CBRS_ALIGN_ANY);
	DockControlBar(&m_wndMenuBar);
	DockControlBar(&m_wndToolBar);
	DockControlBar(&m_wndFightWorkSpace);
	m_wndCreatSkillWorkSpace.AttachToTabWnd (&m_wndFightWorkSpace, BCGP_DM_STANDARD, FALSE, NULL);
...
BOOL CMainFrame::OnWndMsg(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pResult)
{
	...
	{
		m_wndView.OnWndMsg( message, wParam, lParam, pResult );
	}
