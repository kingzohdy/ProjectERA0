...
namespace TE
{
	...
	public:
		...
		void StrafeTerrain(float units,Terrain* terrain,float height);
		void WalkTerrain(float units,Terrain* terrain,float height = 0);
		...
		void getCameraAxis(Ogre::Vector3 &dir, Ogre::Vector3 &up, Ogre::Vector3 &right);
