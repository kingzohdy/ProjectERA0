...
MMoveObjectProcess::MMoveObjectProcess(void)
{	
...
bool MMoveObjectProcess::Process( MTerrainEdit* pEditor , ActionEvent *event )
{
	...
	case MouseLDown:
		{	
			...
			{
				MSelectObjectProcess::Process( pEditor, event );
...
bool   MMoveObjectProcess::TestCurSelectModel( MTerrainEdit* pEditor , MVec3 &dir , MVec3 &pos  )
{	
...
void  MMoveObjectProcess::Undo( MTerrainEdit* pEditor )
{
...
void  MMoveObjectProcess::MoveSelectModel(  MTerrainEdit* pEditor ,MVec3 &dir,MVec3 &pos,int mode)
{
	MVec3  pos0;
	...
	MVec3   dPos = pos0 - pEditor->m_pCurSelectModel->GetModelData ()->pos ;
