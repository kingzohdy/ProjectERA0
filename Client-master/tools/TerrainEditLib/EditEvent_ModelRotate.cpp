...
namespace TE
{
	ModelRotateEditHandler::ModelRotateEditHandler(void)
	{
	...
	bool ModelRotateEditHandler::handleEditEvent( TerrainEditMgr* pEditor , ActionEvent *event )
	{
	...
	void ModelRotateEditHandler::rotateSelectModel(TerrainEditMgr* pEditor, int dx, int dy, COORDINATE_SELECT axis)
	{
	...
	void  ModelRotateEditHandler::RoateYSelectModel ( TerrainEditMgr* pEditor ,int dz )
	{
		if( pEditor->m_pCurSelectModel == NULL)
			return;
