...
MModifyLiquidProcess::MModifyLiquidProcess(void)
{	
...
bool MModifyLiquidProcess::Process( MTerrainEdit* pEditor , ActionEvent *event )
{	
...
bool  MModifyLiquidProcess::AddLiquid( MTerrainEdit* pEditor , MVec3 &dir, MVec3 &pos )
{
 	MVec3  pos0;
	...
	if(g_Terrain.TestAndRay (dir,pos,pos0))
	{
		...
		wateropt.chunk_x = gx;
		wateropt.chunk_z = gz;
		MChunk &curchunk = pEditor->GetEditData()->chunkSet[gz][gx];
