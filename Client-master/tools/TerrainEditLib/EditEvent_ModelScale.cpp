...
namespace TE
{
	ModelScaleEditHandler::ModelScaleEditHandler(void)
	{	
	...
	bool ModelScaleEditHandler::handleEditEvent( TerrainEditMgr* pEditor , ActionEvent *event )
	{
	...
	void  ModelScaleEditHandler::ZoomSelectModel( TerrainEditMgr* pEditor ,int  dz)
	{
