; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	i:\svnroot\client\OgreMain\OgreBitArray.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	??0BitArray1D@Ogre@@QAE@XZ			; Ogre::BitArray1D::BitArray1D
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrebitarray.h
;	COMDAT ??0BitArray1D@Ogre@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0BitArray1D@Ogre@@QAE@XZ PROC				; Ogre::BitArray1D::BitArray1D, COMDAT
; _this$ = ecx
...
; 15   : 		}
	...
	pop	ebp
	ret	0
??0BitArray1D@Ogre@@QAE@XZ ENDP				; Ogre::BitArray1D::BitArray1D
_TEXT	ENDS
PUBLIC	?getBuffer@BitArray1D@Ogre@@QBEPAIXZ		; Ogre::BitArray1D::getBuffer
; Function compile flags: /Odtp
;	COMDAT ?getBuffer@BitArray1D@Ogre@@QBEPAIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getBuffer@BitArray1D@Ogre@@QBEPAIXZ PROC		; Ogre::BitArray1D::getBuffer, COMDAT
; _this$ = ecx
...
; 31   : 		}
	...
	pop	ebp
	ret	0
?getBuffer@BitArray1D@Ogre@@QBEPAIXZ ENDP		; Ogre::BitArray1D::getBuffer
_TEXT	ENDS
PUBLIC	?getBufLen@BitArray1D@Ogre@@QBEIXZ		; Ogre::BitArray1D::getBufLen
; Function compile flags: /Odtp
;	COMDAT ?getBufLen@BitArray1D@Ogre@@QBEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getBufLen@BitArray1D@Ogre@@QBEIXZ PROC			; Ogre::BitArray1D::getBufLen, COMDAT
; _this$ = ecx
...
; 35   : 			return ( (m_nPixel*m_Bpp + 31)/32 ) * sizeof(uint);
...
; 36   : 		}
	...
	pop	ebp
	ret	0
?getBufLen@BitArray1D@Ogre@@QBEIXZ ENDP			; Ogre::BitArray1D::getBufLen
_TEXT	ENDS
PUBLIC	?getNumPixel@BitArray1D@Ogre@@QBEIXZ		; Ogre::BitArray1D::getNumPixel
; Function compile flags: /Odtp
;	COMDAT ?getNumPixel@BitArray1D@Ogre@@QBEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getNumPixel@BitArray1D@Ogre@@QBEIXZ PROC		; Ogre::BitArray1D::getNumPixel, COMDAT
; _this$ = ecx
...
; 41   : 		}
	...
	pop	ebp
	ret	0
?getNumPixel@BitArray1D@Ogre@@QBEIXZ ENDP		; Ogre::BitArray1D::getNumPixel
_TEXT	ENDS
PUBLIC	?getBpp@BitArray1D@Ogre@@QBEIXZ			; Ogre::BitArray1D::getBpp
; Function compile flags: /Odtp
;	COMDAT ?getBpp@BitArray1D@Ogre@@QBEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getBpp@BitArray1D@Ogre@@QBEIXZ PROC			; Ogre::BitArray1D::getBpp, COMDAT
; _this$ = ecx
...
; 46   : 		}
	...
	pop	ebp
	ret	0
?getBpp@BitArray1D@Ogre@@QBEIXZ ENDP			; Ogre::BitArray1D::getBpp
_TEXT	ENDS
PUBLIC	?setPixel@BitArray1D@Ogre@@QAEXII@Z		; Ogre::BitArray1D::setPixel
; Function compile flags: /Odtp
;	COMDAT ?setPixel@BitArray1D@Ogre@@QAEXII@Z
_TEXT	SEGMENT
_this$ = -20						; size = 4
_bits$ = -16						; size = 4
_off$ = -12						; size = 4
...
_x$ = 8							; size = 4
_data$ = 12						; size = 4
?setPixel@BitArray1D@Ogre@@QAEXII@Z PROC		; Ogre::BitArray1D::setPixel, COMDAT
; _this$ = ecx
...
; 50   : 			assert( x < m_nPixel );
; 51   : 
; 52   : 			size_t bits = x*m_Bpp;
...
; 54   : 			size_t off = bits&31;

	mov	eax, DWORD PTR _bits$[ebp]
	and	eax, 31					; 0000001fH
	mov	DWORD PTR _off$[ebp], eax

; 55   : 			size_t mask = m_Mask << off;
...
; 56   : 			m_pBuffer[i] = (m_pBuffer[i]&~mask) | ((data<<off)&mask);
...
; 57   : 		}
	...
	pop	ebp
	ret	8
?setPixel@BitArray1D@Ogre@@QAEXII@Z ENDP		; Ogre::BitArray1D::setPixel
_TEXT	ENDS
PUBLIC	?getPixel@BitArray1D@Ogre@@QBEII@Z		; Ogre::BitArray1D::getPixel
; Function compile flags: /Odtp
;	COMDAT ?getPixel@BitArray1D@Ogre@@QBEII@Z
_TEXT	SEGMENT
_this$ = -16						; size = 4
_bits$ = -12						; size = 4
_off$ = -8						; size = 4
_i$ = -4						; size = 4
_x$ = 8							; size = 4
?getPixel@BitArray1D@Ogre@@QBEII@Z PROC			; Ogre::BitArray1D::getPixel, COMDAT
; _this$ = ecx
...
; 61   : 			assert( x < m_nPixel );
; 62   : 
; 63   : 			size_t bits = x*m_Bpp;
...
; 65   : 			size_t off = bits&31;

	mov	eax, DWORD PTR _bits$[ebp]
	and	eax, 31					; 0000001fH
	mov	DWORD PTR _off$[ebp], eax

; 66   : 			return (m_pBuffer[i]>>off) & m_Mask;
...
; 67   : 		}
	...
	pop	ebp
	ret	4
?getPixel@BitArray1D@Ogre@@QBEII@Z ENDP			; Ogre::BitArray1D::getPixel
_TEXT	ENDS
PUBLIC	??1BitArray1D@Ogre@@QAE@XZ			; Ogre::BitArray1D::~BitArray1D
PUBLIC	??0BitArray2D@Ogre@@QAE@XZ			; Ogre::BitArray2D::BitArray2D
EXTRN	___security_cookie:DWORD
EXTRN	___CxxFrameHandler3:PROC
EXTRN	@__security_check_cookie@4:PROC
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??0BitArray2D@Ogre@@QAE@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0BitArray2D@Ogre@@QAE@XZ$0
__ehfuncinfo$??0BitArray2D@Ogre@@QAE@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0BitArray2D@Ogre@@QAE@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	00H
; Function compile flags: /Odtp
xdata$x	ENDS
;	COMDAT ??0BitArray2D@Ogre@@QAE@XZ
_TEXT	SEGMENT
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??0BitArray2D@Ogre@@QAE@XZ PROC				; Ogre::BitArray2D::BitArray2D, COMDAT
; _this$ = ecx
...
; 84   : 		{
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0BitArray2D@Ogre@@QAE@XZ
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0BitArray1D@Ogre@@QAE@XZ		; Ogre::BitArray1D::BitArray1D
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??0BitArray2D@Ogre@@QAE@XZ$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1BitArray1D@Ogre@@QAE@XZ		; Ogre::BitArray1D::~BitArray1D
__ehhandler$??0BitArray2D@Ogre@@QAE@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0BitArray2D@Ogre@@QAE@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
??0BitArray2D@Ogre@@QAE@XZ ENDP				; Ogre::BitArray2D::BitArray2D
PUBLIC	?getHeight@BitArray2D@Ogre@@QBEIXZ		; Ogre::BitArray2D::getHeight
PUBLIC	?getWidth@BitArray2D@Ogre@@QBEIXZ		; Ogre::BitArray2D::getWidth
PUBLIC	??0BitArray1D@Ogre@@QAE@ABV01@@Z		; Ogre::BitArray1D::BitArray1D
PUBLIC	??0BitArray2D@Ogre@@QAE@ABV01@@Z		; Ogre::BitArray2D::BitArray2D
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??0BitArray2D@Ogre@@QAE@ABV01@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0BitArray2D@Ogre@@QAE@ABV01@@Z$0
__ehfuncinfo$??0BitArray2D@Ogre@@QAE@ABV01@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0BitArray2D@Ogre@@QAE@ABV01@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	00H
; Function compile flags: /Odtp
xdata$x	ENDS
;	COMDAT ??0BitArray2D@Ogre@@QAE@ABV01@@Z
_TEXT	SEGMENT
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
_rhs$ = 8						; size = 4
??0BitArray2D@Ogre@@QAE@ABV01@@Z PROC			; Ogre::BitArray2D::BitArray2D, COMDAT
; _this$ = ecx

; 88   : 		BitArray2D( const BitArray2D &rhs ) : BitArray1D(rhs), m_Width(rhs.getWidth()), m_Height(rhs.getHeight()){}

	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0BitArray2D@Ogre@@QAE@ABV01@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	mov	eax, DWORD PTR ___security_cookie
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0BitArray1D@Ogre@@QAE@ABV01@@Z	; Ogre::BitArray1D::BitArray1D
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _rhs$[ebp]
	call	?getWidth@BitArray2D@Ogre@@QBEIXZ	; Ogre::BitArray2D::getWidth
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+16], eax
	mov	ecx, DWORD PTR _rhs$[ebp]
	call	?getHeight@BitArray2D@Ogre@@QBEIXZ	; Ogre::BitArray2D::getHeight
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??0BitArray2D@Ogre@@QAE@ABV01@@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1BitArray1D@Ogre@@QAE@XZ		; Ogre::BitArray1D::~BitArray1D
__ehhandler$??0BitArray2D@Ogre@@QAE@ABV01@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0BitArray2D@Ogre@@QAE@ABV01@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0BitArray2D@Ogre@@QAE@ABV01@@Z ENDP			; Ogre::BitArray2D::BitArray2D
PUBLIC	?clear@BitArray1D@Ogre@@QAEXI@Z			; Ogre::BitArray1D::clear
PUBLIC	?clear@BitArray2D@Ogre@@QAEXI@Z			; Ogre::BitArray2D::clear
; Function compile flags: /Odtp
;	COMDAT ?clear@BitArray2D@Ogre@@QAEXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_data$ = 8						; size = 4
?clear@BitArray2D@Ogre@@QAEXI@Z PROC			; Ogre::BitArray2D::clear, COMDAT
; _this$ = ecx
...
; 97   : 			BitArray1D::clear(data);

	mov	eax, DWORD PTR _data$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?clear@BitArray1D@Ogre@@QAEXI@Z		; Ogre::BitArray1D::clear
...
; 98   : 		}
	...
	pop	ebp
	ret	4
?clear@BitArray2D@Ogre@@QAEXI@Z ENDP			; Ogre::BitArray2D::clear
_TEXT	ENDS
PUBLIC	?getBuffer@BitArray2D@Ogre@@QBEPAIXZ		; Ogre::BitArray2D::getBuffer
; Function compile flags: /Odtp
;	COMDAT ?getBuffer@BitArray2D@Ogre@@QBEPAIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getBuffer@BitArray2D@Ogre@@QBEPAIXZ PROC		; Ogre::BitArray2D::getBuffer, COMDAT
; _this$ = ecx
...
; 102  : 			return BitArray1D::getBuffer(); 

	mov	ecx, DWORD PTR _this$[ebp]
	call	?getBuffer@BitArray1D@Ogre@@QBEPAIXZ	; Ogre::BitArray1D::getBuffer
...
; 103  : 		}
	...
	pop	ebp
	ret	0
?getBuffer@BitArray2D@Ogre@@QBEPAIXZ ENDP		; Ogre::BitArray2D::getBuffer
_TEXT	ENDS
PUBLIC	?getBufLen@BitArray2D@Ogre@@QBEIXZ		; Ogre::BitArray2D::getBufLen
; Function compile flags: /Odtp
;	COMDAT ?getBufLen@BitArray2D@Ogre@@QBEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getBufLen@BitArray2D@Ogre@@QBEIXZ PROC			; Ogre::BitArray2D::getBufLen, COMDAT
; _this$ = ecx
...
; 107  : 			return BitArray1D::getBufLen();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?getBufLen@BitArray1D@Ogre@@QBEIXZ	; Ogre::BitArray1D::getBufLen
...
; 108  : 		}
	...
	pop	ebp
	ret	0
?getBufLen@BitArray2D@Ogre@@QBEIXZ ENDP			; Ogre::BitArray2D::getBufLen
; Function compile flags: /Odtp
_TEXT	ENDS
;	COMDAT ?getWidth@BitArray2D@Ogre@@QBEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getWidth@BitArray2D@Ogre@@QBEIXZ PROC			; Ogre::BitArray2D::getWidth, COMDAT
; _this$ = ecx
...
; 113  : 		}
	...
	pop	ebp
	ret	0
?getWidth@BitArray2D@Ogre@@QBEIXZ ENDP			; Ogre::BitArray2D::getWidth
; Function compile flags: /Odtp
_TEXT	ENDS
;	COMDAT ?getHeight@BitArray2D@Ogre@@QBEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getHeight@BitArray2D@Ogre@@QBEIXZ PROC			; Ogre::BitArray2D::getHeight, COMDAT
; _this$ = ecx
...
; 118  : 		}
	...
	pop	ebp
	ret	0
?getHeight@BitArray2D@Ogre@@QBEIXZ ENDP			; Ogre::BitArray2D::getHeight
_TEXT	ENDS
PUBLIC	?getBpp@BitArray2D@Ogre@@QBEIXZ			; Ogre::BitArray2D::getBpp
; Function compile flags: /Odtp
;	COMDAT ?getBpp@BitArray2D@Ogre@@QBEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getBpp@BitArray2D@Ogre@@QBEIXZ PROC			; Ogre::BitArray2D::getBpp, COMDAT
; _this$ = ecx
...
; 122  : 			return BitArray1D::getBpp();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?getBpp@BitArray1D@Ogre@@QBEIXZ		; Ogre::BitArray1D::getBpp
...
; 123  : 		}
	...
	pop	ebp
	ret	0
?getBpp@BitArray2D@Ogre@@QBEIXZ ENDP			; Ogre::BitArray2D::getBpp
_TEXT	ENDS
PUBLIC	?setPixel@BitArray2D@Ogre@@QAEXIII@Z		; Ogre::BitArray2D::setPixel
; Function compile flags: /Odtp
;	COMDAT ?setPixel@BitArray2D@Ogre@@QAEXIII@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_x$ = 8							; size = 4
_y$ = 12						; size = 4
_data$ = 16						; size = 4
?setPixel@BitArray2D@Ogre@@QAEXIII@Z PROC		; Ogre::BitArray2D::setPixel, COMDAT
; _this$ = ecx
...
; 127  : 			assert( x<m_Width && y<m_Height );
; 128  : 
; 129  : 			BitArray1D::setPixel( y*m_Width+x, data );
	...
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?setPixel@BitArray1D@Ogre@@QAEXII@Z	; Ogre::BitArray1D::setPixel
...
; 130  : 		}
	...
	pop	ebp
	ret	12					; 0000000cH
?setPixel@BitArray2D@Ogre@@QAEXIII@Z ENDP		; Ogre::BitArray2D::setPixel
_TEXT	ENDS
PUBLIC	?getPixel@BitArray2D@Ogre@@QBEIII@Z		; Ogre::BitArray2D::getPixel
; Function compile flags: /Odtp
;	COMDAT ?getPixel@BitArray2D@Ogre@@QBEIII@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_x$ = 8							; size = 4
_y$ = 12						; size = 4
?getPixel@BitArray2D@Ogre@@QBEIII@Z PROC		; Ogre::BitArray2D::getPixel, COMDAT
; _this$ = ecx
...
; 134  : 			assert( x<m_Width && y<m_Height );
; 135  : 
; 136  : 			return BitArray1D::getPixel( y*m_Width+x );
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getPixel@BitArray1D@Ogre@@QBEII@Z	; Ogre::BitArray1D::getPixel
...
; 137  : 		}
	...
	pop	ebp
	ret	8
?getPixel@BitArray2D@Ogre@@QBEIII@Z ENDP		; Ogre::BitArray2D::getPixel
_TEXT	ENDS
PUBLIC	?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z		; Ogre::BitArray1D::reduceBppTo
PUBLIC	?reduceBppTo@BitArray2D@Ogre@@QAEXI@Z		; Ogre::BitArray2D::reduceBppTo
; Function compile flags: /Odtp
;	COMDAT ?reduceBppTo@BitArray2D@Ogre@@QAEXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_bpp$ = 8						; size = 4
?reduceBppTo@BitArray2D@Ogre@@QAEXI@Z PROC		; Ogre::BitArray2D::reduceBppTo, COMDAT
; _this$ = ecx
...
; 141  : 			BitArray1D::reduceBppTo(bpp);

	mov	eax, DWORD PTR _bpp$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z	; Ogre::BitArray1D::reduceBppTo
...
; 142  : 		}
	...
	pop	ebp
	ret	4
?reduceBppTo@BitArray2D@Ogre@@QAEXI@Z ENDP		; Ogre::BitArray2D::reduceBppTo
_TEXT	ENDS
...
; 101  : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T62138[ebp], eax
	mov	ecx, DWORD PTR $T62138[ebp]
	mov	DWORD PTR $T62137[ebp], ecx
	cmp	DWORD PTR $T62137[ebp], 0
	je	SHORT $LN3@deleteThis
	push	1
	mov	edx, DWORD PTR $T62137[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T62137[ebp]
...
_TEXT	ENDS
PUBLIC	?init@BitArray1D@Ogre@@QAEXII@Z			; Ogre::BitArray1D::init
PUBLIC	??0BitArray1D@Ogre@@QAE@II@Z			; Ogre::BitArray1D::BitArray1D
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrebitarray.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_npixel$ = 8						; size = 4
_bpp$ = 12						; size = 4
??0BitArray1D@Ogre@@QAE@II@Z PROC			; Ogre::BitArray1D::BitArray1D
; _this$ = ecx
...
; 11   : 		init(npixel, bpp);
	...
	push	ecx
	mov	edx, DWORD PTR _npixel$[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?init@BitArray1D@Ogre@@QAEXII@Z		; Ogre::BitArray1D::init
...
; 12   : 	}
	...
	pop	ebp
	ret	8
??0BitArray1D@Ogre@@QAE@II@Z ENDP			; Ogre::BitArray1D::BitArray1D
_TEXT	ENDS
EXTRN	_memcpy:PROC
...
_num$ = -4						; size = 4
_rhs$ = 8						; size = 4
??0BitArray1D@Ogre@@QAE@ABV01@@Z PROC			; Ogre::BitArray1D::BitArray1D
; _this$ = ecx
...
; 16   : 		size_t num = (m_nPixel*m_Bpp + 31) / 32;
...
; 17   : 		m_pBuffer = new uint[num];
	...
	add	esp, 4
	mov	DWORD PTR $T62194[ebp], eax
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR $T62194[ebp]
	mov	DWORD PTR [eax], ecx

; 18   : 
; 19   : 		memcpy( m_pBuffer, rhs.m_pBuffer, num*sizeof(uint) );
...
; 20   : 	}
	...
	pop	ebp
	ret	4
??0BitArray1D@Ogre@@QAE@ABV01@@Z ENDP			; Ogre::BitArray1D::BitArray1D
; Function compile flags: /Odtp
_this$ = -8						; size = 4
$T62196 = -4						; size = 4
??1BitArray1D@Ogre@@QAE@XZ PROC				; Ogre::BitArray1D::~BitArray1D
; _this$ = ecx
...
; 24   : 		delete[](m_pBuffer);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T62196[ebp], ecx
	mov	edx, DWORD PTR $T62196[ebp]
	push	edx
	call	??_V@YAXPAX@Z				; operator delete[]
	add	esp, 4
...
; 25   : 	}
	...
	pop	ebp
	ret	0
??1BitArray1D@Ogre@@QAE@XZ ENDP				; Ogre::BitArray1D::~BitArray1D
; Function compile flags: /Odtp
_this$ = -16						; size = 4
$T62199 = -12						; size = 4
$T62198 = -8						; size = 4
...
_npixel$ = 8						; size = 4
_bpp$ = 12						; size = 4
?init@BitArray1D@Ogre@@QAEXII@Z PROC			; Ogre::BitArray1D::init
; _this$ = ecx
...
; 29   : 		assert( bpp<32 && IsPowerOfTwo(int(bpp)) );
; 30   : 
; 31   : 		delete[](m_pBuffer);

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T62198[ebp], ecx
	mov	edx, DWORD PTR $T62198[ebp]
	push	edx
	call	??_V@YAXPAX@Z				; operator delete[]
	add	esp, 4
...
; 35   : 
; 36   : 		size_t num = (m_nPixel*m_Bpp + 31) / 32;
...
; 37   : 		m_pBuffer = new uint[num];
	...
	call	??_U@YAPAXI@Z				; operator new[]
	add	esp, 4
	mov	DWORD PTR $T62199[ebp], eax
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR $T62199[ebp]
	mov	DWORD PTR [eax], ecx
...
; 40   : 	}
	...
	pop	ebp
	ret	8
?init@BitArray1D@Ogre@@QAEXII@Z ENDP			; Ogre::BitArray1D::init
; Function compile flags: /Odtp
_this$ = -8						; size = 4
_x$57340 = -4						; size = 4
_data$ = 8						; size = 4
?clear@BitArray1D@Ogre@@QAEXI@Z PROC			; Ogre::BitArray1D::clear
; _this$ = ecx
...
; 44   : 		for( size_t x=0; x<m_nPixel; x++ ) setPixel( x, data );

	mov	DWORD PTR _x$57340[ebp], 0
	jmp	SHORT $LN3@clear
$LN2@clear:
	mov	eax, DWORD PTR _x$57340[ebp]
	add	eax, 1
	mov	DWORD PTR _x$57340[ebp], eax
$LN3@clear:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _x$57340[ebp]
	cmp	edx, DWORD PTR [ecx+4]
	jae	SHORT $LN4@clear
	mov	eax, DWORD PTR _data$[ebp]
	push	eax
	mov	ecx, DWORD PTR _x$57340[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?setPixel@BitArray1D@Ogre@@QAEXII@Z	; Ogre::BitArray1D::setPixel
	jmp	SHORT $LN2@clear
...
; 45   : 	}
	...
	pop	ebp
	ret	4
?clear@BitArray1D@Ogre@@QAEXI@Z ENDP			; Ogre::BitArray1D::clear
_TEXT	ENDS
xdata$x	SEGMENT
__unwindtable$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z$0
__ehfuncinfo$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	00H
...
_x$57351 = -36						; size = 4
_shift$ = -32						; size = 4
_tmparray$ = -28					; size = 16
__$EHRec$ = -12						; size = 12
_bpp$ = 8						; size = 4
?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z PROC		; Ogre::BitArray1D::reduceBppTo
; _this$ = ecx
...
; 48   : 	{
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 49   : 		assert( bpp < getBpp() );
; 50   : 		BitArray1D tmparray(m_nPixel, bpp);
	...
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	lea	ecx, DWORD PTR _tmparray$[ebp]
	call	??0BitArray1D@Ogre@@QAE@II@Z		; Ogre::BitArray1D::BitArray1D
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 51   : 		size_t shift = getBpp() - bpp;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?getBpp@BitArray1D@Ogre@@QBEIXZ		; Ogre::BitArray1D::getBpp
	sub	eax, DWORD PTR _bpp$[ebp]
	mov	DWORD PTR _shift$[ebp], eax

; 52   : 
; 53   : 		for( size_t x=0; x<m_nPixel; x++ )

	mov	DWORD PTR _x$57351[ebp], 0
	jmp	SHORT $LN3@reduceBppT
$LN2@reduceBppT:
	mov	eax, DWORD PTR _x$57351[ebp]
	add	eax, 1
	mov	DWORD PTR _x$57351[ebp], eax
$LN3@reduceBppT:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _x$57351[ebp]
	cmp	edx, DWORD PTR [ecx+4]
	jae	SHORT $LN1@reduceBppT

; 54   : 		{
; 55   : 			tmparray.setPixel( x, getPixel(x)>>shift );
	...
	shr	eax, cl
	push	eax
	mov	ecx, DWORD PTR _x$57351[ebp]
	push	ecx
	lea	ecx, DWORD PTR _tmparray$[ebp]
	call	?setPixel@BitArray1D@Ogre@@QAEXII@Z	; Ogre::BitArray1D::setPixel
...
; 56   : 		}
	...
	jmp	SHORT $LN2@reduceBppT
$LN1@reduceBppT:

; 57   : 
; 58   : 		m_Bpp = tmparray.m_Bpp;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _tmparray$[ebp+8]
	mov	DWORD PTR [edx+8], eax

; 59   : 		m_Mask = tmparray.m_Mask;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _tmparray$[ebp+12]
	mov	DWORD PTR [ecx+12], edx
...
; 60   : 		delete[](m_pBuffer);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T62202[ebp], ecx
	mov	edx, DWORD PTR $T62202[ebp]
	push	edx
	call	??_V@YAXPAX@Z				; operator delete[]
	add	esp, 4

; 61   : 		m_pBuffer = tmparray.m_pBuffer;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _tmparray$[ebp]
	mov	DWORD PTR [eax], ecx

; 62   : 		tmparray.m_pBuffer = NULL;

	mov	DWORD PTR _tmparray$[ebp], 0

; 63   : 	}

	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _tmparray$[ebp]
	call	??1BitArray1D@Ogre@@QAE@XZ		; Ogre::BitArray1D::~BitArray1D
	mov	ecx, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, ecx
	pop	ecx
	mov	esp, ebp
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z$0:
	lea	ecx, DWORD PTR _tmparray$[ebp]
	jmp	??1BitArray1D@Ogre@@QAE@XZ		; Ogre::BitArray1D::~BitArray1D
__ehhandler$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-36]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?reduceBppTo@BitArray1D@Ogre@@QAEXI@Z ENDP		; Ogre::BitArray1D::reduceBppTo
PUBLIC	??0BitArray2D@Ogre@@QAE@III@Z			; Ogre::BitArray2D::BitArray2D
xdata$x	SEGMENT
__unwindtable$??0BitArray2D@Ogre@@QAE@III@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0BitArray2D@Ogre@@QAE@III@Z$0
__ehfuncinfo$??0BitArray2D@Ogre@@QAE@III@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0BitArray2D@Ogre@@QAE@III@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	00H
...
_height$ = 12						; size = 4
_bpp$ = 16						; size = 4
??0BitArray2D@Ogre@@QAE@III@Z PROC			; Ogre::BitArray2D::BitArray2D
; _this$ = ecx
...
; 66   : 	{
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0BitArray2D@Ogre@@QAE@III@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	mov	eax, DWORD PTR ___security_cookie
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??0BitArray2D@Ogre@@QAE@III@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1BitArray1D@Ogre@@QAE@XZ		; Ogre::BitArray1D::~BitArray1D
__ehhandler$??0BitArray2D@Ogre@@QAE@III@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0BitArray2D@Ogre@@QAE@III@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0BitArray2D@Ogre@@QAE@III@Z ENDP			; Ogre::BitArray2D::BitArray2D
PUBLIC	??1BitArray2D@Ogre@@QAE@XZ			; Ogre::BitArray2D::~BitArray2D
xdata$x	SEGMENT
__unwindtable$??1BitArray2D@Ogre@@QAE@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??1BitArray2D@Ogre@@QAE@XZ$0
__ehfuncinfo$??1BitArray2D@Ogre@@QAE@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??1BitArray2D@Ogre@@QAE@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	00H
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??1BitArray2D@Ogre@@QAE@XZ PROC				; Ogre::BitArray2D::~BitArray2D
; _this$ = ecx
...
; 70   : 	{
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??1BitArray2D@Ogre@@QAE@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	mov	eax, DWORD PTR ___security_cookie
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??1BitArray2D@Ogre@@QAE@XZ$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1BitArray1D@Ogre@@QAE@XZ		; Ogre::BitArray1D::~BitArray1D
__ehhandler$??1BitArray2D@Ogre@@QAE@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??1BitArray2D@Ogre@@QAE@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
??1BitArray2D@Ogre@@QAE@XZ ENDP				; Ogre::BitArray2D::~BitArray2D
PUBLIC	?init@BitArray2D@Ogre@@QAEXIII@Z		; Ogre::BitArray2D::init
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_width$ = 8						; size = 4
_height$ = 12						; size = 4
_bpp$ = 16						; size = 4
?init@BitArray2D@Ogre@@QAEXIII@Z PROC			; Ogre::BitArray2D::init
; _this$ = ecx
...
; 75   : 		BitArray1D::init(width*height, bpp);
...
; 79   : 	}
	...
	pop	ebp
	ret	12					; 0000000cH
?init@BitArray2D@Ogre@@QAEXIII@Z ENDP			; Ogre::BitArray2D::init
_TEXT	ENDS
PUBLIC	??$Swap@PAM@Ogre@@YAXAAPAM0@Z			; Ogre::Swap<float *>
...
PUBLIC	?dithering@BitArray2D@Ogre@@QAEXI@Z		; Ogre::BitArray2D::dithering
...
$T62223 = -48						; size = 4
$T62222 = -44						; size = 4
_newval$57400 = -40					; size = 4
_newval0$57399 = -36					; size = 4
_error$57406 = -32					; size = 4
_y$57389 = -28						; size = 4
_srcmask$ = -24						; size = 4
_dstmask$ = -20						; size = 4
_curerror$ = -16					; size = 4
...
_x$ = -4						; size = 4
_bpp$ = 8						; size = 4
?dithering@BitArray2D@Ogre@@QAEXI@Z PROC		; Ogre::BitArray2D::dithering
; _this$ = ecx
...
; 91   : 		assert( getBpp()<=16 && bpp<getBpp() );
; 92   : 		uint srcmask = (1<<getBpp()) - 1;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?getBpp@BitArray2D@Ogre@@QBEIXZ		; Ogre::BitArray2D::getBpp
	mov	edx, 1
	mov	ecx, eax
	shl	edx, cl
	sub	edx, 1
	mov	DWORD PTR _srcmask$[ebp], edx

; 93   : 		uint dstmask = (1 << bpp) - 1;

	mov	eax, 1
	mov	ecx, DWORD PTR _bpp$[ebp]
	shl	eax, cl
	sub	eax, 1
	mov	DWORD PTR _dstmask$[ebp], eax

; 94   : 
; 95   : 		float *curerror = new float[m_Width];  //cur row
	...
	call	??_U@YAPAXI@Z				; operator new[]
	add	esp, 4
	mov	DWORD PTR $T62222[ebp], eax
	mov	eax, DWORD PTR $T62222[ebp]
	mov	DWORD PTR _curerror$[ebp], eax

; 96   : 		float *nexterror = new float[m_Width]; //next row
	...
	call	??_U@YAPAXI@Z				; operator new[]
	add	esp, 4
	mov	DWORD PTR $T62223[ebp], eax
	mov	eax, DWORD PTR $T62223[ebp]
	mov	DWORD PTR _nexterror$[ebp], eax

; 97   : 		float factor = float(dstmask)/srcmask;

	mov	ecx, DWORD PTR _dstmask$[ebp]
	mov	DWORD PTR tv274[ebp], ecx
	mov	DWORD PTR tv274[ebp+4], 0
	fild	QWORD PTR tv274[ebp]
	mov	edx, DWORD PTR _srcmask$[ebp]
	mov	DWORD PTR tv278[ebp], edx
	mov	DWORD PTR tv278[ebp+4], 0
	fild	QWORD PTR tv278[ebp]
	fdivp	ST(1), ST(0)
	fstp	DWORD PTR _factor$[ebp]

; 98   : 
; 99   : 		size_t x;
; 100  : 		for( x=0; x<m_Width; x++ ) curerror[x] = 0;

	mov	DWORD PTR _x$[ebp], 0
	jmp	SHORT $LN16@dithering
$LN15@dithering:
...
$LN16@dithering:
	...
	jae	SHORT $LN14@dithering
	mov	eax, DWORD PTR _x$[ebp]
	mov	ecx, DWORD PTR _curerror$[ebp]
	fldz
	fstp	DWORD PTR [ecx+eax*4]
	jmp	SHORT $LN15@dithering
$LN14@dithering:

; 101  : 
; 102  : 		for( size_t y=0; y<m_Height; y++ )

	mov	DWORD PTR _y$57389[ebp], 0
	jmp	SHORT $LN13@dithering
$LN12@dithering:
	mov	edx, DWORD PTR _y$57389[ebp]
	add	edx, 1
	mov	DWORD PTR _y$57389[ebp], edx
$LN13@dithering:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _y$57389[ebp]
	cmp	ecx, DWORD PTR [eax+20]
	jae	$LN11@dithering

; 103  : 		{
; 104  : 			for( x=0; x<m_Width; x++ ) nexterror[x] = 0;

	mov	DWORD PTR _x$[ebp], 0
	jmp	SHORT $LN10@dithering
$LN9@dithering:
	mov	edx, DWORD PTR _x$[ebp]
	add	edx, 1
...
$LN10@dithering:
	...
	jae	SHORT $LN8@dithering
	mov	edx, DWORD PTR _x$[ebp]
	mov	eax, DWORD PTR _nexterror$[ebp]
	fldz
	fstp	DWORD PTR [eax+edx*4]
	jmp	SHORT $LN9@dithering
$LN8@dithering:

; 105  : 
; 106  : 			for( x=0; x<m_Width; x++ )

	mov	DWORD PTR _x$[ebp], 0
	jmp	SHORT $LN7@dithering
$LN6@dithering:
	mov	ecx, DWORD PTR _x$[ebp]
	add	ecx, 1
...
; 107  : 			{
; 108  : 				float newval0 = getPixel(x,y) + curerror[x];
	...
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getPixel@BitArray2D@Ogre@@QBEIII@Z	; Ogre::BitArray2D::getPixel
	mov	DWORD PTR tv305[ebp], eax
	mov	DWORD PTR tv305[ebp+4], 0
	fild	QWORD PTR tv305[ebp]
	mov	eax, DWORD PTR _x$[ebp]
	mov	ecx, DWORD PTR _curerror$[ebp]
	fadd	DWORD PTR [ecx+eax*4]
	fstp	DWORD PTR _newval0$57399[ebp]

; 109  : 				float newval = newval0 * factor;

	fld	DWORD PTR _newval0$57399[ebp]
	fmul	DWORD PTR _factor$[ebp]
	fstp	DWORD PTR _newval$57400[ebp]

; 110  : 				newval = (float)floor(newval + 0.5);

	fld	DWORD PTR _newval$57400[ebp]
...
; 111  : 				newval /= factor;
	...
	fld	DWORD PTR _newval$57400[ebp]
	fdiv	DWORD PTR _factor$[ebp]
	fstp	DWORD PTR _newval$57400[ebp]

; 112  : 				if( newval > float(srcmask) ) newval = float(srcmask);
	...
	jne	SHORT $LN4@dithering
	mov	eax, DWORD PTR _srcmask$[ebp]
	mov	DWORD PTR tv328[ebp], eax
	mov	DWORD PTR tv328[ebp+4], 0
	fild	QWORD PTR tv328[ebp]
	fstp	DWORD PTR _newval$57400[ebp]
$LN4@dithering:

; 113  : 				if( newval < 0 ) newval = 0;

	fld	DWORD PTR _newval$57400[ebp]
	fcomp	QWORD PTR __real@0000000000000000
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN3@dithering
	fldz
	fstp	DWORD PTR _newval$57400[ebp]
$LN3@dithering:

; 114  : 				newval = (float)floor(newval + 0.5f);
...
; 115  : 
; 116  : 				setPixel( x, y, (uint)(newval) );

	fld	DWORD PTR _newval$57400[ebp]
	fnstcw	WORD PTR tv341[ebp]
	movzx	eax, WORD PTR tv341[ebp]
	or	eax, 3072				; 00000c00H
	mov	DWORD PTR tv344[ebp], eax
	fldcw	WORD PTR tv344[ebp]
	fistp	QWORD PTR tv346[ebp]
	fldcw	WORD PTR tv341[ebp]
	...
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?setPixel@BitArray2D@Ogre@@QAEXIII@Z	; Ogre::BitArray2D::setPixel

; 117  : 				float error = newval0 - newval;

	fld	DWORD PTR _newval0$57399[ebp]
	fsub	DWORD PTR _newval$57400[ebp]
	fstp	DWORD PTR _error$57406[ebp]

; 118  : 
; 119  : 				nexterror[x] += error * 5/16;

	fld	DWORD PTR _error$57406[ebp]
	fmul	QWORD PTR __real@4014000000000000
	fdiv	QWORD PTR __real@4030000000000000
	mov	ecx, DWORD PTR _x$[ebp]
	mov	edx, DWORD PTR _nexterror$[ebp]
	fadd	DWORD PTR [edx+ecx*4]
	mov	eax, DWORD PTR _x$[ebp]
	mov	ecx, DWORD PTR _nexterror$[ebp]
	fstp	DWORD PTR [ecx+eax*4]

; 120  : 				if( x > 0 ) nexterror[x-1] += error * 3/16;

	cmp	DWORD PTR _x$[ebp], 0
	jbe	SHORT $LN2@dithering
	fld	DWORD PTR _error$57406[ebp]
	fmul	QWORD PTR __real@4008000000000000
	fdiv	QWORD PTR __real@4030000000000000
	mov	edx, DWORD PTR _x$[ebp]
	mov	eax, DWORD PTR _nexterror$[ebp]
	fadd	DWORD PTR [eax+edx*4-4]
	mov	ecx, DWORD PTR _x$[ebp]
	mov	edx, DWORD PTR _nexterror$[ebp]
...
; 121  : 				if( x < m_Width-1 )
	...
	jae	SHORT $LN1@dithering

; 122  : 				{
; 123  : 					curerror[x+1] += error * 7/16;

	fld	DWORD PTR _error$57406[ebp]
	fmul	QWORD PTR __real@401c000000000000
	fdiv	QWORD PTR __real@4030000000000000
	mov	edx, DWORD PTR _x$[ebp]
	mov	eax, DWORD PTR _curerror$[ebp]
	fadd	DWORD PTR [eax+edx*4+4]
	mov	ecx, DWORD PTR _x$[ebp]
	mov	edx, DWORD PTR _curerror$[ebp]
	fstp	DWORD PTR [edx+ecx*4+4]

; 124  : 					nexterror[x+1] += error * 1/16;

	fld	DWORD PTR _error$57406[ebp]
	fmul	QWORD PTR __real@3ff0000000000000
	fdiv	QWORD PTR __real@4030000000000000
	mov	eax, DWORD PTR _x$[ebp]
	mov	ecx, DWORD PTR _nexterror$[ebp]
...
; 127  : 
; 128  : 			Swap( curerror, nexterror );

	lea	ecx, DWORD PTR _nexterror$[ebp]
	push	ecx
	lea	edx, DWORD PTR _curerror$[ebp]
	push	edx
	call	??$Swap@PAM@Ogre@@YAXAAPAM0@Z		; Ogre::Swap<float *>
	add	esp, 8
...
; 131  : 		delete[](curerror);
	...
	mov	eax, DWORD PTR _curerror$[ebp]
	mov	DWORD PTR $T62224[ebp], eax
	mov	ecx, DWORD PTR $T62224[ebp]
	push	ecx
	call	??_V@YAXPAX@Z				; operator delete[]
	add	esp, 4

; 132  : 		delete[](nexterror);

	mov	edx, DWORD PTR _nexterror$[ebp]
	mov	DWORD PTR $T62225[ebp], edx
	mov	eax, DWORD PTR $T62225[ebp]
	push	eax
	call	??_V@YAXPAX@Z				; operator delete[]
	add	esp, 4
...
; 133  : 	}
	...
	pop	ebp
	ret	4
?dithering@BitArray2D@Ogre@@QAEXI@Z ENDP		; Ogre::BitArray2D::dithering
_TEXT	ENDS
PUBLIC	_floorf
; Function compile flags: /Odtp
...
_floorf	ENDP
_TEXT	ENDS
PUBLIC	??6Ogre@@YAAAVArchive@0@AAV10@AAVBitArray1D@0@@Z ; Ogre::operator<<
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrebitarray.cpp
_TEXT	SEGMENT
_ar$ = 8						; size = 4
_array$ = 12						; size = 4
??6Ogre@@YAAAVArchive@0@AAV10@AAVBitArray1D@0@@Z PROC	; Ogre::operator<<
...
; 141  : 		{
; 142  : 			array.init(array.m_nPixel, array.m_Bpp);
...
; 143  : 			ar.read(array.getBuffer(), array.getBufLen());
...
; 146  : 		{
; 147  : 			ar.write(array.getBuffer(), array.getBufLen());
...
; 151  : 	}
	...
	pop	ebp
	ret	0
??6Ogre@@YAAAVArchive@0@AAV10@AAVBitArray1D@0@@Z ENDP	; Ogre::operator<<
_TEXT	ENDS
PUBLIC	??6Ogre@@YAAAVArchive@0@AAV10@AAVBitArray2D@0@@Z ; Ogre::operator<<
; Function compile flags: /Odtp
_TEXT	SEGMENT
_ar$ = 8						; size = 4
_array$ = 12						; size = 4
??6Ogre@@YAAAVArchive@0@AAV10@AAVBitArray2D@0@@Z PROC	; Ogre::operator<<
...
; 157  : 
; 158  : 		ar << (BitArray1D &)array;

	mov	edx, DWORD PTR _array$[ebp]
	push	edx
	mov	eax, DWORD PTR _ar$[ebp]
	push	eax
	call	??6Ogre@@YAAAVArchive@0@AAV10@AAVBitArray1D@0@@Z ; Ogre::operator<<
	add	esp, 8
...
; 161  : 	}
	...
	pop	ebp
	ret	0
??6Ogre@@YAAAVArchive@0@AAV10@AAVBitArray2D@0@@Z ENDP	; Ogre::operator<<
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogremath.h
_TEXT	ENDS
;	COMDAT ??$Swap@PAM@Ogre@@YAXAAPAM0@Z
_TEXT	SEGMENT
_c$ = -4						; size = 4
_a$ = 8							; size = 4
_b$ = 12						; size = 4
??$Swap@PAM@Ogre@@YAXAAPAM0@Z PROC			; Ogre::Swap<float *>, COMDAT
...
; 107  : 	}
	...
	pop	ebp
	ret	0
??$Swap@PAM@Ogre@@YAXAAPAM0@Z ENDP			; Ogre::Swap<float *>
; Function compile flags: /Odtp
_TEXT	ENDS
