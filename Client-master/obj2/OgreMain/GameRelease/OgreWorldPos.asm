; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	i:\svnroot\client\OgreMain\OgreWorldPos.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 101  : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T62305[ebp], eax
	mov	ecx, DWORD PTR $T62305[ebp]
	mov	DWORD PTR $T62304[ebp], ecx
	cmp	DWORD PTR $T62304[ebp], 0
	je	SHORT $LN3@deleteThis
	push	1
	mov	edx, DWORD PTR $T62304[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T62304[ebp]
...
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogreworldpos.cpp
text$yc	ENDS
;	COMDAT ??__E?m_Origin@WorldPos@Ogre@@2V12@A@@YAXXZ
text$yc	SEGMENT
??__E?m_Origin@WorldPos@Ogre@@2V12@A@@YAXXZ PROC	; `dynamic initializer for 'Ogre::WorldPos::m_Origin'', COMDAT

; 6    : 	WorldPos WorldPos::m_Origin(0, 0, 0);
	...
	push	0
	push	0
	mov	ecx, OFFSET ?m_Origin@WorldPos@Ogre@@2V12@A ; Ogre::WorldPos::m_Origin
	call	??0WorldPos@Ogre@@QAE@HHH@Z		; Ogre::WorldPos::WorldPos
	pop	ebp
	ret	0
??__E?m_Origin@WorldPos@Ogre@@2V12@A@@YAXXZ ENDP	; `dynamic initializer for 'Ogre::WorldPos::m_Origin''
text$yc	ENDS
PUBLIC	?m_Origin@WorldPos@Ogre@@2V12@A			; Ogre::WorldPos::m_Origin
_BSS	SEGMENT
?m_Origin@WorldPos@Ogre@@2V12@A DB 0cH DUP (?)		; Ogre::WorldPos::m_Origin
_TWO_PI	DD	01H DUP (?)
_HALF_PI DD	01H DUP (?)
_BSS	ENDS
CRT$XCU	SEGMENT
...
?m_Origin$initializer$@WorldPos@Ogre@@2P6AXXZA DD FLAT:??__E?m_Origin@WorldPos@Ogre@@2V12@A@@YAXXZ ; Ogre::WorldPos::m_Origin$initializer$
CRT$XCU	ENDS
END
