; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	i:\svnroot\client\OgreMain\OgreRenderTarget.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG5713	DB	'bad allocation', 00H
	ORG $+1
$SG55547 DB	'RenderTarget', 00H
	ORG $+3
$SG55575 DB	'TextureRenderTarget', 00H
CONST	ENDS
...
; 101  : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T59880[ebp], eax
	mov	ecx, DWORD PTR $T59880[ebp]
	mov	DWORD PTR $T59879[ebp], ecx
	cmp	DWORD PTR $T59879[ebp], 0
	je	SHORT $LN3@deleteThis
	push	1
	mov	edx, DWORD PTR $T59879[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T59879[ebp]
...
PUBLIC	?isSuccessCreateRenderTarget@RenderTarget@Ogre@@UAE_NXZ ; Ogre::RenderTarget::isSuccessCreateRenderTarget
PUBLIC	?isSuccessCreateDSBuffer@RenderTarget@Ogre@@UAE_NXZ ; Ogre::RenderTarget::isSuccessCreateDSBuffer
...
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrerendertarget.cpp
_TEXT	ENDS
_TEXT	SEGMENT
_this$ = -4						; size = 4
?isSuccessCreateRenderTarget@RenderTarget@Ogre@@UAE_NXZ PROC ; Ogre::RenderTarget::isSuccessCreateRenderTarget
; _this$ = ecx
...
; 12   : 	}
	...
	pop	ebp
	ret	0
?isSuccessCreateRenderTarget@RenderTarget@Ogre@@UAE_NXZ ENDP ; Ogre::RenderTarget::isSuccessCreateRenderTarget
; Function compile flags: /Odtp
_this$ = -4						; size = 4
?isSuccessCreateDSBuffer@RenderTarget@Ogre@@UAE_NXZ PROC ; Ogre::RenderTarget::isSuccessCreateDSBuffer
; _this$ = ecx
...
; 17   : 	}
	...
	pop	ebp
	ret	0
?isSuccessCreateDSBuffer@RenderTarget@Ogre@@UAE_NXZ ENDP ; Ogre::RenderTarget::isSuccessCreateDSBuffer
_TEXT	ENDS
EXTRN	??0RuntimeClass@Ogre@@QAE@PBDPBV01@HP6APAVBaseObject@1@XZ@Z:PROC ; Ogre::RuntimeClass::RuntimeClass
; Function compile flags: /Odtp
;	COMDAT ??__E?m_RTTI@RenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ
text$yc	SEGMENT
??__E?m_RTTI@RenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ PROC ; `dynamic initializer for 'Ogre::RenderTarget::m_RTTI'', COMDAT

; 6    : 	IMPLEMENT_RTTI_VIRTUAL(RenderTarget, BaseObject, 100)

	push	ebp
	mov	ebp, esp
	push	0
	push	100					; 00000064H
	push	OFFSET ?m_RTTI@BaseObject@Ogre@@2VRuntimeClass@2@B ; Ogre::BaseObject::m_RTTI
	push	OFFSET $SG55547
	mov	ecx, OFFSET ?m_RTTI@RenderTarget@Ogre@@2VRuntimeClass@2@B ; Ogre::RenderTarget::m_RTTI
	call	??0RuntimeClass@Ogre@@QAE@PBDPBV01@HP6APAVBaseObject@1@XZ@Z ; Ogre::RuntimeClass::RuntimeClass
	pop	ebp
	ret	0
??__E?m_RTTI@RenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ ENDP ; `dynamic initializer for 'Ogre::RenderTarget::m_RTTI''
; Function compile flags: /Odtp
text$yc	ENDS
;	COMDAT ??__E?m_RTTI@TextureRenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ
text$yc	SEGMENT
??__E?m_RTTI@TextureRenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ PROC ; `dynamic initializer for 'Ogre::TextureRenderTarget::m_RTTI'', COMDAT

; 7    : 	IMPLEMENT_RTTI_VIRTUAL(TextureRenderTarget, RenderTarget, 100)
	...
	push	OFFSET $SG55575
	mov	ecx, OFFSET ?m_RTTI@TextureRenderTarget@Ogre@@2VRuntimeClass@2@B ; Ogre::TextureRenderTarget::m_RTTI
	call	??0RuntimeClass@Ogre@@QAE@PBDPBV01@HP6APAVBaseObject@1@XZ@Z ; Ogre::RuntimeClass::RuntimeClass
	pop	ebp
	ret	0
??__E?m_RTTI@TextureRenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ ENDP ; `dynamic initializer for 'Ogre::TextureRenderTarget::m_RTTI''
text$yc	ENDS
PUBLIC	?m_RTTI@RenderTarget@Ogre@@2VRuntimeClass@2@B	; Ogre::RenderTarget::m_RTTI
PUBLIC	?m_RTTI@TextureRenderTarget@Ogre@@2VRuntimeClass@2@B ; Ogre::TextureRenderTarget::m_RTTI
_BSS	SEGMENT
?m_RTTI@RenderTarget@Ogre@@2VRuntimeClass@2@B DB 014H DUP (?) ; Ogre::RenderTarget::m_RTTI
?m_RTTI@TextureRenderTarget@Ogre@@2VRuntimeClass@2@B DB 014H DUP (?) ; Ogre::TextureRenderTarget::m_RTTI
_BSS	ENDS
CRT$XCU	SEGMENT
?m_RTTI$initializer$@RenderTarget@Ogre@@2P6AXXZA DD FLAT:??__E?m_RTTI@RenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ ; Ogre::RenderTarget::m_RTTI$initializer$
?m_RTTI$initializer$@TextureRenderTarget@Ogre@@2P6AXXZA DD FLAT:??__E?m_RTTI@TextureRenderTarget@Ogre@@2VRuntimeClass@2@B@@YAXXZ ; Ogre::TextureRenderTarget::m_RTTI$initializer$
CRT$XCU	ENDS
END
