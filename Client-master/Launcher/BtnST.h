...
public:
	...
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0, HBITMAP hBitmapOvr=0, COLORREF crTransColorOvr=0);
