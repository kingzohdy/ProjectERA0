...
#define EEN_PROP_SELECT_COMBO (WM_USER + 2002) 
#define EEN_PROP_UPDATE_VALUE	(WM_USER + 2003)
#define EEN_LINE_UPDATE_DOT	(WM_USER + 2004)

#define ID_VIEW_FIGHT_WORKSPACE		40000
#define ID_PROPLIST_FIGHT_PROP		40001

#define ID_VIEW_SKILLEDIT_WORKSPACE	41000
#define ID_PRPPLIST_SKILL_PROP		41001