...
public:
	...
	CNotifiedProp*  m_pPropPreUpdateTime;
	...
	CNotifiedProp*	m_pPropColorMid;
	CNotifiedProp*	m_pPropSizeMid;
	CNotifiedProp*	m_pPropAspectMid;
	...
	CNotifiedProp *m_pPropCollideOnTerrain;
