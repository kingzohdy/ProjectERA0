...
namespace TE
{
	PathEditHandler::PathEditHandler(void)
	{
	...
	void PathEditHandler::UpdateData( TerrainEditMgr* pEditor )
	{
		pEditor->GetPathSet()->UpdateSelectPathPos();
	};

	bool PathEditHandler::handleEditEvent( TerrainEditMgr* pEditor , ActionEvent *event )
	{
	...
	bool PathEditHandler::TestPathModel(  TerrainEditMgr* pEditor ,Ogre::Vector3 &dir , Ogre::Vector3 &pos  )
	{
		return pEditor->GetPathSet()->TestPathModel( pEditor , dir , pos );
	}

	bool PathEditHandler::AddPathPos(   TerrainEditMgr* pEditor ,Ogre::Vector3 &dir , Ogre::Vector3 &pos  )
	{
		Ogre::Vector3  pos0;
	...
	bool PathEditHandler::MovePathPos(  TerrainEditMgr* pEditor , Ogre::Vector3 &dir , Ogre::Vector3 &pos )
	{
		Ogre::Vector3  pos0;
