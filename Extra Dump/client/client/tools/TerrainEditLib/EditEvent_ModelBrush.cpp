...
namespace TE
{
	ModelBrushEditHandler::ModelBrushEditHandler(void)
	{	
	...
	bool ModelBrushEditHandler::handleEditEvent( TerrainEditMgr* pEditor , ActionEvent *event )
	{
	...
	void  ModelBrushEditHandler::AddObjectTitle( TerrainEditMgr* pEditor )
	{
	...
	void  ModelBrushEditHandler::AddPlantModelToTitle( TerrainEditMgr* pEditor,const char* filename,Ogre::Vector3 pos,Ogre::Vector3 dir,float fscale)
	{
		if( pEditor->GetEditData() == NULL )
		{
			return;
