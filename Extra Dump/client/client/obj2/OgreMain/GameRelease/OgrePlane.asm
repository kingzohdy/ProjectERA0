; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	i:\svnroot\client\OgreMain\OgrePlane.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 101  : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T63486[ebp], eax
	mov	ecx, DWORD PTR $T63486[ebp]
	mov	DWORD PTR $T63485[ebp], ecx
	cmp	DWORD PTR $T63485[ebp], 0
	je	SHORT $LN3@deleteThis
	push	1
	mov	edx, DWORD PTR $T63485[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T63485[ebp]
...
; 198  : 			Vector3 vDis = Abs(box.getCenter() - getCenter());
	...
	lea	eax, DWORD PTR $T63816[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getCenter@BoxBound@Ogre@@QBE?AVVector3@2@XZ ; Ogre::BoxBound::getCenter
	push	eax
	lea	ecx, DWORD PTR $T63817[ebp]
	push	ecx
	mov	ecx, DWORD PTR _box$[ebp]
	call	?getCenter@BoxBound@Ogre@@QBE?AVVector3@2@XZ ; Ogre::BoxBound::getCenter
	push	eax
	lea	edx, DWORD PTR $T63818[ebp]
	push	edx
	call	??GOgre@@YA?AVVector3@0@ABV10@0@Z	; Ogre::operator-
	add	esp, 12					; 0000000cH
	push	eax
...
; 199  : 			Vector3 vRadius = box.getExtension() + getExtension();
	...
	lea	ecx, DWORD PTR $T63819[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getExtension@BoxBound@Ogre@@QBE?AVVector3@2@XZ ; Ogre::BoxBound::getExtension
	push	eax
	lea	edx, DWORD PTR $T63820[ebp]
	push	edx
	mov	ecx, DWORD PTR _box$[ebp]
	call	?getExtension@BoxBound@Ogre@@QBE?AVVector3@2@XZ ; Ogre::BoxBound::getExtension
	push	eax
...
; 331  : 			m_Center = (minpt + maxpt)/2.0f;
	...
	push	ecx
	lea	edx, DWORD PTR $T63867[ebp]
	push	edx
	call	??HOgre@@YA?AVVector3@0@ABV10@0@Z	; Ogre::operator+
	add	esp, 12					; 0000000cH
	push	eax
	lea	eax, DWORD PTR $T63868[ebp]
	push	eax
	call	??KOgre@@YA?AVVector3@0@ABV10@M@Z	; Ogre::operator/
	add	esp, 12					; 0000000cH
	push	eax
...
_TEXT	ENDS
PUBLIC	?rotate@Plane@Ogre@@QAEXABVMatrix4@2@@Z		; Ogre::Plane::rotate
EXTRN	?transformNormal@Matrix4@Ogre@@QBEXAAVVector3@2@ABV32@@Z:PROC ; Ogre::Matrix4::transformNormal
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogreplane.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_mat$ = 8						; size = 4
?rotate@Plane@Ogre@@QAEXABVMatrix4@2@@Z PROC		; Ogre::Plane::rotate
; _this$ = ecx
...
; 37   : 		assert(isValid());
; 38   : 		assert( mat.isOrthonormal() );
; 39   : 
; 40   : 		// rotate the normal
; 41   : 		mat.transformNormal( m_normal, m_normal );
	...
	call	?transformNormal@Matrix4@Ogre@@QBEXAAVVector3@2@ABV32@@Z ; Ogre::Matrix4::transformNormal
...
; 42   : 	}
	...
	pop	ebp
	ret	4
?rotate@Plane@Ogre@@QAEXABVMatrix4@2@@Z ENDP		; Ogre::Plane::rotate
_TEXT	ENDS
PUBLIC	?transformIT@Plane@Ogre@@QAEXABVMatrix4@2@@Z	; Ogre::Plane::transformIT
PUBLIC	?transform@Plane@Ogre@@QAEXABVMatrix4@2@@Z	; Ogre::Plane::transform
EXTRN	?transpose@Matrix4@Ogre@@QAEXXZ:PROC		; Ogre::Matrix4::transpose
EXTRN	?inverse@Matrix4@Ogre@@QBEXAAV12@@Z:PROC	; Ogre::Matrix4::inverse
EXTRN	??0Matrix4@Ogre@@QAE@XZ:PROC			; Ogre::Matrix4::Matrix4
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -68						; size = 4
_invxform$ = -64					; size = 64
_xform$ = 8						; size = 4
?transform@Plane@Ogre@@QAEXABVMatrix4@2@@Z PROC		; Ogre::Plane::transform
; _this$ = ecx
...
; 46   : 		Matrix4 invxform;
	...
	lea	ecx, DWORD PTR _invxform$[ebp]
	call	??0Matrix4@Ogre@@QAE@XZ			; Ogre::Matrix4::Matrix4

; 47   : 		xform.inverse( invxform );

	lea	eax, DWORD PTR _invxform$[ebp]
	push	eax
	mov	ecx, DWORD PTR _xform$[ebp]
	call	?inverse@Matrix4@Ogre@@QBEXAAV12@@Z	; Ogre::Matrix4::inverse

; 48   : 		invxform.transpose();

	lea	ecx, DWORD PTR _invxform$[ebp]
	call	?transpose@Matrix4@Ogre@@QAEXXZ		; Ogre::Matrix4::transpose

; 49   : 
; 50   : 		transformIT( invxform );

	lea	ecx, DWORD PTR _invxform$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?transformIT@Plane@Ogre@@QAEXABVMatrix4@2@@Z ; Ogre::Plane::transformIT
...
; 51   : 	}
	...
	pop	ebp
	ret	4
?transform@Plane@Ogre@@QAEXABVMatrix4@2@@Z ENDP		; Ogre::Plane::transform
_TEXT	ENDS
...
_ret$ = -16						; size = 16
_xform$ = 8						; size = 4
?transformIT@Plane@Ogre@@QAEXABVMatrix4@2@@Z PROC	; Ogre::Plane::transformIT
; _this$ = ecx
...
; 55   : 		Vector4 ret = getVec4() * xform;

	mov	eax, DWORD PTR _xform$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getVec4@Plane@Ogre@@QBEABVVector4@2@XZ	; Ogre::Plane::getVec4
	push	eax
...
; 58   : 		m_normal.y = ret.y;
	...
	mov	eax, DWORD PTR _this$[ebp]
	fld	DWORD PTR _ret$[ebp+4]
	fstp	DWORD PTR [eax+4]

; 59   : 		m_normal.z = ret.z;

	mov	ecx, DWORD PTR _this$[ebp]
	fld	DWORD PTR _ret$[ebp+8]
	fstp	DWORD PTR [ecx+8]

; 60   : 		m_offset   = ret.w;

	mov	edx, DWORD PTR _this$[ebp]
	fld	DWORD PTR _ret$[ebp+12]
...
; 61   : 	}
	...
	pop	ebp
	ret	4
?transformIT@Plane@Ogre@@QAEXABVMatrix4@2@@Z ENDP	; Ogre::Plane::transformIT
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrematrix4.h
_TEXT	ENDS
...
_TEXT	ENDS
PUBLIC	?normalize@Plane@Ogre@@QAEXXZ			; Ogre::Plane::normalize
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogreplane.cpp
_TEXT	SEGMENT
_this$ = -8						; size = 4
_len$ = -4						; size = 4
?normalize@Plane@Ogre@@QAEXXZ PROC			; Ogre::Plane::normalize
; _this$ = ecx
...
; 72   : 	}
	...
	pop	ebp
	ret	0
?normalize@Plane@Ogre@@QAEXXZ ENDP			; Ogre::Plane::normalize
_TEXT	ENDS
PUBLIC	__real@3ff0000000000000
PUBLIC	?CrossProduct@Ogre@@YA?AVVector3@1@ABV21@0@Z	; Ogre::CrossProduct
PUBLIC	?setFromThreePoints@Plane@Ogre@@QAEMABVVector3@2@00@Z ; Ogre::Plane::setFromThreePoints
...
_point2$ = 12						; size = 4
_point3$ = 16						; size = 4
?setFromThreePoints@Plane@Ogre@@QAEMABVVector3@2@00@Z PROC ; Ogre::Plane::setFromThreePoints
; _this$ = ecx
...
; 76   : 		// facing of plane defined by counter-clockwise (??) orientation of the triangle
; 77   : 		//	defined by these three points
; 78   : 		// can fail if the points are on top of eachother !! returns 
; 79   : 		// the area normally, zero on failure !!
; 80   : 		Vector3 delta1 = point2-point1;

	mov	eax, DWORD PTR _point1$[ebp]
	push	eax
	mov	ecx, DWORD PTR _point2$[ebp]
	push	ecx
	lea	edx, DWORD PTR _delta1$[ebp]
	push	edx
	call	??GOgre@@YA?AVVector3@0@ABV10@0@Z	; Ogre::operator-
	add	esp, 12					; 0000000cH

; 81   : 		Vector3 delta2 = point3-point1;

	mov	eax, DWORD PTR _point1$[ebp]
	push	eax
	mov	ecx, DWORD PTR _point3$[ebp]
	push	ecx
	lea	edx, DWORD PTR _delta2$[ebp]
	push	edx
	call	??GOgre@@YA?AVVector3@0@ABV10@0@Z	; Ogre::operator-
	add	esp, 12					; 0000000cH

; 82   : 		m_normal = CrossProduct( delta1, delta2 );

	lea	eax, DWORD PTR _delta2$[ebp]
	push	eax
	lea	ecx, DWORD PTR _delta1$[ebp]
	push	ecx
...
; 83   : 
; 84   : 		float area = m_normal.lengthSqr();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?lengthSqr@Vector3@Ogre@@QBEMXZ		; Ogre::Vector3::lengthSqr
	fstp	DWORD PTR _area$[ebp]

; 85   : 		if ( area < EPSILON*EPSILON )

	fld	DWORD PTR _EPSILON
	fmul	DWORD PTR _EPSILON
	...
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN2@setFromThr

; 86   : 		{
; 87   : 			m_normal = Vector3(0, 0, 0);
...
; 98   : 			m_offset = -DotProduct( m_normal, point1 );
...
; 104  : 	}
	...
	pop	ebp
	ret	12					; 0000000cH
?setFromThreePoints@Plane@Ogre@@QAEMABVVector3@2@00@Z ENDP ; Ogre::Plane::setFromThreePoints
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrevector3.h
_TEXT	ENDS
...
_TEXT	ENDS
PUBLIC	?mirrorPoint@Plane@Ogre@@QAEXAAVVector3@2@ABV32@@Z ; Ogre::Plane::mirrorPoint
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogreplane.cpp
_TEXT	SEGMENT
tv88 = -36						; size = 4
...
_dest$ = 8						; size = 4
_src$ = 12						; size = 4
?mirrorPoint@Plane@Ogre@@QAEXAAVVector3@2@ABV32@@Z PROC	; Ogre::Plane::mirrorPoint
; _this$ = ecx
...
; 108  : 		float dist = distanceToPoint( src );
...
; 110  : 	}
	...
	pop	ebp
	ret	8
?mirrorPoint@Plane@Ogre@@QAEXAAVVector3@2@ABV32@@Z ENDP	; Ogre::Plane::mirrorPoint
_TEXT	ENDS
PUBLIC	?mirrorVector@Plane@Ogre@@QAEXAAVVector3@2@ABV32@@Z ; Ogre::Plane::mirrorVector
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv89 = -36						; size = 4
_this$ = -32						; size = 4
...
_dest$ = 8						; size = 4
_src$ = 12						; size = 4
?mirrorVector@Plane@Ogre@@QAEXAAVVector3@2@ABV32@@Z PROC ; Ogre::Plane::mirrorVector
; _this$ = ecx
...
; 114  : 		float mydot = DotProduct( m_normal, src );
	...
	call	?DotProduct@Ogre@@YAMABVVector3@1@0@Z	; Ogre::DotProduct
	add	esp, 8
	fstp	DWORD PTR _mydot$[ebp]

; 115  : 		dest = src + m_normal*(-mydot*2);

	fld	DWORD PTR _mydot$[ebp]
	fchs
	fadd	ST(0), ST(0)
	fstp	DWORD PTR tv89[ebp]
	fld	DWORD PTR tv89[ebp]
...
; 116  : 	}
	...
	pop	ebp
	ret	8
?mirrorVector@Plane@Ogre@@QAEXAAVVector3@2@ABV32@@Z ENDP ; Ogre::Plane::mirrorVector
_TEXT	ENDS
PUBLIC	?boxSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVBoxBound@2@@Z ; Ogre::Plane::boxSide
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -24						; size = 4
$T63902 = -20						; size = 12
_radius$ = -8						; size = 4
_distToCenter$ = -4					; size = 4
_box$ = 8						; size = 4
?boxSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVBoxBound@2@@Z PROC ; Ogre::Plane::boxSide
; _this$ = ecx
...
; 120  : 		float distToCenter = distanceToPoint(box.getCenter());

	lea	eax, DWORD PTR $T63902[ebp]
	push	eax
	mov	ecx, DWORD PTR _box$[ebp]
	call	?getCenter@BoxBound@Ogre@@QBE?AVVector3@2@XZ ; Ogre::BoxBound::getCenter
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?distanceToPoint@Plane@Ogre@@QBEMABVVector3@2@@Z ; Ogre::Plane::distanceToPoint
	fstp	DWORD PTR _distToCenter$[ebp]

; 121  : 
; 122  : 		float radius = box.getRadiusInDirection(getNormal());

	mov	ecx, DWORD PTR _this$[ebp]
	call	?getNormal@Plane@Ogre@@QBEABVVector3@2@XZ ; Ogre::Plane::getNormal
	push	eax
	mov	ecx, DWORD PTR _box$[ebp]
	call	?getRadiusInDirection@BoxBound@Ogre@@QBEMABVVector3@2@@Z ; Ogre::BoxBound::getRadiusInDirection
	fstp	DWORD PTR _radius$[ebp]

; 123  : 
; 124  : 		if ( distToCenter > radius )

	fld	DWORD PTR _distToCenter$[ebp]
	fld	DWORD PTR _radius$[ebp]
	fcompp
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN4@boxSide

; 125  : 			return Plane::FRONT;

	xor	eax, eax
	jmp	SHORT $LN1@boxSide
	jmp	SHORT $LN1@boxSide
$LN4@boxSide:

; 126  : 		else if ( distToCenter < - radius )
	...
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN2@boxSide

; 127  : 			return Plane::BACK;
...
; 130  : 	}
	...
	pop	ebp
	ret	4
?boxSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVBoxBound@2@@Z ENDP ; Ogre::Plane::boxSide
_TEXT	ENDS
PUBLIC	?sphereSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVSphereBound@2@@Z ; Ogre::Plane::sphereSide
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -12						; size = 4
_dist$ = -8						; size = 4
_radius$ = -4						; size = 4
_sphere$ = 8						; size = 4
?sphereSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVSphereBound@2@@Z PROC ; Ogre::Plane::sphereSide
; _this$ = ecx
...
; 134  : 		float radius = sphere.getRadius();
...
; 135  : 
; 136  : 		float dist = distanceToPoint(sphere.getCenter());
...
; 137  : 		if( dist > radius ) return Plane::FRONT;
	...
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN4@sphereSide
	xor	eax, eax
	jmp	SHORT $LN1@sphereSide
	jmp	SHORT $LN1@sphereSide
$LN4@sphereSide:

; 138  : 		else if( dist < -radius ) return Plane::BACK;
	...
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN2@sphereSide
	mov	eax, 1
	jmp	SHORT $LN1@sphereSide
	jmp	SHORT $LN1@sphereSide
$LN2@sphereSide:

; 139  : 		else return Plane::INTERSECT;
...
; 140  : 	}
	...
	pop	ebp
	ret	4
?sphereSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVSphereBound@2@@Z ENDP ; Ogre::Plane::sphereSide
_TEXT	ENDS
PUBLIC	?boxSphereBoundSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVBoxSphereBound@2@@Z ; Ogre::Plane::boxSphereBoundSide
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -12						; size = 4
_dist$ = -8						; size = 4
_radius$ = -4						; size = 4
_bound$ = 8						; size = 4
?boxSphereBoundSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVBoxSphereBound@2@@Z PROC ; Ogre::Plane::boxSphereBoundSide
; _this$ = ecx
...
; 144  : 		float dist = distanceToPoint(bound.m_Center);
...
; 145  : 		float radius = bound.m_Radius;

	mov	ecx, DWORD PTR _bound$[ebp]
	fld	DWORD PTR [ecx+24]
	fstp	DWORD PTR _radius$[ebp]

; 146  : 
; 147  : 		if( dist > radius ) return Plane::FRONT;
	...
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN4@boxSphereB
	xor	eax, eax
	jmp	SHORT $LN1@boxSphereB
	jmp	SHORT $LN1@boxSphereB
$LN4@boxSphereB:

; 148  : 		else if( dist < -radius ) return Plane::BACK;
	...
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN2@boxSphereB
	mov	eax, 1
	jmp	SHORT $LN1@boxSphereB
	jmp	SHORT $LN1@boxSphereB
$LN2@boxSphereB:

; 149  : 		else return Plane::INTERSECT;
...
; 150  : 	}
	...
	pop	ebp
	ret	4
?boxSphereBoundSide@Plane@Ogre@@QBE?AW4ESIDE_T@12@ABVBoxSphereBound@2@@Z ENDP ; Ogre::Plane::boxSphereBoundSide
_TEXT	ENDS
PUBLIC	?relativePlane@WorldPlane@Ogre@@QBEXAAVPlane@2@ABVWorldPos@2@@Z ; Ogre::WorldPlane::relativePlane
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -16						; size = 4
_pt$ = -12						; size = 12
_dest$ = 8						; size = 4
_origin$ = 12						; size = 4
?relativePlane@WorldPlane@Ogre@@QBEXAAVPlane@2@ABVWorldPos@2@@Z PROC ; Ogre::WorldPlane::relativePlane
; _this$ = ecx
...
; 154  : 		Vector3 pt = m_Point.subtract( origin );
...
; 155  : 		dest.setFromNormalAndPoint( m_Normal, pt );
...
; 156  : 	}
	...
	pop	ebp
	ret	8
?relativePlane@WorldPlane@Ogre@@QBEXAAVPlane@2@ABVWorldPos@2@@Z ENDP ; Ogre::WorldPlane::relativePlane
_TEXT	ENDS
PUBLIC	?distanceToPoint@WorldPlane@Ogre@@QBEMABVWorldPos@2@@Z ; Ogre::WorldPlane::distanceToPoint
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -16						; size = 4
$T63907 = -12						; size = 12
_pt$ = 8						; size = 4
?distanceToPoint@WorldPlane@Ogre@@QBEMABVWorldPos@2@@Z PROC ; Ogre::WorldPlane::distanceToPoint
; _this$ = ecx
...
; 160  : 		return DotProduct(pt.subtract( m_Point ), m_Normal);
...
; 161  : 	}
	...
	pop	ebp
	ret	4
?distanceToPoint@WorldPlane@Ogre@@QBEMABVWorldPos@2@@Z ENDP ; Ogre::WorldPlane::distanceToPoint
_TEXT	ENDS
PUBLIC	?mirrorPoint@WorldPlane@Ogre@@QBEXAAVWorldPos@2@ABV32@@Z ; Ogre::WorldPlane::mirrorPoint
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv84 = -36						; size = 4
_this$ = -32						; size = 4
...
_dest$ = 8						; size = 4
_src$ = 12						; size = 4
?mirrorPoint@WorldPlane@Ogre@@QBEXAAVWorldPos@2@ABV32@@Z PROC ; Ogre::WorldPlane::mirrorPoint
; _this$ = ecx
...
; 165  : 		float dist = distanceToPoint( src );

	mov	eax, DWORD PTR _src$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?distanceToPoint@WorldPlane@Ogre@@QBEMABVWorldPos@2@@Z ; Ogre::WorldPlane::distanceToPoint
	fstp	DWORD PTR _dist$[ebp]

; 166  : 		dest = src - m_Normal*(dist*2.0f);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T63909[ebp]
	push	edx
	call	??DOgre@@YA?AVVector3@0@ABV10@M@Z	; Ogre::operator*
	add	esp, 12					; 0000000cH
	push	eax
	lea	eax, DWORD PTR $T63910[ebp]
	push	eax
	mov	ecx, DWORD PTR _src$[ebp]
	call	??GWorldPos@Ogre@@QBE?AV01@ABVVector3@1@@Z ; Ogre::WorldPos::operator-
	mov	ecx, DWORD PTR _dest$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
	mov	edx, DWORD PTR [eax+4]
...
; 167  : 	}
	...
	pop	ebp
	ret	8
?mirrorPoint@WorldPlane@Ogre@@QBEXAAVWorldPos@2@ABV32@@Z ENDP ; Ogre::WorldPlane::mirrorPoint
_TEXT	ENDS
PUBLIC	?mirrorVector@WorldPlane@Ogre@@QBEXAAVVector3@2@ABV32@@Z ; Ogre::WorldPlane::mirrorVector
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv89 = -36						; size = 4
_this$ = -32						; size = 4
...
_dest$ = 8						; size = 4
_src$ = 12						; size = 4
?mirrorVector@WorldPlane@Ogre@@QBEXAAVVector3@2@ABV32@@Z PROC ; Ogre::WorldPlane::mirrorVector
; _this$ = ecx
...
; 171  : 		float mydot = DotProduct( m_Normal, src );
...
; 173  : 	}
	...
	pop	ebp
	ret	8
?mirrorVector@WorldPlane@Ogre@@QBEXAAVVector3@2@ABV32@@Z ENDP ; Ogre::WorldPlane::mirrorVector
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogremath.h
_TEXT	ENDS
