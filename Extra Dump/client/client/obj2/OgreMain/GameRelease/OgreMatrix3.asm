; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	i:\svnroot\client\OgreMain\OgreMatrix3.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 101  : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T62438[ebp], eax
	mov	ecx, DWORD PTR $T62438[ebp]
	mov	DWORD PTR $T62437[ebp], ecx
	cmp	DWORD PTR $T62437[ebp], 0
	je	SHORT $LN3@deleteThis
	push	1
	mov	edx, DWORD PTR $T62437[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T62437[ebp]
...
_TEXT	ENDS
PUBLIC	?makeScaleMatrix@Matrix3@Ogre@@QAEXABVVector3@2@@Z ; Ogre::Matrix3::makeScaleMatrix
...
_TEXT	ENDS
PUBLIC	?det@Matrix3@Ogre@@QBEMXZ			; Ogre::Matrix3::det
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrematrix3.cpp
_TEXT	SEGMENT
tv160 = -8						; size = 4
_this$ = -4						; size = 4
?det@Matrix3@Ogre@@QBEMXZ PROC				; Ogre::Matrix3::det
; _this$ = ecx
...
; 38   : 		return  (_11 * _22 - _12 * _21) * _33
; 39   : 			-(_11 * _23 - _13 * _21) * _32
; 40   : 			+(_12 * _23 - _13 * _22) * _31;
...
; 41   : 	}
	...
	pop	ebp
	ret	0
?det@Matrix3@Ogre@@QBEMXZ ENDP				; Ogre::Matrix3::det
_TEXT	ENDS
PUBLIC	__real@3ff0000000000000
PUBLIC	__real@0000000000000000
PUBLIC	?inverse@Matrix3@Ogre@@QBEXAAV12@@Z		; Ogre::Matrix3::inverse
...
_s$ = -4						; size = 4
_output$ = 8						; size = 4
?inverse@Matrix3@Ogre@@QBEXAAV12@@Z PROC		; Ogre::Matrix3::inverse
; _this$ = ecx
...
; 45   : 		assert( this != &output );
; 46   : 
; 47   : 		float s = det();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?det@Matrix3@Ogre@@QBEMXZ		; Ogre::Matrix3::det
...
; 51   : 		output._11 = s * ((_22 * _33) - (_23 * _32));
...
; 52   : 		output._12 = s * ((_32 * _13) - (_33 * _12));
...
; 53   : 		output._13 = s * ((_12 * _23) - (_13 * _22));
...
; 54   : 		output._21 = s * ((_23 * _31) - (_21 * _33));
...
; 55   : 		output._22 = s * ((_33 * _11) - (_31 * _13));
...
; 56   : 		output._23 = s * ((_13 * _21) - (_11 * _23));
...
; 57   : 		output._31 = s * ((_21 * _32) - (_22 * _31));
...
; 58   : 		output._32 = s * ((_31 * _12) - (_32 * _11));
...
; 59   : 		output._33 = s * ((_11 * _22) - (_12 * _21));
...
; 60   : 	}
	...
	pop	ebp
	ret	4
?inverse@Matrix3@Ogre@@QBEXAAV12@@Z ENDP		; Ogre::Matrix3::inverse
_TEXT	ENDS
PUBLIC	?inverse@Matrix3@Ogre@@QAEXXZ			; Ogre::Matrix3::inverse
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -40						; size = 4
_tmp$ = -36						; size = 36
?inverse@Matrix3@Ogre@@QAEXXZ PROC			; Ogre::Matrix3::inverse
; _this$ = ecx
...
; 65   : 		tmp.inverse(*this);
	...
	call	?inverse@Matrix3@Ogre@@QBEXAAV12@@Z	; Ogre::Matrix3::inverse
...
; 66   : 	}
	...
	pop	ebp
	ret	0
?inverse@Matrix3@Ogre@@QAEXXZ ENDP			; Ogre::Matrix3::inverse
; Function compile flags: /Odtp
_this$ = -4						; size = 4
_scale$ = 8						; size = 4
?makeScaleMatrix@Matrix3@Ogre@@QAEXABVVector3@2@@Z PROC	; Ogre::Matrix3::makeScaleMatrix
; _this$ = ecx
...
; 74   : 	}
	...
	pop	ebp
	ret	4
?makeScaleMatrix@Matrix3@Ogre@@QAEXABVVector3@2@@Z ENDP	; Ogre::Matrix3::makeScaleMatrix
_TEXT	ENDS
PUBLIC	?transform@Matrix3@Ogre@@QBEXAAVVector3@2@ABV32@@Z ; Ogre::Matrix3::transform
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -16						; size = 4
_z$ = -12						; size = 4
...
_output$ = 8						; size = 4
_input$ = 12						; size = 4
?transform@Matrix3@Ogre@@QBEXAAVVector3@2@ABV32@@Z PROC	; Ogre::Matrix3::transform
; _this$ = ecx
...
; 78   : 		float x = input.x*_11 + input.y*_21 + input.z*_31;
...
; 79   : 		float y = input.x*_12 + input.y*_22 + input.z*_32;
...
; 80   : 		float z = input.x*_13 + input.y*_23 + input.z*_33;
...
; 85   : 	}
	...
	pop	ebp
	ret	8
?transform@Matrix3@Ogre@@QBEXAAVVector3@2@ABV32@@Z ENDP	; Ogre::Matrix3::transform
_TEXT	ENDS
PUBLIC	?transform@Matrix3@Ogre@@QBEXAAVWorldPos@2@ABV32@@Z ; Ogre::Matrix3::transform
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -28						; size = 4
_z$ = -24						; size = 8
...
_output$ = 8						; size = 4
_input$ = 12						; size = 4
?transform@Matrix3@Ogre@@QBEXAAVWorldPos@2@ABV32@@Z PROC ; Ogre::Matrix3::transform
; _this$ = ecx
...
; 89   : 		double x = input.x*_11 + input.y*_21 + input.z*_31;
...
; 90   : 		double y = input.x*_12 + input.y*_22 + input.z*_32;
...
; 91   : 		double z = input.x*_13 + input.y*_23 + input.z*_33;
...
; 96   : 	}
	...
	pop	ebp
	ret	8
?transform@Matrix3@Ogre@@QBEXAAVWorldPos@2@ABV32@@Z ENDP ; Ogre::Matrix3::transform
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogremath.h
_TEXT	ENDS
