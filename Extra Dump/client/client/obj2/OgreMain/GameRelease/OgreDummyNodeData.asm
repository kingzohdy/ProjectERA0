; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	i:\svnroot\client\OgreMain\OgreDummyNodeData.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 101  : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T61132[ebp], eax
	mov	ecx, DWORD PTR $T61132[ebp]
	mov	DWORD PTR $T61131[ebp], ecx
	cmp	DWORD PTR $T61131[ebp], 0
	je	SHORT $LN3@deleteThis
	push	1
	mov	edx, DWORD PTR $T61131[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T61131[ebp]
...
_TEXT	ENDS
PUBLIC	??0DummyNodeData@Ogre@@QAE@XZ			; Ogre::DummyNodeData::DummyNodeData
...
; 17   : 		DECLARE_RTTI(DummyNodeData)
	...
	add	esp, 4
	mov	DWORD PTR $T61215[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T61215[ebp], 0
	je	SHORT $LN3@newObject
	mov	ecx, DWORD PTR $T61215[ebp]
...
$LN4@newObject:
	...
	mov	DWORD PTR $T61214[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	eax, DWORD PTR $T61214[ebp]
	mov	ecx, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, ecx
	pop	ecx
	mov	esp, ebp
...
PUBLIC	?_serialize@DummyNodeData@Ogre@@MAEXAAVArchive@2@H@Z ; Ogre::DummyNodeData::_serialize
...
_TEXT	ENDS
PUBLIC	??1DummyNodeData@Ogre@@MAE@XZ			; Ogre::DummyNodeData::~DummyNodeData
...
_TEXT	ENDS
xdata$x	SEGMENT
__unwindtable$??0DummyNodeData@Ogre@@QAE@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0DummyNodeData@Ogre@@QAE@XZ$0
__ehfuncinfo$??0DummyNodeData@Ogre@@QAE@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0DummyNodeData@Ogre@@QAE@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	00H
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogredummynodedata.cpp
xdata$x	ENDS
_TEXT	SEGMENT
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??0DummyNodeData@Ogre@@QAE@XZ PROC			; Ogre::DummyNodeData::DummyNodeData
; _this$ = ecx
...
; 10   : 	{
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0DummyNodeData@Ogre@@QAE@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	mov	eax, DWORD PTR ___security_cookie
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7DummyNodeData@Ogre@@6B@
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??0DummyNodeData@Ogre@@QAE@XZ$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1Resource@Ogre@@MAE@XZ		; Ogre::Resource::~Resource
__ehhandler$??0DummyNodeData@Ogre@@QAE@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0DummyNodeData@Ogre@@QAE@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
??0DummyNodeData@Ogre@@QAE@XZ ENDP			; Ogre::DummyNodeData::DummyNodeData
xdata$x	SEGMENT
__unwindtable$??1DummyNodeData@Ogre@@MAE@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??1DummyNodeData@Ogre@@MAE@XZ$0
__ehfuncinfo$??1DummyNodeData@Ogre@@MAE@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??1DummyNodeData@Ogre@@MAE@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	00H
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??1DummyNodeData@Ogre@@MAE@XZ PROC			; Ogre::DummyNodeData::~DummyNodeData
; _this$ = ecx
...
; 14   : 	{
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??1DummyNodeData@Ogre@@MAE@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	mov	eax, DWORD PTR ___security_cookie
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$??1DummyNodeData@Ogre@@MAE@XZ$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1Resource@Ogre@@MAE@XZ		; Ogre::Resource::~Resource
__ehhandler$??1DummyNodeData@Ogre@@MAE@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??1DummyNodeData@Ogre@@MAE@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
??1DummyNodeData@Ogre@@MAE@XZ ENDP			; Ogre::DummyNodeData::~DummyNodeData
PUBLIC	??$serializeRawType@VDummyNodeDesc@Ogre@@@Archive@Ogre@@QAEXAAVDummyNodeDesc@1@@Z ; Ogre::Archive::serializeRawType<Ogre::DummyNodeDesc>
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ar$ = 8						; size = 4
_version$ = 12						; size = 4
?_serialize@DummyNodeData@Ogre@@MAEXAAVArchive@2@H@Z PROC ; Ogre::DummyNodeData::_serialize
; _this$ = ecx
...
; 19   : 		ar.serializeRawType(m_Desc);

	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 16					; 00000010H
	push	eax
	mov	ecx, DWORD PTR _ar$[ebp]
	call	??$serializeRawType@VDummyNodeDesc@Ogre@@@Archive@Ogre@@QAEXAAVDummyNodeDesc@1@@Z ; Ogre::Archive::serializeRawType<Ogre::DummyNodeDesc>
...
; 21   : 	}
	...
	pop	ebp
	ret	8
?_serialize@DummyNodeData@Ogre@@MAEXAAVArchive@2@H@Z ENDP ; Ogre::DummyNodeData::_serialize
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrearchive.h
_TEXT	ENDS
;	COMDAT ??$serializeRawType@VDummyNodeDesc@Ogre@@@Archive@Ogre@@QAEXAAVDummyNodeDesc@1@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_value$ = 8						; size = 4
??$serializeRawType@VDummyNodeDesc@Ogre@@@Archive@Ogre@@QAEXAAVDummyNodeDesc@1@@Z PROC ; Ogre::Archive::serializeRawType<Ogre::DummyNodeDesc>, COMDAT
; _this$ = ecx
...
; 99   : 		}
	...
	pop	ebp
	ret	4
??$serializeRawType@VDummyNodeDesc@Ogre@@@Archive@Ogre@@QAEXAAVDummyNodeDesc@1@@Z ENDP ; Ogre::Archive::serializeRawType<Ogre::DummyNodeDesc>
_TEXT	ENDS
EXTRN	??0RuntimeClass@Ogre@@QAE@PBDPBV01@HP6APAVBaseObject@1@XZ@Z:PROC ; Ogre::RuntimeClass::RuntimeClass
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogredummynodedata.cpp
;	COMDAT ??__E?m_RTTI@DummyNodeData@Ogre@@2VRuntimeClass@2@B@@YAXXZ
text$yc	SEGMENT
??__E?m_RTTI@DummyNodeData@Ogre@@2VRuntimeClass@2@B@@YAXXZ PROC ; `dynamic initializer for 'Ogre::DummyNodeData::m_RTTI'', COMDAT

; 7    : 	IMPLEMENT_RTTI(DummyNodeData, Resource, 100)

	push	ebp
	mov	ebp, esp
	push	OFFSET ?newObject@DummyNodeData@Ogre@@SAPAVBaseObject@2@XZ ; Ogre::DummyNodeData::newObject
	push	100					; 00000064H
	push	OFFSET ?m_RTTI@Resource@Ogre@@2VRuntimeClass@2@B ; Ogre::Resource::m_RTTI
	push	OFFSET $SG56635
	mov	ecx, OFFSET ?m_RTTI@DummyNodeData@Ogre@@2VRuntimeClass@2@B ; Ogre::DummyNodeData::m_RTTI
	call	??0RuntimeClass@Ogre@@QAE@PBDPBV01@HP6APAVBaseObject@1@XZ@Z ; Ogre::RuntimeClass::RuntimeClass
	pop	ebp
	ret	0
??__E?m_RTTI@DummyNodeData@Ogre@@2VRuntimeClass@2@B@@YAXXZ ENDP ; `dynamic initializer for 'Ogre::DummyNodeData::m_RTTI''
text$yc	ENDS
PUBLIC	?m_RTTI@DummyNodeData@Ogre@@2VRuntimeClass@2@B	; Ogre::DummyNodeData::m_RTTI
_BSS	SEGMENT
?m_RTTI@DummyNodeData@Ogre@@2VRuntimeClass@2@B DB 014H DUP (?) ; Ogre::DummyNodeData::m_RTTI
_BSS	ENDS
CRT$XCU	SEGMENT
?m_RTTI$initializer$@DummyNodeData@Ogre@@2P6AXXZA DD FLAT:??__E?m_RTTI@DummyNodeData@Ogre@@2VRuntimeClass@2@B@@YAXXZ ; Ogre::DummyNodeData::m_RTTI$initializer$
CRT$XCU	ENDS
END
