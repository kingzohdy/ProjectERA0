; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.30729.01 
	...
	TITLE	i:\svnroot\client\OgreMain\OgreVector4.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 101  : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T62263[ebp], eax
	mov	ecx, DWORD PTR $T62263[ebp]
	mov	DWORD PTR $T62262[ebp], ecx
	cmp	DWORD PTR $T62262[ebp], 0
	je	SHORT $LN3@deleteThis
	push	1
	mov	edx, DWORD PTR $T62262[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T62262[ebp]
...
PUBLIC	?length@Vector4@Ogre@@QBEMXZ			; Ogre::Vector4::length
PUBLIC	?Normalize@Ogre@@YAXAAVVector4@1@@Z		; Ogre::Normalize
;	COMDAT __real@3ff0000000000000
; File i:\svnroot\client\ogremain\ogrevector4.cpp
CONST	SEGMENT
...
_scale$ = -4						; size = 4
_vec$ = 8						; size = 4
?Normalize@Ogre@@YAXAAVVector4@1@@Z PROC		; Ogre::Normalize
...
; 36   : 		assert( vec.length() > 0 );
; 37   : 		float scale = 1.0f /vec.length();

	mov	ecx, DWORD PTR _vec$[ebp]
	call	?length@Vector4@Ogre@@QBEMXZ		; Ogre::Vector4::length
	fld1
	fdivrp	ST(1), ST(0)
...
; 42   : 	}
	...
	pop	ebp
	ret	0
?Normalize@Ogre@@YAXAAVVector4@1@@Z ENDP		; Ogre::Normalize
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrevector4.h
_TEXT	ENDS
;	COMDAT ?length@Vector4@Ogre@@QBEMXZ
_TEXT	SEGMENT
tv128 = -8						; size = 4
_this$ = -4						; size = 4
?length@Vector4@Ogre@@QBEMXZ PROC			; Ogre::Vector4::length, COMDAT
; _this$ = ecx
...
; 118  : 			return sqrt(x*x+y*y+z*z+w*w);
...
; 119  : 		}
	...
	pop	ebp
	ret	0
?length@Vector4@Ogre@@QBEMXZ ENDP			; Ogre::Vector4::length
_TEXT	ENDS
PUBLIC	??$Abs@M@Ogre@@YAMABM@Z				; Ogre::Abs<float>
PUBLIC	?IsNormalized@Ogre@@YA_NABVVector4@1@@Z		; Ogre::IsNormalized
; Function compile flags: /Odtp
; File i:\svnroot\client\ogremain\ogrevector4.cpp
_TEXT	SEGMENT
tv74 = -8						; size = 4
$T62372 = -4						; size = 4
_vec$ = 8						; size = 4
?IsNormalized@Ogre@@YA_NABVVector4@1@@Z PROC		; Ogre::IsNormalized
...
; 46   : 		return Abs(vec.length()-1.0f) < EPSILON;

	mov	ecx, DWORD PTR _vec$[ebp]
	call	?length@Vector4@Ogre@@QBEMXZ		; Ogre::Vector4::length
	fsub	QWORD PTR __real@3ff0000000000000
	fstp	DWORD PTR $T62372[ebp]
	lea	eax, DWORD PTR $T62372[ebp]
	push	eax
...
; 47   : 	}}
	...
	pop	ebp
	ret	0
?IsNormalized@Ogre@@YA_NABVVector4@1@@Z ENDP		; Ogre::IsNormalized
_TEXT	ENDS
