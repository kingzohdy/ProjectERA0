...
**  $Id: tfile.h,v 1.7 2007/10/31 01:39:35 steve Exp $
**  @author $Author: steve $
**  @date $Date: 2007/10/31 01:39:35 $
...
*/
int tfopen(IN const char* a_pszPath, IN int a_iMode);
...
*********************************************************************/
int tfwrite(IN int a_iFile, IN const char* a_pszBuff, IN int a_iSize);
...
*	@retval >=0 for success
*********************************************************************/
int tfread(IN int a_iFile, OUT char* a_pszBuff, IN int a_iSize);
...
*	@retval  0 for success.
*********************************************************************/
int tfload(IN int a_iFile, INOUT char** a_ppszBuff, INOUT int* a_piSize);
...
*	@retval 0 for success.
*********************************************************************/
int tflock(IN int a_iFile, IN int a_iOff, IN int a_iLen, IN int a_iIsBlocking);
...
*	@retval 0 for success.
*********************************************************************/
int tfunlock(IN int a_iFile, IN int a_iOff, IN int a_iLen);
...
*	@return[in] a_iOrigin the method to reposition:
...
*	@retval 0 for success.
*********************************************************************/
int tfseek(IN int a_iFile, IN int a_iOff, IN int a_iOrigin);
...
*	@retval 0 for success.
*********************************************************************/
int tftruncate(IN int a_iFile, IN int a_iSize);
...
*	@param[in] a_iIsReplceExist whether replace the target file if the target file already exist.
*	@return whether the operation is succeeded.
*	@retval -1 for failure, use errno for detail.
*	@retval 0 for success.
*********************************************************************/
...
*	@retval 0 for success.
*********************************************************************/
int tfstat(IN int a_iFile, OUT TFSTAT* a_pstStat);
