...
**  $Id: tshm.h,v 1.6 2007/12/29 09:45:45 steve Exp $
**  @author $Author: steve $
**  @date $Date: 2007/12/29 09:45:45 $
...
*********************************************************************/
int tshmopen(IN const char* a_pszPath, IN int a_iSize, IN int a_iFlags, IN int a_iType);

/** *******************************************************************
*	@brief close the shm object.
*	@parami[in] a_iShm the descriptor of the shm object.
*	@parami[in] a_iFlags only one flags can be specified: TSHMF_DELETE, delete the shm object after closing it. otherwise just close it.
*	@return whether the operation is succeed.
*	@retval -1 for failure.
*	@retval 0 for success.
*********************************************************************/
int tshmclose(IN int a_iShm, IN int a_iFlags);
...
*********************************************************************/
void* tshmat(IN int a_iShm, IN int a_iFlags);
