...
**  $Id: tnet.h,v 1.7 2007/10/31 01:45:12 steve Exp $
**  @author $Author: steve $
**  @date $Date: 2007/10/31 01:45:12 $
...
*	@retval -1 for failure.
*********************************************************************/
int tnet_set_nonblock(IN int a_iSock, IN int a_iIsNonblocking);			/* set the socket to be nonblock or not. */
...
*	@retval -1 for failure.
*********************************************************************/
int tnet_set_recvbuff(int a_iSock, int a_iSize);
...
*	@retval -1 for failure.
*********************************************************************/
int tnet_set_sendbuff(int a_iSock, int a_iSize);


/* create/destroy the socket. */

/** *******************************************************************
*	@brief  open a communication descriptor by a URI string. the URI like that: tcp://127.0.0.1:8888?reuseaddr=1
...
*********************************************************************/
int tnet_open(IN const char* a_pszUri);				/* create a socket use uri info. */



/** *******************************************************************
*	@brief  create a communication descriptor by a URI string and listen on it. the URI like that: tcp://127.0.0.1:8888?reuseaddr=1
*	@param[in]  a_pszUri the URI string used to create the communication descriptor.
...
*	@retval  the communication descriptor if success.
*********************************************************************/
int tnet_listen(IN const char* a_pszUri, IN int a_iBacklog);		/* create a socket for listen. */



/** *******************************************************************
*	@brief  open a communication descriptor by a URI string and do connect. the URI like that: tcp://127.0.0.1:8888?reuseaddr=1
*	@param[in]  a_pszUri the URI string used to create the communication descriptor.
...
*	@retval  the communication descriptor if success.
*********************************************************************/
int tnet_connect(IN const char* a_pszUri, IN int a_iTimeout);		/* create a socket, and connect to the uri specified. */
...
*	@return a_iTimeout the max milliseconds can be used to accept the pre-finished connection.
*	@return the accepted communication descriptor.
*	@retval  -1 if failed.
*	@retval  the accepted communication descriptor if success.
*********************************************************************/
int tnet_accept(IN int a_iSock, OUT struct sockaddr* a_pstAddr, INOUT int* a_piLen, IN int a_iTimeout); /* accept a income connection. */
...
*	@retval -1 if failure.
*********************************************************************/
int tnet_close(IN int a_iSock);						/* close a socket. */
...
*********************************************************************/
int tnet_send(IN int a_iSock, IN const char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*********************************************************************/
int tnet_recv(IN int a_iSock, OUT char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*	@retval >=0 the data sent, by bytes.
*********************************************************************/
int tnet_sendall(IN int a_iSock, IN const char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*	@retval >=0 the data received, by bytes.
*********************************************************************/
int tnet_recvall(IN int a_iSock, OUT char* a_pszBuff, IN int a_iLen, IN int a_iTimeout);
...
*********************************************************************/
int tnet_write(IN int a_iSock, IN const char* a_pszBuff, IN int a_iLen);
...
*********************************************************************/
int tnet_read(IN int s, OUT char* pszBuff, IN int iLen);
