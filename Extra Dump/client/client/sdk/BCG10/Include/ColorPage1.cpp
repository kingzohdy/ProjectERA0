...
IMPLEMENT_DYNCREATE(CBCGPColorPage1, CPropertyPage)

CBCGPColorPage1::CBCGPColorPage1() : CPropertyPage(CBCGPColorPage1::IDD)
{
...
BEGIN_MESSAGE_MAP(CBCGPColorPage1, CPropertyPage)
