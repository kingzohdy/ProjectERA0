...
//------------------------------------------------------------------------------------
void CBCGPControlBar::OnStyleChanged(int nStyleType, LPSTYLESTRUCT lpStyleStruct)
{
	CBCGPBaseControlBar::OnStyleChanged (nStyleType, lpStyleStruct);
...
BOOL CBCGPControlBar::OnShowControlBarMenu (CPoint point)
{
...

	{
		...
		strItem.LoadString (IDS_BCGBARRES_FLOATING);
		menu.AppendMenu (MF_STRING, idFloating, strItem);

		strItem.LoadString (IDS_BCGBARRES_DOCKING);
		...
		strItem.LoadString (IDS_BCGBARRES_AUTOHIDE);
		menu.AppendMenu (MF_STRING, idAutoHide, strItem);

		strItem.LoadString (IDS_BCGBARRES_HIDE);
...
BOOL CBCGPControlBar::CanBeTabbedDocument () const
{
	...
	if (!pMDIFrame->CanCovertControlBarToMDIChild ())
	{
		return FALSE;
	}
