...
BOOL CBCGPRibbonCustomizePage::OnInitDialog() 
{
	...
	m_wndUp.SetStdImage (CBCGPMenuImages::IdArowUpLarge);
	m_wndDown.SetStdImage (CBCGPMenuImages::IdArowDownLarge);
...
//**********************************************************************
void CBCGPRibbonCustomizePage::EnableKeyboradCustomization (BOOL bEnable/* = TRUE*/)
{
	ASSERT_VALID (this);
	ASSERT (GetSafeHwnd () == NULL);
