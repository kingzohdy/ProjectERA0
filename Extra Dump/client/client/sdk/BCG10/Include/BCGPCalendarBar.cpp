...
void CBCGPCalendar::OnPaint() 
{
	...
	CBCGPMenuImages::Draw (pDC, CBCGPMenuImages::IdArowLeftLarge, 
			m_rectBtnPrev, imageState);

	CBCGPMenuImages::Draw (pDC, CBCGPMenuImages::IdArowRightLarge, 
...
void CBCGPCalendar::OnDrawMonth (CDC* pDC, CRect rect, int nMonthIndex)
{
	...
	for (i = 0; i < 42; i++)
	{
		...
		if (bIsSelected)
		{
			...
			if (m_Colors.clrSelectedText != globalData.clrWindowText)
			{
										  ...
										  int nMonthIndexInCalendar)
{
	...
	m_pCalendarWnd->m_bIsMonthPicker = TRUE;
}

CBCGPMonthPickerWnd::~CBCGPMonthPickerWnd()
{
	ASSERT_VALID (m_pCalendarWnd);
	m_pCalendarWnd->m_bIsMonthPicker = FALSE;
}
...
//****************************************************************************************
void CBCGPMonthPickerWnd::PrevMonth ()
{
...
//****************************************************************************************
void CBCGPMonthPickerWnd::NextMonth ()
{
	m_nFirstVisibleMonth++;
