...
void CBCGPTabWnd::AdjustTabs ()
{
	...
	if (m_bActiveTabCloseButton && m_iActiveTab >= 0)
	{
		...
		m_rectCloseButton.OffsetRect (
			-CBCGPVisualManager::GetInstance ()->GetTabHorzMargin (this), 
			GetLocation () == CBCGPBaseTabWnd::LOCATION_TOP ? 1 : -1);
...
void CBCGPTabWnd::SetTabsHeight ()
{
	...
	else if (m_bIsVS2005Style)
	{
		...
		m_nTabsHeight = (max (nImageHeight, globalData.GetTextHeight () - globalData.GetTextMargins () + 6));
	}
	else
	{
...
void CBCGPTabWnd::SetScrollButtons ()
{
	...
	m_btnScrollLeft.SetStdImage (
		CBCGPMenuImages::IdArowLeftTab3d,
		m_bIsOneNoteStyle || m_bIsVS2005Style || m_bLeftRightRounded ? CBCGPMenuImages::ImageBlack : CBCGPMenuImages::ImageDkGray,
		CBCGPMenuImages::IdArowLeftDsbldTab3d);
	...
	{
		m_btnScrollRight.SetStdImage (
			CBCGPMenuImages::IdArowRightTab3d,
			m_bIsOneNoteStyle || m_bIsVS2005Style || m_bLeftRightRounded ? CBCGPMenuImages::ImageBlack : CBCGPMenuImages::ImageDkGray,
			CBCGPMenuImages::IdArowRightDsbldTab3d);
	}
