...
IMPLEMENT_DYNCREATE(CBCGPColorPage2, CPropertyPage)

CBCGPColorPage2::CBCGPColorPage2() : CPropertyPage(CBCGPColorPage2::IDD)
{
...
BEGIN_MESSAGE_MAP(CBCGPColorPage2, CPropertyPage)
