...
**  $Id: tconnapi.h,v 1.5 2012/06/19 07:40:47 kent Exp $
**  @author $Author: kent $
**  @date $Date: 2012/06/19 07:40:47 $
...
*    =0:success
*/
int tconnapi_create(IN int iProcID, OUT unsigned long int* piHandle);
...
*return value:
*/
void tconnapi_free(IN unsigned long int* piHandle);
...
*     =0  success
*/
int tconnapi_connect(IN unsigned long int iHandle,IN int iDst);
...
*    =0   recv one package  
*/
int tconnapi_recv(IN unsigned long int iHandle,IN int *piSrc,INOUT char* pszBuff,INOUT int* piBuff,OUT TFRAMEHEAD* pstHead);
...
*     =0  success
*/
int tconnapi_send(IN unsigned long int iHandle,IN  int iDst, IN char* pszBuff,IN  int iBuff,IN TFRAMEHEAD* pstHead);
