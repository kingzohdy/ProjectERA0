...
#ifndef BI_SERVICE_CONF_DESC_H
#define BI_SERVICE_CONF_DESC_H


#ifndef TDR_METALIB_BI_SERVICE_VERSION 
#define TDR_METALIB_BI_SERVICE_VERSION 	10 /*version of metalib*/
#endif

#ifndef TDR_METALIB_BI_SERVICE_HASH 
#define TDR_METALIB_BI_SERVICE_HASH 	"bc2a53f8958c7b7026387b2d679470d1" /*hash of metalib*/
#endif
/*   
 User Define Macros.   */
...
struct tagbi_serviceconf;
typedef struct tagbi_serviceconf                   	BI_SERVICECONF;
typedef struct tagbi_serviceconf                   	*LPBI_SERVICECONF;

struct tagbi_servicerun_status;
typedef struct tagbi_servicerun_status             	BI_SERVICERUN_STATUS;
typedef struct tagbi_servicerun_status             	*LPBI_SERVICERUN_STATUS;
...
{
    int RegionID;                       
    TORMCONNECTDBINFO DBConnectInfo;                   	/*   account_x 数据库 */
    TORMCONNECTDBINFO BillDBConnectInfo;               	/*   bill_x 数据库 */
};
...
struct tagbi_serviceconf
{
    ...
    REGIONDBINFO RegionDBInfo[BI_MAX_REGION_NUM]; 	/*   soap输入输出编码格式 */
};
