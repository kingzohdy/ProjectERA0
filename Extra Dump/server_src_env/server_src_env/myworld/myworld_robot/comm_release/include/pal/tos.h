...
**  $Id: tos.h,v 1.1.1.1 2011/01/05 10:59:29 jerry Exp $
**  @author $Author: jerry $
...
#if defined(__GNUC__)
#define TOS_UNUSED_ARG(a) do{}while(0 == &a)
#else
...
/* PS Method Start. */
	...
	//#define creat(path, mode) 		_creat(path, mode)
...
*	@retval -1 it not.
*********************************************************************/
int tos_timed_wait(pid_t pid, int a_iTimeout);
