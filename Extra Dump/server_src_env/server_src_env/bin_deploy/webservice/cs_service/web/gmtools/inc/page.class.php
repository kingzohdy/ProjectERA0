...
class Page
{
	...
	//获取分页变量
	function GetPage($sql,$pagenum='', $ordermode='id desc')
	{
		global $dosql;
		...
		$sql .= " ORDER BY $ordermode LIMIT $startnum, $this->pagenum";
	...
	function AjaxPage()
	{
		...
		{	
			...
			if($this->page > 1)
			{
				$pagetxt .= '<a href="javascript:;" onclick="PageList(\'1\',\''.$tid.'\',\''.$flag.'\',\''.$keyword.'\')">&lt;&lt;</a>';
				$pagetxt .= '<a href="javascript:;" onclick="PageList(\''.$previous.'\',\''.$tid.'\',\''.$flag.'\',\''.$keyword.'\')">&lt;</a>';
			}
			else
			{
				$pagetxt .= '<a href="javascript:;">&lt;&lt;</a>';
