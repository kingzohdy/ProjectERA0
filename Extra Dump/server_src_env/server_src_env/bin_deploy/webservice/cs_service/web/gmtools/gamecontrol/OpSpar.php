...
function sear()
{
	...
	$.ajax({
		...
		url: 'select_log.php',
		dataType: 'json',
		data: {"OpSpar":"","xzdb": f,"time":tb, "time1":tb1, "us":jsm,"fag":fag,"qq":fu},
		success: function(msg){
			if( null ==msg || ""== msg)
			{
				$("#tabr").empty();
			...
			else
			{
				...
				$.each(msg, function (index, value) {
					...
					var s = '<tr class=mgr_tr align=center ><td height=32 width="8%" >'+value['Uin']+'</td><td width="8%">'+value['LoginName']+'</td><td width="8%" >'+value['RoleName']+'</td><td width="7%">'+value['OpType']+'</td><td width="9%" >'+value['NewSparID']+'</td><td width="5%">'+value['NewSparLevel']+'</td><td width="8%" >'+value['money']+'</td><td width="38%" >'+value['spars']+'</td><td width="9%" >'+value['LogTime']+'</td></tr>';
					$("#tabr").append(s);
				});
			}
		}
...
<body>
<div class="mgr_header"> <span class="title">道具消耗</span>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		<tr class="thead2" align="center">
                ...
                <td width="9%">晶石ID</td>
                <td width="5%">晶石等级</td>
                <td width="8%">消耗绑银/银币</td>
                <td width="38%">消耗材料（名称：数量）</td>
                <td width="9%">时间</td>
		</tr>
 </table>
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table" id="tabr">
 </table>
</div>
 <div class="page_area">
</div>
