...
function sear()
{
	...
	$.ajax({
		...
		url: 'select_log.php',
		dataType: 'json',
		data: {"GodCoinConsumeRecord":"","xzdb":qu,"time":tb, "time1":tb1, "us":jsm},
		success: function(msg){
			...
			else
			{
				...
				$.each(msg, function (index, value) {
					...
					var s = '<tr class=mgr_tr align=center ><td height=32 width="8%" >'+value['Uin']+'</td><td width="14%">'+value['RoleID']+'</td><td width="4%" >'+value['RoleLevel']+'</td><td width="10%">'+value['WorldID']+'</td><td width="8%" >'+value['OperType']+'</td><td width="8%">'+value['OperSubType']+'</td><td width="8%" >'+value['GodCoin']+'</td><td width="10%" >'+value['Shop']+'</td><td width="8%" >'+value['ShopNum']+'</td><td width="12%" >'+value['OperDesc']+'</td><td width="10%" >'+value['LogTime']+'</td></tr>';
					$("#tabr").append(s);
				});
			}
		}
...
<body>
<div class="mgr_header"> <span class="title">金币消耗</span>
