...
function get_tabs()
{
    ...
    foreach ($tables as $one_table) {
        ...
        $GLOBALS['PMD_OUT']['TABLE_NAME'][$i] = latin_htmlspecialchars($GLOBALS['db'] . "." . $one_table['TABLE_NAME'], ENT_QUOTES);
        $GLOBALS['PMD_OUT']['OWNER'][$i] = latin_htmlspecialchars($GLOBALS['db'], ENT_QUOTES);
        $GLOBALS['PMD_OUT']['TABLE_NAME_SMALL'][$i] = latin_htmlspecialchars($one_table['TABLE_NAME'], ENT_QUOTES);
