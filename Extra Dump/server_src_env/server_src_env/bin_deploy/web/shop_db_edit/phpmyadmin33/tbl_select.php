...
<fieldset id="fieldset_table_qbe">
    ...
    for ($i = 0; $i < $fields_cnt; $i++) {
        ...
        <tr class="<?php echo $odd_row ? 'odd' : 'even'; $odd_row = ! $odd_row; ?>">
            <th><?php echo latin_htmlspecialchars($fields_list[$i]); ?></th>
        ...
        if (strncasecmp($fields_type[$i], 'enum', 4) == 0) {
            foreach ($GLOBALS['cfg']['EnumOperators'] as $fc) {
                echo "\n" . '                        '
                   . '<option value="' . latin_htmlspecialchars($fc) . '">'
                   . latin_htmlspecialchars($fc) . '</option>';
            }
        ...
        ?>
            <input type="hidden" name="names[<?php echo $i; ?>]"
                value="<?php echo latin_htmlspecialchars($fields_list[$i]); ?>" />
...
<fieldset id="fieldset_select_fields">
    ...
    foreach ($fields_list as $each_field) {
        echo '        '
            .'<option value="' . latin_htmlspecialchars($each_field) . '"'
            .' selected="selected">' . latin_htmlspecialchars($each_field)
            .'</option>' . "\n";
    }
    ?>
    </select>
...
<fieldset id="fieldset_display_order">
    ...
    foreach ($fields_list as $each_field) {
        echo '        '
            .'<option value="' . latin_htmlspecialchars($each_field) . '">'
            .latin_htmlspecialchars($each_field) . '</option>' . "\n";
    } // end for
    ?>
    </select>
<?php
