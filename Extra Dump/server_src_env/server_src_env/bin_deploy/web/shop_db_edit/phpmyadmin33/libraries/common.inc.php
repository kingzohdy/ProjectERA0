...
function latin_htmlspecialchars($buffer,$flag="ENT_COMPAT|ENT_HTML401",$encoding='ISO-8859-1')
{
	$buffer = htmlspecialchars($buffer,ENT_COMPAT|ENT_HTML401,$encoding);
	return $buffer;
}
...
$PMA_PHP_SELF = latin_htmlspecialchars($PMA_PHP_SELF);
