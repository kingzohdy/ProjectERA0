...
class PMA_Theme_Manager
{
        ...
        if (! $this->checkTheme($GLOBALS['cfg']['ThemeDefault'])) {
            trigger_error(
                sprintf($GLOBALS['strThemeDefaultNotFound'],
                    latin_htmlspecialchars($GLOBALS['cfg']['ThemeDefault'])),
                E_USER_ERROR);
    ...
    function setActiveTheme($theme = null)
    {
        if (! $this->checkTheme($theme)) {
            trigger_error(
                sprintf($GLOBALS['strThemeNotFound'], latin_htmlspecialchars($theme)),
                E_USER_ERROR);
            return false;
        }
    ...
    function getHtmlSelectBox($form = true)
    {
        ...
        foreach ($this->themes as $each_theme_id => $each_theme) {
            ...
            $select_box .=  '>' . latin_htmlspecialchars($each_theme->getName()) . '</option>';
        }
        $select_box .=  '</select>';
