...
class PMA_Theme {
    ...
    function printPreview()
    {
        ...
        echo '<h2>' . latin_htmlspecialchars($this->getName())
            .' (' . latin_htmlspecialchars($this->getVersion()) . ')</h2>'
            .'<p>'
        ...
        if (@file_exists($this->getPath() . '/screen.png')) {
            ...
            echo '<img src="' . $this->getPath() . '/screen.png" border="1"'
                .' alt="' . latin_htmlspecialchars($this->getName()) . '"'
                .' title="' . latin_htmlspecialchars($this->getName()) . '" /><br />';
        } else {
