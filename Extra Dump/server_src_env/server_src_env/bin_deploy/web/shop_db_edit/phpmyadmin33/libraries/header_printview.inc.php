...
<p>
    ...
    <strong><?php echo $strDatabase; ?>:</strong> <?php echo latin_htmlspecialchars($db); ?><br />
    ...
    <strong><?php echo $strSQLQuery; ?>:</strong> <?php echo latin_htmlspecialchars($full_sql_query); ?>;
