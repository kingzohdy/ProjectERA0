    ...
    foreach ($databases as $current) {
        ...
        if ($is_superuser || $cfg['AllowUserDropDatabase']) {
            ...
            if ($current['SCHEMA_NAME'] != 'mysql'
             && $current['SCHEMA_NAME'] != 'information_schema') {
                echo '        <input type="checkbox" name="selected_dbs[]" title="' . latin_htmlspecialchars($current['SCHEMA_NAME']) . '" value="' . latin_htmlspecialchars($current['SCHEMA_NAME']) . '" ' . (empty($checkall) ? '' : 'checked="checked" ') . '/>' . "\n";
            } else {
                echo '        <input type="checkbox" name="selected_dbs[]" title="' . latin_htmlspecialchars($current['SCHEMA_NAME']) . '" value="' . latin_htmlspecialchars($current['SCHEMA_NAME']) . '" disabled="disabled"/>' . "\n";
            }
            echo '    </td>' . "\n";
        }
        echo '    <td class="name">' . "\n"
           ...
           . sprintf($strJumpToDB, latin_htmlspecialchars($current['SCHEMA_NAME']))
           . '" target="_parent">' . "\n"
           . '            ' . latin_htmlspecialchars($current['SCHEMA_NAME']) . "\n"
           . '        </a>' . "\n"
           . '    </td>' . "\n";
        ...
        if ($is_superuser) {
            echo '    <td class="tool">' . "\n"
               ...
               . '" title="' . sprintf($strCheckPrivsLong, latin_htmlspecialchars($current['SCHEMA_NAME']))
               . '">'. "\n"
               . '            '
