...
$strTransformation_text_plain__formatted = 'Zachová původní formátování sloupce, tak jak je uložen v databázi, bez použití latin_htmlspecialchars(). Předpokládá se, že sloupec obsahuje platné HTML.';
