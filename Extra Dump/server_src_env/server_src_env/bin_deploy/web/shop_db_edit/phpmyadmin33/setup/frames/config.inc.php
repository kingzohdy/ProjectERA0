...
<input type="hidden" name="eol" value="<?php echo latin_htmlspecialchars(PMA_ifSetOr($_GET['eol'], 'unix')) ?>" />
<?php display_fieldset_top('', '', null, array('class' => 'simple')); ?>
<tr>
    <td>
        <textarea cols="50" rows="20" name="textconfig" id="textconfig" spellcheck="false"><?php
            echo latin_htmlspecialchars(ConfigFile::getInstance()->getConfigFile())
        ?></textarea>
    </td>
</tr>
<tr>
