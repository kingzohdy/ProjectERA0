...
proc 2
	...
	if Rets = 0
		SET_SCRIPT_INT_RET -1
		add_sys_msg_start
		add_sys_msg 你的公会未开启公会宝藏活动，不能使用物品！
		set_sys_msg_mode 1 0 0
		msg_info
		return
	endif
...
;		;古老藏宝图
;	endif
	if Radn >= 5 and Radn < 11
		ADD_ITEM_NUM_INPAK 5060066 1 1 0
		;生存奖章*10
	endif

	if Radn >= 11 and Radn < 16
		ADD_ITEM_NUM_INPAK 5103001 1 1 0
		;秘境净化
	endif
