...
;怪物巡逻结束事件
	...
	if Mon_Ret = 0
		...
		if PatrolID = 16
				MON_CHG_MAP 2400 3800 5300 24 20 1	
		endif
		if PatrolID = 24
...
;	if 11 = 0 
		MON_TASK_AREA_CHECK 30015 3000 300 200		
		;检查有效玩家
;	endif
...
;	endif
	...
	if 32 != 1000
		...
		if 13 = 20 
			...
			MON_CALL_ENEMY_MON 200026 3 80 1 @MonX @MonY 1000 0 0 0 300 1 0
			MON_CALL_ENEMY_MON 200027 3 80 1 @MonX @MonY 1000 0 0 0 300 1 0
			var 13 0
			SET_MON_VAR 1 8 @13 1		
		endif
	endif
