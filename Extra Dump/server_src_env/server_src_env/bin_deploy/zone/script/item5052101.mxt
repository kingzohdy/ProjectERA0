...
;1~40级
	...
	;endif
	if Radn >= 0 and Radn < 2
		ADD_ITEM_NUM_INPAK 5060014 1 1 0
		;宝石碎片
	endif
	if Radn >= 2 and Radn < 4
...
;		;古老藏宝图
;	endif
	if Radn >= 4 and Radn < 10
		ADD_ITEM_NUM_INPAK 5060064 1 1 0
		;生存奖章*3
	endif

	if Radn >= 10 and Radn < 41
...
; 40 ~60级
	...
	;	ADD_ITEM_NUM_INPAK 5050510 1 1 0
	;endif
	if Radn >= 4 and Radn < 20
		ADD_ITEM_NUM_INPAK 5060014 1 1 0
		;宝石碎片
	endif
	if Radn >= 20 and Radn < 40
		ADD_ITEM_NUM_INPAK 5109201 1 1 0
		;旷岩宝珠
	endif
...
;	endif
	...
	if Radn >= 510 and Radn < 700
		ADD_ITEM_NUM_INPAK 5101002 2 1 0
		;密英矿
	endif
	if Radn >= 700 and Radn < 810
		ADD_ITEM_NUM_INPAK 5102001 2 1 0
		;原生油
	endif
...
;60~70
	...
	;	ADD_ITEM_NUM_INPAK 5050510 1 1 0
	;endif
	if Radn >= 5 and Radn < 20
		ADD_ITEM_NUM_INPAK 5060014 1 1 0
		;宝石碎片
	endif
	if Radn >= 20 and Radn < 30
		ADD_ITEM_NUM_INPAK 5109201 1 1 0
		;旷岩宝珠
	endif
...
;	endif
	...
	if Radn >= 90 and Radn < 150
		ADD_ITEM_NUM_INPAK 5060066 1 1 0
		;生存奖章*10
	endif

	if Radn >= 150 and Radn < 220
		ADD_ITEM_NUM_INPAK 5103002 1 1 0
		;宁静精华
	endif
	if Radn >= 220 and Radn < 410
...
proc 203
	...
	;	ADD_ITEM_NUM_INPAK 5050510 1 1 0
		;灵魂契约
	;endif
	if rad >= 50 and rad < 90
		ADD_ITEM_NUM_INPAK 5060014 1 1 0
		;宝石碎片
	endif
	if rad >= 90 and rad < 100
		ADD_ITEM_NUM_INPAK 5109202 1 1 0
		;熔火宝珠
	endif
	if rad >= 100 and rad < 110
		ADD_ITEM_NUM_INPAK 5109203 1 1 0
		;狂澜宝珠
	endif
	if rad >= 110 and rad < 120
		ADD_ITEM_NUM_INPAK 5109204 1 1 0
		;岚空宝珠
	endif 
;	if rad >= 120 and rad < 200
;		ADD_ITEM_NUM_INPAK 5219400 1 1 0
;		;一级宝石升级符
;	endif
;	if rad >= 200 and rad < 270
;		ADD_ITEM_NUM_INPAK 5062000 1 1 0
;		;古老藏宝图
;	endif
	
	if Rad >= 120 and Rad < 180
		ADD_ITEM_NUM_INPAK 5060066 1 1 0
		;生存奖章*10
	endif

	if rad >= 180 and rad < 300
		ADD_ITEM_NUM_INPAK 5103002 1 1 0
		;宁静精华
	endif
	if rad >= 300 and rad < 360
		ADD_ITEM_NUM_INPAK 5103003 1 1 0
		;冷川精华
	endif
	if rad >= 360 and rad < 400
		ADD_ITEM_NUM_INPAK 5103004 1 1 0
		;飞尘精华
	endif
	if rad >= 400 and rad < 460
		ADD_ITEM_NUM_INPAK 5101002 2 1 0
		;密英矿
	endif
	if rad >= 460 and rad < 540
		ADD_ITEM_NUM_INPAK 5101003 2 1 0
		;热能矿
	endif
	if rad >= 540 and rad < 720
		ADD_ITEM_NUM_INPAK 5101004 2 1 0
		;乌损矿
	endif
	if rad >= 720 and rad < 760
		ADD_ITEM_NUM_INPAK 5102002 2 1 0
		;低构油
	endif
	if rad >= 760 and rad < 820
		ADD_ITEM_NUM_INPAK 5102003 2 1 0
		;光合油
	endif
	if rad >= 820 and rad < 1000
		ADD_ITEM_NUM_INPAK 5101004 2 1 0
		;晶脉油
	endif
...
proc 205
	...
	strvar Radn
	rand Radn 1000
	if Radn >= 0 and Radn < 5
		ADD_BIND_ITEM_NUM_INPAK 5233000 1 1 0
		;幻化果实
	endif
	if Radn >= 5 and Radn < 8
		ADD_BIND_ITEM_NUM_INPAK 5233500 1 1 0
		;基因果实
	endif
	;if Radn = 2
	...
	if Radn >= 40 and Radn < 55
		ADD_ITEM_NUM_INPAK 5109202 1 1 0
		;熔火宝珠
	endif
	if Radn >= 55 and Radn < 65
		ADD_ITEM_NUM_INPAK 5109203 1 1 0
		;狂澜
	endif
;	if Radn >= 65 and Radn < 100
;		ADD_ITEM_NUM_INPAK 5219400 1 1 0
;		;无瑕宝石升级符
;	endif
;	if Radn >= 100 and Radn < 120
;		ADD_ITEM_NUM_INPAK 5062000 1 1 0
;		;古老藏宝图
;	endif
	
	if Radn >= 65 and Radn < 125
		ADD_ITEM_NUM_INPAK 5060066 1 1 0
		;生存奖章*10
	endif

	if Radn >= 125 and Radn < 160
		ADD_ITEM_NUM_INPAK 5103001 1 1 0
		;秘境精华
	endif
