...
PROC 3
	...
	if 20 > 50 or 20 > @22
		...
		switch 10
			case 1
			new_dyn_mon 2 283016 @23 11344 12927 800 0 0 0 0 110 1
			endcase
			case 3
			new_dyn_mon 2 283016 @23 9392 10392 800 0 0 0 0 110 1
			endcase
			case 5
			new_dyn_mon 2 283016 @23 12778 10605 800 0 0 0 0 110 1
			endcase
			case 7
			new_dyn_mon 2 283015 @23 11337 12069 800 0 0 0 0 110 1
			endcase
			case 9
			new_dyn_mon 2 283015 @23 10690 11027 800 0 0 0 0 110 1
			endcase
			case 10
			new_dyn_mon 2 283015 @23 11914 10976 800 0 0 0 0 110 1
			endcase
			case 15
			...
			if 21 = 0
				...
				set_sys_msg_mode 4 0 0
				map_msg_info
				new_dyn_mon 19 283017 1 @16 @17 0 @18 0 0 0 110 1
				set_pworld_var 36 32 @19 1
