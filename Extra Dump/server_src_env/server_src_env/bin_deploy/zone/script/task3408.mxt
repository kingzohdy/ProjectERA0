...
proc 1
	...
	var Tim 0
	set_task_var 3408 1 8 @Tim 1
endproc

proc 2
	strvar Mid
	GET_MAP_NPC_ID 306021 Mid 1
	mon_speech @Mid 2 0 1 谁也无法阻挡#Name#的锋芒，连PK之王伊索也不例外！
...
proc 6
	...
	if Loc = 1
		...
		get_task_var 3408 1 8 1 Tim
		add Tim 1
		set_task_var 3408 1 8 @Tim 1
		if Tim =  1
			mon_speech @Mid 2 0 1 不败神话伊索上场！
		...
		;	NEW_MON 282025 1 12400 13000 0 0 0 0 0
			NEW_LIFE_MON 282025 1 12400 13000 0 0 0 0 1800 0 0
			var Tim 0
			set_task_var 3408 1 8 @Tim 1
			var Loc 0
			set_task_var 3408 0 8 @Loc 1
