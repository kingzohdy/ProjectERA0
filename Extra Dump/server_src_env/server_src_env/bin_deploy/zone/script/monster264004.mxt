...
;怪物巡逻结束事件
	...
	if Mon_Ret = 0
		if PatrolID = 30 or PatrolID = 19 or PatrolID = 31 
			SET_MON_TASK_STAT 30007 1 1
			DESTROY_MON 1
		endif
...
;	if 11 = 0 
		MON_TASK_AREA_CHECK 30007 3000 300 200		
		;检查有效玩家
;	endif
...
;			MON_CALL_ENEMY_MON 200024 2 75 2 @MonX @MonY 1000 0 0 0 60 1 0
;			MON_CALL_ENEMY_MON 200025 1 75 2 @MonX @MonY 1000 0 0 0 60 1 0
;			var 13 0
;			SET_MON_VAR 1 8 @13 1		
;		endif
;	endif
