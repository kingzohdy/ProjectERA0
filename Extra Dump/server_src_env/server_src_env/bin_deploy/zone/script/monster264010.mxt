...
;怪物巡逻结束事件
	...
	if Mon_Ret = 0
		...
		if PatrolID = 16 
			...
			switch NumRand_2
				case 100
					MON_CHG_MAP 2400 3320 3550 23 20 1
				endcase
				case 101
					MON_CHG_MAP 2400 3320 3550 35 20 1
				endcase
				case 102
					MON_CHG_MAP 2400 3320 3550 36 20 1
				endcase
		...
		if PatrolID = 17 
			...
			switch NumRand_3
				case 100
					MON_CHG_MAP 2500 31067 22561 26 20 1
				endcase
				case 101
					MON_CHG_MAP 2500 31067 22561 37 20 1
				endcase
				case 102
					MON_CHG_MAP 2500 31067 22561 38 20 1
				endcase
...
;	endif
	...
	if 32 != 1000
		...
		if 13 = 20 
			...
			MON_CALL_ENEMY_MON 200024 2 50 1 @MonX @MonY 1000 0 0 0 30 1 0
			MON_CALL_ENEMY_MON 200025 2 50 1 @MonX @MonY 1000 0 0 0 30 1 0
			var 13 0
			SET_MON_VAR 1 8 @13 1		
		endif
	endif
