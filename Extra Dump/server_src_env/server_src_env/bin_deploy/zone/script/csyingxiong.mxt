...
proc 101
	...
	if RetB = 1
		...
		if Moy = -1
			...
			GET_PLAYER_ID 1 mid
			TRANSMIT_CAMERA @mid 90 1000 33000 48500 0 0
...
proc 102
	...
	IS_CAN_BIANSHEN RetB 1
		if RetB = 1
			...
			GET_PLAYER_ID 1 mid
			TRANSMIT_CAMERA @mid 90 1000 41300 27000 0 0
			DEC_MONEY 0 50 21 10
		endif
	endif
endproc
...
proc 103
	...
	if RetB = 1
		...
		if Moy = -1
			...
			GET_PLAYER_ID 1 mid
			TRANSMIT_CAMERA @mid 90 1000 26300 11000 0 0	
			DEC_MONEY 0 50 21 10
		endif
	endif
endproc
...
proc 106
	...
	if RetB = 1
		...
		if Moy = -1
			...
			GET_PLAYER_ID 1 mid
			TRANSMIT_CAMERA @mid 90 1000 14200 26300 0 0	
			DEC_MONEY 0 50 21 10
		endif
	endif
endproc 
