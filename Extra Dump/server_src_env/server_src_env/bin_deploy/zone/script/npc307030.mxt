			...
			if ret = 1
				if zhi2 < 30
					...
					if zhi < 90
						...
						if zhi >= 40 and zhi < 88
							ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5052172 1 1 0
						endif
						if zhi >= 88 and zhi < 90
							ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 5052191 1 1 0
							call 102
						endif
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小罐绑银、一些强化石、慧然果子和战备箱！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif
					if zhi >= 90
						...
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小罐绑银、一些强化石、慧然果子和一块合金！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif		
				endif
				if zhi2 >= 30 and zhi2 < 38
					...
					if zhi < 90
						...
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小罐绑银、一些强化石、独悟果子和战备箱！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif
					if zhi >= 90
						...
						ADD_SYS_MSG_START
						ADD_SYS_MSG 你从领主的遗产中找到了一小罐绑银、一些强化石、独悟果子和一块合金！
						SET_SYS_MSG_MODE 3 0 0
						MSG_INFO
					endif
				endif
		...
		if @num < 6
			...
			if ret = 1
				...
				if zhi < 90
					...
					ADD_SYS_MSG_START
					ADD_SYS_MSG 你从领主的遗产中找到了一小罐绑银、一些强化石和战备箱！
					SET_SYS_MSG_MODE 3 0 0
					MSG_INFO
				endif
				if zhi >= 90
					...
					ADD_SYS_MSG_START
					ADD_SYS_MSG 你从领主的遗产中找到了一小罐绑银、一些强化石和一块合金！
					SET_SYS_MSG_MODE 3 0 0
					MSG_INFO
				endif
