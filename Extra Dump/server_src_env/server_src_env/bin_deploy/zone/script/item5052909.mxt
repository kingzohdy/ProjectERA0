...
proc 1
	...
	get_role_var 12 8 0 zhi
	
	if zhi < 1
		GET_PACK_SPACE 0 ret
		if ret >= 8
			DEC_ITEM_NUM_INPAK 5052909 1 10
			if 10 = 0
				...
				; ADD_BIND_ITEM_NUM_INPAK_NOLIMIT 3653002 1 1 0
		...
		add_sys_msg_start
		add_sys_msg 你已开启过腾讯公测特权金卡，无法再开启
