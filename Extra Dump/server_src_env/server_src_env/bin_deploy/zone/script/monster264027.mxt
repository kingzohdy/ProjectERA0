...
;怪物巡逻结束事件
	...
	if Mon_Ret = 0
		if PatrolID = 133 or PatrolID = 130 or PatrolID = 131 or PatrolID = 132
			SET_MON_TASK_STAT 30013 1 1
			DESTROY_MON 1
		endif
		if PatrolID = 13
			MON_CHG_MAP 2100 4200 4000 128 20 1
		endif
		...
		if PatrolID = 128
			...
			switch NumRand_1
				case 100
					MON_CHG_MAP 2104 6100 6900 130 20 1
				endcase
				case 101
					MON_CHG_MAP 2104 6100 6900 131 20 1
				endcase
				case 102
					MON_CHG_MAP 2104 6100 6900 132 20 1
				endcase
				case 103
					MON_CHG_MAP 2104 6100 6900 129 20 1
				endcase
			endswitch
		endif
		if PatrolID = 129
			MON_CHG_MAP 3100 12900 1000 133 20 1
		endif
...
;	if 11 = 0 
		MON_TASK_AREA_CHECK 30013 3000 300 200		
		;检查有效玩家
;	endif
			...
			if 13 = 20
				;60秒时让镖车停下30秒召唤怪物
					...
					if Rad = 0
						...
						MON_CALL_ENEMY_MON 200026 2 65 2 @OutMonX @OutMonY 500 0 0 0 60 1 0
						MON_CALL_ENEMY_MON 200027 2 65 2 @OutMonX @OutMonY 500 0 0 0 60 1 0
					endif
				var 13 0
				SET_MON_VAR 1 8 @13 1		
			endif
