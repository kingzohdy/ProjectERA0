...
;怪物巡逻结束事件
	...
	if Mon_Ret = 0
		if PatrolID = 20 or PatrolID = 33 or PatrolID = 34 or PatrolID = 23 or PatrolID = 35 or PatrolID = 36
...
;	endif
	...
	if 32 != 1000
		...
		if 13 = 20 
			...
			MON_CALL_ENEMY_MON 200024 2 40 1 @MonX @MonY 1000 0 0 0 30 1 0
			MON_CALL_ENEMY_MON 200025 2 40 1 @MonX @MonY 1000 0 0 0 30 1 0
			var 13 0
			SET_MON_VAR 1 8 @13 1		
		endif
	endif
