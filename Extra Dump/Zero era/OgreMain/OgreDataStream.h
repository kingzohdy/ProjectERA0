...
#define OGRE_STREAM_TEMP_SIZE 128
	...
	*/
	...
	public:
		...
		*/
		MemoryDataStream(void* pMem, size_t size, void (*freeOnClose)(void *) = NULL);
		...
		*/
		...
		void setFreeOnClose(void (*freeOnClose)(void *)) { mFreeOnClose = freeOnClose; }
	};
	...
	*/
	...
	class _OgreExport DataStreamObject
	{
	protected:
	...
	public:
		...
		virtual void *	buffer(size_t len) = 0;
		virtual size_t	length() = 0;
		virtual size_t	size() = 0;
		virtual void	shift(size_t len) = 0;
	};

	class _OgreExport ObjectDataStream : public DataStream
	{
	protected:
		DataStreamObject	*mObject;
		size_t				mPos;

	public:
		ObjectDataStream(DataStreamObject *object);
		virtual ~ObjectDataStream();
	...
	{
	public:
		virtual ~DataStreamHandle() {};
		bool Unhandle(DataStream *&ps)
		{
			if (getValue(ps))
			{
				delete this;
	...
	protected:
		virtual bool getValue(DataStream *&ps) = 0;
	};

	class DataStreamShell : public DataStreamHandle
	{
	public:
		DataStreamShell(DataStream *ps);
