...
namespace Ogre {
	...
	*/
	...
	public:
		...
		/// @copydoc Codec::code
		DataStream * code(MemoryDataStream * input, CodecData * pData) const;
		/// @copydoc Codec::codeToFile
		void codeToFile(MemoryDataStream * input, const String& outFileName, CodecData * pData) const;
		/// @copydoc Codec::decode
		DecodeResult decode(DataStream * input) const;
