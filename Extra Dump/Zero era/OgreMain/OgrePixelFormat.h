...
namespace Ogre {
	...
	*/
	...
	"width" pixels.
	*/
	class _OgreExport PixelBox: public BoxInt{
	public:
		...
		*/
		PixelBox(const BoxInt &extents, PixelFormat pixelFormat, void *pixelData=0):
		BoxInt(extents), data(pixelData), format(pixelFormat)
		{
			setConsecutive();
		}
		...
		*/
		...
		BoxInt(0, 0, 0, (int)width, (int)height, (int)depth),
		...
		*/
		PixelBox getSubVolume(const BoxInt &def) const;
	};
