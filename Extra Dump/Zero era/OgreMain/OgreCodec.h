	...
	*/
	...
	public:
		...
		*/
		...
		stream.
		*/
		virtual DataStream * code(MemoryDataStream * input, CodecData * pData) const = 0;
		...
		*/
		virtual void codeToFile(MemoryDataStream * input, const String& outFileName, CodecData * pData) const = 0;

		/// Result of a decoding; both a decoded data stream and CodecData metadata
		typedef std::pair<MemoryDataStream *, CodecData *> DecodeResult;
		...
		*/
		virtual DecodeResult decode(DataStream * input) const = 0;
