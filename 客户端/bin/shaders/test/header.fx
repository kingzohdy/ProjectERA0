...
float4x4 g_referencepoint      : REFERENCEPOINT;
float3 g_warfogparameter	   : WARFOGPARAMETER;
float3 g_warfogcolor		   : WARFOGCOLOR;
/*
NUM_LIGHTS
...
//return shadow;
*/
	return tex2Dproj(s_DepthMapSampler, uv).x;
}
